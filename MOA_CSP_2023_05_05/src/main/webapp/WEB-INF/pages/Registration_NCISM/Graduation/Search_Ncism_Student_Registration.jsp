			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<form:form name="" id="" action="Search_Student_RegAction"
						method="post" commandName="Search_Student_Reg_CMD">
						<div class="card-style mb-30">
						<div class="custom-field-block">
							<h6 class="mb-25">Student Admitted Report</h6>
							<div class="row">
								<div class="col-12 col-sm-12 col-md-6 col-lg-3"
									id="university_div">
									<div class="select-style-1">
										<label for="text-input">University<span
								...
								<div class="col-12 col-sm-12 col-md-6 col-lg-3">
									<div class="input-style-1">
										...
										<input type="text" id="name" name="name"
											class="autocomplete UpperClassName txt-transupp" placeholder = "Enter Name"
											autocomplete="off" />
									</div>
								</div>
								<div class="col-12 col-sm-12 col-md-6 col-lg-3">
									<div class="input-style-1">
										<label for="text-input">Ayush Id<span
											class="mandatory"></span></label> <input type="text" id="ayush_id" placeholder = "Enter Ayush ID"
											name="ayush_id"
								...
								<div class="col-12 col-sm-12 col-md-6 col-lg-3">
									<div class="input-style-1">
										<label>Date of Birth </label> <input type="text"
											name="date_of_birth" id="date_of_birth" maxlength="10"
								...
								<div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12">
										<ul class="buttons-group mainbtn">
											...
											<li><a href="Search_Ncism_Students_RegistrationUrl"
			...
			<div class="col-lg-12 col-md-12 col-sm-12">
				<div class="card-style mb-30">
					<div class="table-wrapper table-responsive custom-datatable-p">
						<table class="table" id="getSearch_Ncism_Stu_Reg">
							<thead>
								<tr>
									<th><h6>Sr No</h6></th>
...
<c:url value="Search_Stu_Reg_NcismPopupUrl"
	var="Search_Stu_Reg_NcismPopupUrl" />
<form:form action="${Search_Stu_Reg_NcismPopupUrl}" method="post"
...
$(document).ready(function() {
	...
	mockjax1('getSearch_Ncism_Stu_Reg');
	table = dataTable('getSearch_Ncism_Stu_Reg');
...
function data(getSearch_Ncism_Stu_Reg) {
	jsondata = [];
	var table = $('#' + getSearch_Ncism_Stu_Reg).DataTable();
	...
	$.post("getFilterSearch_Ncism_Stu_Reg_data?" + key + "=" + value, {
		startPage : startPage,
	...
	$.post("getTotalSearch_Ncism_Stu_Reg_dataCount?" + key + "=" + value, {
...
function get_inst_by_uni_nch(val) {
	...
	$.post('get_inst_by_uni_ncism_ctrl?' + key + "=" + value,{university_id : val},function(j) {
// 		alert(j);
