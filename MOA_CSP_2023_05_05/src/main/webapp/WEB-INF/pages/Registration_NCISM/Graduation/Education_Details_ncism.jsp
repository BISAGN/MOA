		...
		<div class="form-elements-wrapper">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					...
					<form:form name="Edu_Det_Ncism_Action" id="Edu_Det_Ncism_Action"
						action="Edu_Det_Ncism_Action?${_csrf.parameterName}=${_csrf.token}"
						method='POST' modelAttribute="Edu_Det_Ncism_CMD"
												...
												<thead>
													<tr>
														...
														<th><h6>
															...
															</h6> <label class="table-note">[Maximum file size
															...
															<div class="select-style-1">
																<div class="select-position">
																	<input type="hidden" id="education_id_form"
																		name="education_id_form" value="0"> <select
														...
														<td>
															<div class="input-style-1">
																<input id="board_or_university"
																	...
																	placeholder="Enter Board/University" value=""
																	autocomplete="off" placeholder="" maxlength="50" />
																<div class="note-text">
																	<span class="errorClass"
																		id='board_or_university_lbl'></span>
																</div>
															</div>
														</td>
														<td>
														...
														<td>
															<div class="input-style-1">
																<input type="file" accept=".pdf" id="doc_path"
																	...
																	value="" />
																<div class="note-text">
																	<span class="errorClass" id='document_lbl1'></span>
						...
						<input type="hidden" name="tbpdid" id="tbpdid" value="0" />
								...
								<div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12">
										<ul class="buttons-group mainbtn">
											<li><a id="aIdPrevious"
												href="Personal_Details_Ncism_Url"
...
function editData(id){
	$.post("geteditEducation_Ncism_data_ctrl?" + key + "=" + value, {id:id}, function(j) {
		...
		document.getElementById('save_btn').className ='main-btn deactive-btn btn-hover btnupda';
...
// 		var orderColunm = $(table.column(order[0][0]).header()).attr('id').toLowerCase();
		...
		$.post("getFilterEducation_Ncism_data?" + key + "=" + value, {
			startPage : startPage,
		...
		$.post("getTotalEducation_Ncism_dataCount?" + key + "=" + value, {Search:Search}, function(j) {
			FilteredRecords = j;
		});
...
function Getchekyear(current_year) {
	...
	$.post('Getedu_chekyear_ncism_ctrl?' + key + "=" + value,{p_id : p_id},function(j) {
		for (var i = 0; i < j.length; i++) {
