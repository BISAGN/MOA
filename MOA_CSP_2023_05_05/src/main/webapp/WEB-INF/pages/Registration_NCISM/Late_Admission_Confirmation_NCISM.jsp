		...
		<div class="form-elements-wrapper">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<!-- input style start -->
					<form:form name="lateadmission_ncism" id="lateadmission_ncism"
						action="LateAdmission_ncismAction" method='POST'
						commandName="lateadmission_ncismCMD" enctype="multipart/form-data">
						<div class="card-style mb-30">
							<div class="custom-field-block">
								<h6 class="mb-25">Late Admission Confirmation</h6>
								<div class="row">
								...
								<div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12">
										<ul class="buttons-group mainbtn">
											<li><a class="main-btn secondary-btn btn-hover btn-iconic-icon btnsearch"
												id="search-reg" value="Search"><i
													class="lni lni-search-alt"></i>Search</a></li>
											<li><a href="Late_Admission_Confirmation_NCISM_Url"
											...
											<li><input type="button"
												class="main-btn deactive-btn btn-hover d-none"
												value="Forward to Commission" id="forwardtocomm"
												name="forwardtocomm"></li>

											<li><input type="button"
												class="main-btn success-btn btn-hover d-none"
												value="Approve" id="btn-comm-approve"
												name="btn-comm-approve"></li>

											<li><input type="button"
												class="main-btn danger-btn btn-hover d-none" value="Reject"
												id="btn-comm-reject" name="btn-comm-reject"></li>
										</ul>
				...
				<div class="row">
					<div class="col-12">
						<div class="card-style mb-30">
							...
							<!-- 				<input id="searchInput" type="text" style="font-family: 'FontAwesome', Arial; margin-bottom: 5px;width: 50%;" placeholder="&#xF002; Search" size="35" class="form-control"> -->
							<!-- 			</div> -->
								...
								<table class="table" id="ScreenReport">
									<thead>
										<tr>
											<th><h6>Sr No</h6></th>
											<c:if
												test="${late_admission_status  != '6'   && role != 'NCISM'}">
...
<c:url value="Late_Admission_Confirmation_NCISM_Search"
	var="Late_Admission_Confirmation_NCISM_Search" />
<form:form action="${Late_Admission_Confirmation_NCISM_Search}"
	method="post" id="searchForm" name="searchForm" modelAttribute="">
...
function setApproveStatus(){
	 ...
	 if(a == ""){
		alert("Please Select Student's for Approval");
			...
			$.post("Approve_From_Admission_Confirmation_Student_Data1?"+key+"="+value, 
			{ a:a }).done(function(j) {
				alert(j);
				location.reload();
			}); 
...
function setApproveByCommisionStatus(){
	 ...
	 if(a == ""){
		alert("Please Select Student's for Approval");
			...
			$.post("Approve_Student_Admission_By_Commission_NCISM_Ctrl?"+key+"="+value, 
			{ a:a }).done(function(j) {
				alert(j);
				location.reload();
			}); 
...
// 	}else{
// 			$.post("Reject_Approve_Student_Admission_By_Commission_NCISM_Ctrl?"+key+"="+value,
// 			{ a:a }).done(function(j) {
// 				alert(j);
// 				location.reload();
// 			}); 
...
function dynamicTable(a){
	...
	$.post("get_StudentName_by_NCISM_Reject_id?" + key + "=" + value, {
		id:idx
		}, function(p) {
...
function setforwardtocommission(){
	 ...
	 if(a == ""){
		alert("Please Select Student's for Forward to Commission");
			...
			$.post("Forward_Student_To_Commission_NCISM_ctrl?"+key+"="+value,
			{ a:a }).done(function(j) {
				alert(j);
				location.reload();
			}); 
...
// 	debugger;
	...
	var n = $('#late_admission_status').val();
