			...
			<div class="row align-items-center">
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="title mb-30">
						<h2><span id="lbladd">University In India</h2><span class="text-red font-size12 enter_by"></span>
					...
					<div class="breadcrumb-wrapper mb-30">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">University In India</li>
							</ol>
						</nav>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-12">
					...
					<form:form name="university" id="university"
						action="University_Action" method="post"
						class="form-horizontal" modelAttribute="University_CMD">
						<div class="card-style mb-30">
							<h6 class="mb-25">University In India</h6>
							<div class="row">
			...
			<div class="col-12">
				<div class="card-style mb-30">
					<div class="table-wrapper table-responsive custom-datatable-p">
						<table class="table" id="search_system_uni_india">
							<thead>
								<tr>
									<th><h6>Sr No</h6></th>
									<th><h6>Country</h6></th>
...
<c:url value="delete_Url33" var="deleteUrl" />
...
$(document).ready(function() {
	...
	mockjax1('search_system_uni_india');
	table = dataTable('search_system_uni_india');
...
function data(search_system_uni_india) {
	jsondata = [];
	var table = $('#' + search_system_uni_india ).DataTable();
	...
	$.post("getFilter_University?" + key + "=" + value, {
		startPage : startPage,
	...
	$.post("getTotal_University?" + key + "=" + value, {
		Search : Search,
		country_name : country_name,
		university_name : university_name,
		college_name : college_name,
...
function Validation() {
		...
		if ($("#college_name").val() =="0" ) {
			alert("Please Enter College Name.");
			$("select#college_name").focus();
			return false;
		}
		if ($("#abbreviation").val() =="" ) {
...
function getAbbreviationList1(){
	$("#Abbreviation").empty();
	var institute_id = $("#college_name").val();
	
	$.post("getAbbreviationList1?" + key + "=" + value, {
...
function getInstitute() {
	...
	$.post("getInstituteUrlindia?" + key + "=" + value,
					{
						selval : selval
					},
					function(j) {
