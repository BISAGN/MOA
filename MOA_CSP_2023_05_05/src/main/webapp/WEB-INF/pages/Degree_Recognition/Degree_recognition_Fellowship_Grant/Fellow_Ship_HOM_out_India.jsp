	...
	<div class="container-fluid">
			...
			<div class="row align-items-center">
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="title mb-30">
						<h2><span id="lbladd"></span>Fellow Ship HOM Out India</h2>
					...
					<div class="breadcrumb-wrapper mb-30">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Fellow
									Ship HOM Out India</li>
							</ol>
						</nav>
					</div>
				</div>
		...
		<div class="form-elements-wrapper">
			<div class="row">
				<div class="col-12">
					<!-- input style start -->
					<form:form name="fellow_ship_hom_out_india" id="fellow_ship_hom_out_india"
						action="Fellow_Ship_HOM_out_India_Action" method="post"
						class="form-horizontal"
						modelAttribute="Fellow_Ship_HOM_out_India_CMD">
						<div class="card-style mb-30">
							<h6 class="mb-25">Fellow Ship HOM Out India</h6>
							<div class="row">
							  ...
							  <div class="col-12 col-sm-12 col-md-6 col-lg-4">
								...
								<ul class="buttons-group mainbtn">
									...
									<li><a href="FellowShipHOMoutIndiaUrl"
...
<c:url value="deleteFellow_ship_Hom_out_india_Url" var="deleteFellow_ship_Hom_out_india_Url" />
<form:form action="${deleteFellow_ship_Hom_out_india_Url}" method="post" id="deleteForm"
...
//	 			var vpf = vp.substring(8,10) +"/"+vp.substring(5,7)+"/"+vp.substring(0,4);
	...
	function data(search_system) {
		...
		$.post("getFilter_fellow_ship_hom_out_india_data?" + key + "=" + value, {
			startPage : startPage,
		...
		$.post("getTotal_fellow_ship_hom_out_india_dataCount?" + key + "=" + value, {
			Search : Search,
			country_id : country_id,
			university_name : university_name,
			college_id : college_id,
	...
	function getAbbreviationListfellow1(){
		$("#Abbreviation").empty();
		var institute_id = $("#college_id").val();
		
		$.post("getAbbreviationListfellow1?" + key + "=" + value, {
...
function Validation() {
	...
	if ($("#university").val().trim() == "0") {
		alert("Please Select University.");
		$("input#university").focus();
		return false;
	}
	if ($("#college").val().trim() == "0") {
		alert("Please Select College.");
		$("input#college").focus();
		return false;
	}
	if ($("#qualification").val().trim() == "0") {
	...
	document.addEventListener('DOMContentLoaded', function() {
		...
		document.getElementById('college_id').onchange = function() {
			return getAbbreviationListfellow1();
		};
	...
	function getInstituteFellowOutIndia() {
		var selval = $("#university_name").val();0
		$.post("getInstituteUrlfellowOut?" + key + "=" + value,
						{
							selval : selval
						},
						function(j) {
