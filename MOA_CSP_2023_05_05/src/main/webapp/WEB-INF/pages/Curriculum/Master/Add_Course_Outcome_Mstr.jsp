			...
			<div class="row align-items-center">
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="title mb-30">
						...
						<h2>
							<span id="lbladd"></span> Add Course Outcome Master
						</h2>
					</div>
				</div>
				<!-- end col -->
		...
		<div class="form-elements-wrapper">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<!-- input style start -->
					<form:form name="Course_Outcomeform" id="Course_Outcomeform"
						action="Course_OutcomeAction" method="post"
						modelAttribute="Course_OutcomeCMD">
						<div class="card-style mb-30">
							<div class="custom-field-block">
								<h6 class="mb-25">Add Course Outcome Master</h6>
								<div class="row">
									...
									<div class="col-12 col-sm-12 col-md-6 col-lg-4">
										<div class="input-style-1">
											<label>Course Outcome<span class="mandatory">*</span></label>
											<input type="text" id="course_outcome" name="course_outcome"
									...
									<div class="col-12 col-sm-12 col-md-6 col-lg-4">
										<div class="input-style-1">
											<label>Code<span class="mandatory">*</span></label> <input
												type="text" id="co_code" name="co_code"
												class="autocomplete UpperClassName txt-transupp"
												autocomplete="off" maxlength="05" placeholder="Ex: CO1" />
										</div>
										<!-- end input -->
									</div>
								...
								<div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12">
										<ul class="buttons-group mainbtn">
											<li id="btn-reload1"><a
												href="Add_Course_Outcome_Mstr_Url"
					...
					<div class="col-lg-12 col-md-12 col-sm-12">
						<div class="card-style mb-30">
							<div class="table-wrapper table-responsive custom-datatable-p">
								<table class="table" id="search_course_outcome">
									<thead>
										<tr>
											...
											<th id="4"><h6>Course Outcome</h6></th>
											<th id="5"><h6>Code</h6></th>
											<th><h6>Action</h6></th>
										</tr>
									</thead>
									<tbody>
...
<c:url value="Course_Outcome_Mstr_Delete_Url" var="deleteUrl" />
...
<script nonce="${cspNonce}" type="text/javascript">
	$(document).ready(function() {
		...
		mockjax1('search_course_outcome');
		table = dataTable('search_course_outcome');
	...
	function setTimeLoadForTable(){
		...
		document.querySelectorAll('.ADDCourse_Outcome').forEach((items, index) => {
			items.addEventListener('click', event => {
				
				var val=parseInt(index)+1;
				
				var hid = document.getElementById('apIdCO'+val).value;
				...
				var hco = document.getElementById('approfCO'+val).value;
				var hcocode = document.getElementById('apcodeCO'+val).value;
				var hstatus = document.getElementById('apstatusCO'+val).value;
				
				
				if (confirm('Are You Sure You Want to Edit Detail ?')) {
					editData(hid,hsid,hprodegree,hidprofessional,hcourse,hco,hcocode,hstatus);
				} else {
					return false;
				}
			})
	...
	function data(search_course_outcome) {
		
		jsondata = [];
		var table = $('#' + search_course_outcome).DataTable();
		...
		var course_outcome = $("#course_outcome").val();
		...
		$.post("getFilterCourse_Outcome_data?" + key + "=" + value, {
			startPage : startPage,
			...
			for (var i = 0; i < j.length; i++) {
				jsondata.push([ j[i].ser,j[i].system_name, j[i].degree_name,j[i].professional,j[i].course_name, j[i].course_outcome,j[i].co_code,j[i].action ]);
			}
		});
		$.post("getTotalCourse_Outcome_dataCount?" + key + "=" + value, {
			Search : Search,
			course_id : course_id,
			course_outcome : course_outcome,
			co_code : co_code,
	...
	function editData(id,system_id,degree_id,professional_id,course_id,course_outcome,hcocode,status) {
		$("#btn-update").show();
		$("#btn-save").hide();
		$("#tbl").hide();
		$("#btn-reload").hide();
		...
		$("input#course_outcome").val(course_outcome);
		$("input#co_code").val(hcocode);
	...
	function Validation() {
		...
		if ($("#course_outcome").val().trim() == "") {
			alert("Please Enter Course Outcome.");
			$("input#course_outcome").focus();
			return false;
		}
		if (isNaN($("#course_outcome").val()) == false) {
			alert("Please Enter Valid Course Outcome.");
			$("input#course_outcome").focus();
			return false;
		}
		if ($("#co_code").val().trim() == "") {
