			...
			<div class="row align-items-center">
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="title mb-30">
						...
						<h2>
							<span id="lbladd"></span> Add Topic Master
						</h2>
					</div>
				</div>
				<!-- end col -->
		...
		<div class="form-elements-wrapper">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<!-- input style start -->
					<form:form name="topicmstr" id="topicmstr" action="topicmstrAction"
						method="post"
						modelAttribute="topicmstrCMD">
						<div class="card-style mb-30">
						<div class="custom-field-block">
							<h6 class="mb-25">Add Topic Master</h6>
							<div class="row">
							...
							<div class="col-12 col-sm-12 col-md-6 col-lg-4">
								...
								<div class="col-12 col-sm-12 col-md-6 col-lg-4">
									<div class="input-style-1">
										<label>Topic<span class="mandatory">*</span></label> <input
											type="text" id="topic" name="topic"
											class="autocomplete UpperClassName txt-transupp"
											autocomplete="off" maxlength="500" placeholder="Topic" />
									</div>
									<!-- end input -->
								</div>
								<div class="col-12 col-sm-12 col-md-6 col-lg-4">
							...
							<li id="btn-reload1">
						           <a href="Topic_Mstr_Url" class="main-btn dark-btn-outline btn-hover btn-iconic-icon btnback"><i class="lni lni-chevron-left"></i>Back</a>
						        </li>
								...
								<li  id="btn-reload2" ><a  id="btn-reload1" href="Topic_Mstr_Url"
...
<c:url value="Topic_Mstr_Delete_Url" var="deleteUrl" />
...
<script nonce="${cspNonce}" type="text/javascript">
	...
	document.addEventListener('DOMContentLoaded', function () {	
		...
		document.getElementById('topic').onkeypress = function() {
	...
	function setTimeLoadForTable(){
		...
		document.querySelectorAll('.ADDTopic').forEach((items, index) => {
			items.addEventListener('click', event => {
				...
				var htopic = document.getElementById('apTopic'+val).value;
	...
	function data(search_Topic) {
		...
		$.post("getFilterTopicMstr_data?" + key + "=" + value, {
			startPage : startPage,
			...
			for (var i = 0; i < j.length; i++) {
				jsondata.push([ j[i].ser,j[i].system_name,j[i].degree_name,j[i].professional,j[i].course_name, j[i].topic, j[i].action ]);
			}
		});
		$.post("getTotalTopicMstr_dataCount?" + key + "=" + value, {
			Search : Search,
			course_id : course_id,
			topic : topic,
			status : status,
	...
	function editData(id,system_id,degree_id,professional_id,course_id,topic,status) {
		$("#btn-update").show();
		$("#btn-save").hide();
		$("#tbl").hide();
		$("#btn-reload").hide();
	...
	function Validation() {
		...
		if (isNaN($("#topic").val()) == false) {
			alert("Please Enter Valid Topic.");
			$("input#topic").focus();
			return false;
		}
