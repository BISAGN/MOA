			...
			<div class="row align-items-center">
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="title mb-30">
						<h2>
							<span id="lbladd1"></span>Edit Teaching Learning Method
						</h2>
					</div>
				</div>
				<!-- end col -->
					...
					<div class="breadcrumb-wrapper mb-30">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Edit Teaching Learning Method</li>
							</ol>
						</nav>
					</div>
				</div>
		...
		<div class="form-elements-wrapper">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<!-- input style start -->
					<form:form name="course" id="edit_Teaching_Learning_Method"
						action="edit_Teaching_Learning_MethodAction" method='POST'
						commandName="edit_Teaching_Learning_MethodCMD"
						enctype="multipart/form-data">
						<div class="card-style mb-30">
							<div class="custom-field-block">
								<h6 class="mb-25">Edit Teaching Learning Method</h6>
								<div class="row">
...
<script nonce="${cspNonce}" type="text/javascript">
	...
	function addmoredatafetch1() {
		...
		var id = "${j[0]}";
		var teaching_learning_method = "${j[1]}";
// 		var no_of_activities = "${j[2]}";
		//	var non_lecture_hours = "${j[3]}";
		//	var term_id = "${j[4]}";

		$("#eid" + ind).val(id);
		$("#teaching_learning_method" + ind).val(teaching_learning_method);
			...
			$("table#att_Tb")
					.append(
							'<tr align="center" id="tr_id_att'+att+'"><td>'
									+ att
									+ '</td>'
									+ '<td class="min-width"><div class="input-style-2"><input type="text" id="teaching_learning_method'+att+'" name="teaching_learning_method'+att+'"  maxlength="500" class="form-control"  autocomplete="off" placeholder="Teaching Learning Method" ></div></td>'
