			...
			<div class="row align-items-center">
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="title mb-30">
						<h2>
							<span id="lbladd1"></span>Theory Learning Objectives
						</h2>
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="breadcrumb-wrapper mb-30">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Theory Learning Objectives</li>
							</ol>
						</nav>
					</div>
				</div>
		...
		<div class="form-elements-wrapper">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<!-- input style start -->
					<form:form name="course" id="theory_learning_object"
						action="theory_learning_objectAction" method='POST'
						commandName="theory_learning_objectCMD" enctype="multipart/form-data">
						<div class="card-style mb-30">
							<div class="custom-field-block">
								<h6 class="mb-25">Theory Learning Objectives</h6>
								<div class="row">
										...
										<table class="table" id="att_Tb">
											<thead>
												<tr>
													...
													<th rowspan="2"><h6>
															Millers Level:Does/Shows how/ Knows how/ Knows<span class="mandatory">*</span>
														</h6></th>
													<th rowspan="2"><h6>
															Specific Competency<span
													...
													<th rowspan="2"><h6>
															Guilbert's Level<span class="mandatory">*</span>
														</h6></th>
													<th rowspan="2"><h6>
															Must Know/ Desirable to know/ nice to know<span class="mandatory">*</span>
														</h6></th>
													<th rowspan="2"><h6>
															T-L Methods<span class="mandatory">*</span>
														</h6></th>
														<th rowspan="2"><h6>
													...
													<th rowspan="2"><h6>
															Summative Assessment<span class="mandatory">*</span>
																...
																<th rowspan="2"><h6>
															Integration Departments- Horizontal/ Vertical/ Spiral<span class="mandatory">*</span>
														</h6></th>
											...
											<tbody id="att_Tbbody">
												<tr id="tr_id_att">
													...
													<div class="input-style-1">
															<input type="text" id="generic_competency1"
																name="generic_competency1"
													...
													<td>
														<div class="input-style-1">
															<input type="text" id="subject_area1"
																name="subject_area1"
																class="autocomplete UpperClassName txt-transupp"
																autocomplete="off" 
													...
													<td>
														<div class="input-style-1">
															<input type="text" id="specific_competency1"
																name="specific_competency1"
																class="autocomplete UpperClassName txt-transupp"
																autocomplete="off" 
													...
													<td>
														<div class="input-style-1">
															<input type="text" id="slo_outcome1"
																name="slo_outcome1"
																class="autocomplete UpperClassName txt-transupp"
																autocomplete="off" 
																placeholder="SLO Outcome" />
														</div>
													</td>
													<td>
														<div class="select-style-1">
														...
														<div class="select-style-1">
															<div class="select-position">
																<select name="guilberts_level1" id="guilberts_level1">
																	<option value="0">--Select--</option>
																	<c:forEach var="item" items="${getguilberts_levelList}"
																		varStatus="num">
													...
													<td>
														<div class="select-style-1">
															<div class="select-position">
																<select name="tl_methods1" id="tl_methods1">
																	<option value="0">--Select--</option>
													...
													<td>
														<div class="select-style-1">
															<div class="select-position">
																<select name="form_assessment1" id="form_assessment1">
																	<option value="0">--Select--</option>
																	<c:forEach var="item" items="${getnch_formative_and_summativeList}"
																		varStatus="num">
														...
														<div class="select-style-1">
															<div class="select-position">
																<select name="summ_assessment1" id="summ_assessment1">
																	<option value="0">--Select--</option>
																	<c:forEach var="item" items="${getnch_formative_and_summativeList}"
																		varStatus="num">
																		<option value="${item.id}" name="${item.formative}">${item.formative}</option>
													...
													<td>
														<div class="input-style-1">
															<input type="text" id="int_departments1"
																name="int_departments1"
																class="autocomplete UpperClassName txt-transupp"
																autocomplete="off" 
																placeholder="Integration Departments" />
						...
						<div class="col-lg-12 col-md-12 col-sm-12">
							...
							<h6 class="mb-10">Learning Objectives (Theory) of Course HomUG-OM-I</h6>
								<div class="table-wrapper table-responsive simple-table custom-table-v2">
									<table class="table table-striped" id="pop">
										<thead>
											<tr>
<!-- 								<h6 class="mb-10">Table 3: Learning objectives (Theory) of Subject</h6> -->
...
function getpop() {
	...
	var learning_outcome = $("#learning_outcome_hid").val();
// 	var paper = "";
	var topic = "";
	$
	.post(
			"Nch_getView_All_Screenviewdata?" + key + "=" + value,
			{
				course_id : course_id
			},
			function(j) {
...
// 						topic = j[i][0];
						topic = j[i][0];
						learning_outcome = j[i][1];
						$("table#pop")
								.append(
										'<tr><td colspan="13"><p>Topic - '
												+ j[i][0]
												+ '</p></td></tr>'
												+'<tr><td colspan="12"><p>Learning Outcome - '
												+ j[i][1]
												+ '</p></td></tr>'
												+ '<tr>'
												+ '<td><p id="generic_competency">'
												+ j[i][2]
												+ '</p></td>'
												+ '<td><p id="subject_area">'
												+ j[i][3]
												+ '</p></td>'
												+ '<td><p id="rep_und">'
												+ j[i][4]
												+ '</p></td>'
												+ '<td><p id="specific_competency">'
												+ j[i][5]
												+ '</p></td>'
												+ '<td><p id="slo_outcome">'
												+ j[i][6]
												...
												+ j[i][12]
												+ '</p></td>'
												+ '<td><p id="int_departments">'
												+ j[i][13]
												+ '</p></td>'
												+ '</tr>');
					} 
					else {
						if (topic != j[i][0],learning_outcome != j[i][1]) {
							topic = j[i][0];
							learning_outcome = j[i][1];
							$("table#pop")
									.append(
...
// function getNCHTopicListbyCourse() {
// 	var course_id = $("#course_id").val();
// 	$
// 			.post('NchgetTopicListby_Course?' + key + "=" + value, {
// 				course_id : course_id
// 			})
// 			.done(
// 					function(j) {
		...
		$("table#att_Tb")
				.append(
						'<tr align="center" id="tr_id_att'+att+'"><td>'
								...
								+ '<input type="text" id="generic_competency'+att+'" name="generic_competency'+att+'" autocomplete="off"  placeholder="Generic Competency" /></div></td>'
								
								+ '<td><div class="input-style-1">'
								+ '<input type="text" id="subject_area'+att+'" name="subject_area'+att+'" autocomplete="off"  placeholder="Subject Area" /></div></td>'
								...
								+ '<td><div class="input-style-1">'
								+ '<input type="text" id="specific_competency'+att+'" name="specific_competency'+att+'" autocomplete="off"  placeholder="Specific Competency" /></div></td>'
								
								+ '<td><div class="input-style-1">'
								+ '<input type="text" id="slo_outcome'+att+'" name="slo_outcome'+att+'" autocomplete="off"  placeholder="SLO/ Outcome" /></div></td>'
								...
								+ '<td><div class="input-style-1">'
								+ '<input type="text" id="int_departments'+att+'" name="int_departments'+att+'" autocomplete="off"  placeholder="ntegration Departments" /></div></td>'
...
// 	if ($("#learning_outcome1").val() == "0") {
// 		alert("Please Select Learning Outcome.");
// 		$("select#learning_outcome1").focus();
// 		return false;
// 	}
