		...
		<div class="form-elements-wrapper">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<!-- input style start -->
					<form:form name="course" id="view_que_paper_blue_print_Action"
						action="view_que_paper_blue_print_Action" method='POST'
						commandName="view_que_paper_blue_print_CMD"
								...
								<div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12">
										...
										<ul class="buttons-group mainbtn">
											<li><a href="View_Que_Paper_Blue_Print_url"
...
<script nonce="${cspNonce}" type="text/javascript">
	...
	function getpop() {
		...
		$
				.post(
						"getView_QuePaperBluePrintviewdata?" + key + "="
								+ value,
						{
							course_id : course_id
						},
							...
							for (var i = 0; i < j.length; i++) {
								...
								if (paper == "PAPER I") {
									...
									if (quetyp == "MULTIPLE CHOICE QUESTIONS") {
										...
										$
												.post(
														"getPaper_Format_data?"
																+ key + "="
																+ value,
														{
															course_id : course_id,
															d3_desirable_know : '5,6,7',
															qt : 'mcq',
															paper : paper
														},
														function(j) {
