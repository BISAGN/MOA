			...
			<div class="row align-items-center">
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="title mb-30">
						<h2>
							<span id="lbladd1"></span>Search T3-Theory Learning Objectives
						</h2>
					</div>
				</div>
				<!-- end col -->
						...
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Search
									T3-Theory Learning Objectives</li>
							</ol>
						</nav>
					</div>
				</div>
		...
		<div class="form-elements-wrapper">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<!-- input style start -->
					<form:form name="course" id="t3_learning_object"
						action="t3_learning_objectAction" method='POST'
						commandName="t3_learning_objectCMD" enctype="multipart/form-data">
						<div class="card-style mb-30">
							<div class="custom-field-block">
								<h6 class="mb-25">Search T3-Theory Learning Objectives</h6>
								<div class="row">
									<div
								...
								<div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12">
										<ul class="buttons-group mainbtn">
											...
											<li><a href="T3_Learning_Object_Url"
			...
			<div class="modal fade custom-modal bd-example-modal-lg"
				...
				<div class="modal-dialog modal-xl modal-dialog-scrollable">
					...
					<div class="modal-header">
							<h3 class="modal-title">Table 3: Learning objectives (Theory) of Subject
							</h3>
							...
							<div class="custom-modal-inner">
								<div class="table-wrapper table-responsive custom-table">
									<table class="table model-table"
										id="T3SearchLearningObject_ChildUrl">
										<thead>
											<tr>
												<th><h6>Sr No</h6></th>
												<!-- 0 -->
...
<c:url value="Edit_T3_Search_Learning_Object_Url"
	var="Edit_T3_Search_Learning_Object_Url" />
<form:form action="${Edit_T3_Search_Learning_Object_Url}" method="post"
	id="editForm" name="editForm" modelAttribute="id1">
	<input type="hidden" name="id1" id="id1" />
</form:form>

<c:url value="delete_T3_Search_Learning_Object_Url"
	var="delete_T3_Search_Learning_Object_Url" />
<form:form action="${delete_T3_Search_Learning_Object_Url}"
...
function getTopicListbyCourse() {
	...
	$
			.post('getTopicListby_Course?' + key + "=" + value, {
				course_id : course_id
			})
			.done(
					function(j) {
...
function data(search_Topic) {
	...
	$.post("getFilterT3SearchLearningObject_data?" + key + "=" + value, {
		startPage : startPage,
...
// 		}
	...
	$.post("getTotalT3SearchLearningObject_dataCount?" + key + "=" + value, {
		system_id:system_id,
		degree_id:degree_id,
		professional_id:professional_id,
		course_id:course_id,
...
// 	debugger;
	$('tbody#att_TbbodyNameMed').empty();
		$
				.post( 
						"T3SearchLearningObject_ChildUrl?" + key
								+ "=" + value,
						{
							hid : hid
						},
