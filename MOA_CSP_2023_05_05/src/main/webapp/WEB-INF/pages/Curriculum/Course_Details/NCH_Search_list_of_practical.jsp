			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					...
					<form:form name="searchlist_practical" id="searchlist_practical"
						action="nch_searchlist_practicalAction" method='POST'
						commandName="nch_searchlist_practicalCMD"
			...
			<div class="col-lg-12 col-md-12 col-sm-12">
				<div class="card-style mb-30">
					<div class="table-wrapper table-responsive custom-datatable-p">
						<table class="table" id="nch_search_Practical">
							<thead>
								<tr>
									<th><h6>Sr No</h6></th>
					...
					<div class="modal-body custom-modal-table">
						<div class="custom-modal-inner">
							<div class="table-wrapper table-responsive custom-table">
								<table class="table model-table" id="NchPractical_ChildUrl">
									<thead>
										<tr>
											<th>Sr No</th>
											<th>Practical</th>
											...
											<th>Term</th>
											<th>Hours</th>
											<th>Demonstration/Performance</th>
										</tr>
									</thead>
...
<c:url value="Nch_Edit_Practical_Url" var="Nch_Edit_Practical_Url" />
<form:form action="${Nch_Edit_Practical_Url}" method="post" id="editForm"
	name="editForm" modelAttribute="id1">
	<input type="hidden" name="id1" id="id1" />
</form:form>

<c:url value="Nch_deletePractical_Url" var="Nch_deletePractical_Url" />
<form:form action="${Nch_deletePractical_Url}" method="post" id="deleteForm"
...
$(document).ready(function() {
	...
	mockjax1('nch_search_Practical');
	table = dataTable('nch_search_Practical');
...
function data(nch_search_Practical) {
	jsondata = [];
	var table = $('#' + nch_search_Practical).DataTable();
	...
	$.post("getFilterNCH_Practical_data?" + key + "=" + value, {
		startPage : startPage,
	...
	$.post("getTotalNCH_Practical_dataCount?" + key + "=" + value, {
		system_id:system_id,
		degree_id:degree_id,
		professional_id:professional_id,
		course_id:course_id,
