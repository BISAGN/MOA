			...
			<div class="row align-items-center">
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="title mb-30">
						<h2>
							<span id="lbladd1"></span>Search T2 - Add Content Of Subject
						</h2>
					</div>
				</div>
				<!-- end col -->
					...
					<form:form name="search_list_topics" id="search_list_topics"
						...
						<div class="card-style mb-30">
							<div class="custom-field-block">
								<h6 class="mb-25">Search T2 - Add Content Of Subject</h6>
								<div class="row">
		...
		<div class="modal fade custom-modal bd-example-modal-lg" tabindex="-1"
			...
			<div class="modal-dialog modal-xl modal-dialog-scrollable">
				...
				<div class="modal-header">
							<h3 class="modal-title">Contents of Subject
							</h3>
					...
					<div class="modal-body custom-modal-table">
						<div class="custom-modal-inner">
							<div class="table-wrapper table-responsive custom-table">
								<table class="table model-table" id="Topic_ChildUrl">
									<thead>
										<tr>
											<th>Sr No</th>
											<th>Topic</th>
...
<c:url value="Edit_Topic_Url" var="Edit_Topic_Url" />
<form:form action="${Edit_Topic_Url}" method="post" id="editForm"
	name="editForm" modelAttribute="id1">
	<input type="hidden" name="id1" id="id1" />
</form:form>

<c:url value="deleteTopic_Url" var="deleteTopic_Url" />
<form:form action="${deleteTopic_Url}" method="post" id="deleteForm"
...
function data(search_Topic) {
	...
	$.post("getFilterTopic_data?" + key + "=" + value, {
		startPage : startPage,
		...
		for (var i = 0; i < j.length; i++) {
			jsondata.push([ j[i].ser,j[i].system_name,j[i].degree_name,j[i].professional, j[i].course_name ,j[i].paper,j[i].vd,j[i].action]);
		}
	});
	$.post("getTotalTopic_dataCount?" + key + "=" + value, {
		system_id:system_id,
		degree_id:degree_id,
		professional_id:professional_id,
		course_id:course_id,
