			...
			<div class="row">
				<div class="col-12">
					...
					<form:form name="editlist_practical" id="edit_list_practical"
						action="edit_list_practicalAction" method='POST'
						commandName="edit_list_practicalCMD" enctype="multipart/form-data">
										...
										<table class="table" id="att_Tb">
											<thead>
												<tr>
													...
													<th rowspan="2"><h6>Practical</h6></th>
													<th rowspan="2"><h6>Term</h6></th>
													<th rowspan="2"><h6>Activity/Practical
															Description</h6></th>
						...
						<ul class="buttons-group mainbtn">
							...
							<li> <a href="Search_List_of_practical_Url" class="main-btn dark-btn-outline  btn-hover btn-iconic-icon">
...
<script nonce="${cspNonce}" type="text/javascript">
	...
	function addmoredatafetch1() {
		...
		var practical = "${j[1]}";
		var term_id = "${j[2]}";
		var activity_practical_description = "${j[3]}";

		$("#eid" + ind).val(id);
		$("#practical" + ind).val(practical);
		$("#term_id" + ind).val(term_id);
		$("textarea#activity_practical_description" + ind).val(
				activity_practical_description);
			...
			$("table#att_Tb")
					.append(
							'<tr align="center" id="tr_id_att'+att+'"><td>'
									+ att
									+ '</td>'
									+ '<td class="min-width"><div class="input-style-2"><input type="text" id="practical'+att+'" name="practical'+att+'"  maxlength="25" class="form-control"  autocomplete="off" placeholder="Practical" ></div></td>'
									...
									+ '</select></div></div> </td>'
									+ '<td class="min-width"><div class="input-style-2"><textarea id="activity_practical_description'+att+'" name="activity_practical_description'+att+'"   class="form-control"  autocomplete="off" placeholder="Activity Practical Description" ></textarea></div></td>'
