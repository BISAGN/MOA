			...
			<div class="row align-items-center">
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="title mb-30">
						<h2>
							<span id="lbladd1"></span>List of Practical
						</h2>
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<form:form name="list_practical" id="list_practical"
						action="Nch_list_practicalAction" method='POST'
						commandName="Nch_list_practicalCMD" enctype="multipart/form-data">
						<div class="card-style mb-30">
						<div class="custom-field-block">
							<h6 class="mb-25">List of Practical</h6>
							<div class="row">
								...
								<div class="col-12 col-sm-12 col-md-6 col-lg-4">
									<div class="select-style-1">
										...
										<div class="select-position">
											<select class="singleselect form-control form-control-lg" id="course_id" name="course_id" > 
												<option value="0">--Select--</option>
											</select>
										</div>
									</div>
								...
								<div class="col-12 col-sm-12 col-md-6 col-lg-4">
									<div class="select-style-1">
										...
										<div class="select-position">
											<select class="singleselect form-control form-control-lg" id="practical_id" name="practical_id" >
												<option value="0">--Select--</option>
											</select>
										</div>
									</div>
											...
											<thead>
												<tr>
													<th rowspan="2"><h6>Sr No</h6></th>
														...
														<th rowspan="2"><h6>
															Sub Practical<span></span>
														</h6></th>
													<th rowspan="2"><h6>
															Term<span class="mandatory">*</span>
														</h6></th>
													<th rowspan="2"><h6>
															Hours<span class="mandatory" maxlength="100">*</span>
														</h6></th>
														<th rowspan="2"><h6>
															Demonstration/Performance<span></span>
														</h6></th>
												...
												<tr id="tr_id_att">
													...
													<td class="min-width">
														<div class="input-style-1">
															<input type="text" id="sub_practical1" name="sub_practical1"
																class="form-control" autocomplete="off"
																placeholder="Sub Practical">
														</div>
													</td>
													<td>
														<div class="select-style-1">
...
<%-- 																	</c:forEach> --%>
													...
													<td class="min-width">
														<div class="input-style-1">
															<input id="hours1"
																name="hours1" autocomplete="off" 
																placeholder="Hours">
														</div>
													</td>
													<td class="min-width">
														<div class="input-style-1">
															<input id="demo_perform1"
																name="demo_perform1"  autocomplete="off"
																placeholder="Demonstration/Performance">
<!-- 																rows="5" cols="50" -->
														</div>
													</td>
													<td>
							...
							<ul class="buttons-group mainbtn">
								...
								<li><a href="Nch_list_of_practical_url"
							...
							<thead>
								<tr>
									...
									<th><h6>Practical</h6></th>
											<th><h6>Sub Practical</h6></th>
											<th><h6>Term</h6></th>
									<th><h6>Hours</h6></th>
									<th><h6>Demonstration/Performance</h6></th>
...
<script nonce="${cspNonce}" type="text/javascript">
	...
	function getdegreelistbysystem() {
		...
		$
				.post('getDegreeListbysystem_nch?' + key + "=" + value, {
	...
	document
			.addEventListener(
					...
					function() {
						...
						document.getElementById('hours1').onkeypress = function() {
							return isNumberKey0to9(event, this);
						};
						// 	document.getElementById('practical1').onkeypress = function() {
...
// 						};
	...
	function getpop() {
		...
		$.post("getNch_ListOfPracticalsviewdata?" + key + "=" + value, {
			course_id : course_id
		}, function(j) {
			for (var i = 0; i < j.length; i++) {
				// 			paper = j[i][4];
