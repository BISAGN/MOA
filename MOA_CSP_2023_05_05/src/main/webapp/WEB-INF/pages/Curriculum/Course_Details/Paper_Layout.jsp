			...
			<div class="row align-items-center">
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="title mb-30">
						...
						<h2>
							<span id="lbladd"></span> T6-e-Add Paper Layout
						</h2>
					</div>
				</div>
				<!-- end col -->
					...
					<div class="breadcrumb-wrapper mb-30">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">T6-e-Add
									Paper Layout</li>
							</ol>
						</nav>
					</div>
		...
		<div class="form-elements-wrapper">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<!-- input style start -->
					<form:form name="PaperLayoutform" id="PaperLayoutform"
						action="PaperLayoutAction" method="post" class="form-horizontal"
						modelAttribute="PaperLayoutCMD">
						<div class="card-style mb-30">
							<div class="custom-field-block">
								<h6 class="mb-25">T6-e-Add Paper Layout</h6>
								<div class="row">
								...
								<div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12">
										<ul class="buttons-group mainbtn">
											...
											<li><a id="btn-reload1" href="Paper_Layout_Url"
											...
											<li><a id="btn-reload2" href="Paper_Layout_Url"
...
<c:url value="Edit_Paper_Layout_Url" var="Edit_Url" />
<form:form action="${Edit_Url}" method="post" id="updateForm"
	name="updateForm" modelAttribute="id2">
	<input type="hidden" name="id2" id="id2">
</form:form>

<c:url value="Paper_Layout_Delete_Url" var="deleteUrl" />
...
// 		};
		...
		document.querySelectorAll('.ADDpaper_layout').forEach((items, index) => {
			items.addEventListener('click', event => {
				...
				if (confirm('Are You Sure You Want to Edit Detail ?')) {
					editData(hid,haps,hapd,happ,hapc,hpaper,htime,hins,hqtype,hnumq,hmarq,hstatus);
				} else {
					return false;
				}
			})
	...
	function data(search_Paper_Layout) {
		...
		$.post("getFilterpaper_layout_data?" + key + "=" + value, {
			startPage : startPage,
			...
			for (var i = 0; i < j.length; i++) {
				jsondata.push([ j[i].ser,j[i].system_name,j[i].degree_name,j[i].professional, j[i].course_name, j[i].paper, j[i].time, j[i].instructions, j[i].question_type, j[i].num_questions, j[i].marks_questions, j[i].action ]);
			}
		});
		$.post("getTotalpaper_layout_dataCount?" + key + "=" + value, {
			Search : Search,
			system_id : system_id,
			degree_id : degree_id,
			professional_id : professional_id,
	...
	function editData(id,system_id,degree_id,professional_id,course_id,paper_id,time,instructions,question_type_id,num_questions,marks_questions,status) {
	...
	function getpop() {
		...
		var course_id = $("#course_id").val();
		var temp_count = 0;
		$.post("getPaperLayout0viewdata?"+key+"="+value,{course_id:course_id},function(j) {
		...
		$.post("getPaperLayoutviewdata?"+key+"="+value,{course_id:course_id},function(j) {
			for(var i=0;i<j.length;i++){
//	 			paper = j[i][4];
//	 			if(paper == "PAPER I"){
					$("table#pop").append('<tr>' 
...
//	 			}
	...
	function getpop2() {
		...
		var course_id = $("#course_id").val();
		var temp_count2 = 0;
		$.post("getPaperLayout2viewdata?"+key+"="+value,{course_id:course_id},function(j) {
