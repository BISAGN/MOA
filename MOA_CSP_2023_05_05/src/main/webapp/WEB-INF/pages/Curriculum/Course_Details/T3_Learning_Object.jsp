			...
			<div class="row align-items-center">
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="title mb-30">
						<h2>
							<span id="lbladd1"></span>T3 - Theory Learning Objectives
						</h2>
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="breadcrumb-wrapper mb-30">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">T3 -
					...
					<form:form name="course" id="t3_learning_object"
						...
						<div class="card-style mb-30">
							<div class="custom-field-block">
								<h6 class="mb-25">T3 - Theory Learning Objectives</h6>
								<div class="row">
										...
										<table class="table" id="att_Tb">
											...
											<tbody id="att_Tbbody">
												<tr id="tr_id_att">
													...
													<td>
														<!-- 								<div class="select-style-1"> --> <!-- 									<div class="select-position"> -->
														<!-- 										<select name="b3_learning_obj1" id="b3_learning_obj1"> -->
														<!-- 									  <option value="0">--Select--</option> -->
														<%-- 										<c:forEach var="item" items="${getCourse_OutcomeList}" varStatus="num"> --%>
...
<%-- 																	</c:forEach> --%>
													...
													<!-- 								<div class="select-style-1"> -->
													<!-- 									<div class="select-position"> -->
													<!-- 										<select name="j3_integration1" id="j3_integration1" > -->
													<!-- 											<option value="0">--Select--</option> -->
													<%-- 											<c:forEach var="item" items="${geti3_termList}" varStatus="num"> --%>
													<%-- 												<option value="${item.id}" name="${item.term}">${item.term}</option> --%>
													<%-- 											</c:forEach> --%>
													<!-- 										</select> -->
													<!-- 								    </div> -->
								...
								<div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12">
										<ul class="buttons-group mainbtn">
											<li><a href="T3_Search_Learning_Object_Url"
...
<!-- 													<tr> -->
														...
														<th><h6>D3 Must to know
																desirable to know/Nice to know</h6></th>
														<th><h6>E3 Level Does/
...
<script nonce="${cspNonce}" type="text/javascript">
	function getpop() {
		...
		$.post("getView_All_Screenviewdata?" + key + "=" + value,
						{
							course_id : course_id
						},
						function(j) {
			...
			$("table#att_Tb")
					.append(
							'<tr align="center" id="tr_id_att'+att+'"><td>'
									...
									+ '<input type="text" id="b3_learning_obj'+att+'" name="b3_learning_obj'+att+'" autocomplete="off" maxlength="250" placeholder="B3 Learning Obj" /></div></td>'
...
// 									+ '<c:forEach var="item" items="${geti3_termList}" varStatus="num"><option value="${item.id}" name="${item.term}">${item.term}</option></c:forEach>'
									+ '</select></div></div> </td>'
									+ '<td><div class="input-style-1">'
									+ '<input type="text" id="j3_integration'+att+'" name="j3_integration'+att+'" autocomplete="off" maxlength="250" placeholder="J3 Integration" /></div></td>'
