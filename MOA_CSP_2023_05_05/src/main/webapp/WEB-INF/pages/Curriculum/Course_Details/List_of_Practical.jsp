			...
			<div class="row align-items-center">
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="title mb-30">
						<h2>
							<span id="lbladd1"></span> Add List of Practical
						</h2>
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
		...
		<div class="form-elements-wrapper">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<form:form name="list_practical" id="list_practical"
						action="list_practicalAction" method='POST'
						commandName="list_practicalCMD" enctype="multipart/form-data">
						<div class="card-style mb-30">
							<div class="custom-field-block">
								<h6 class="mb-25">Add List of Practical</h6>
								<div class="row">
											...
											<table class="table" id="att_Tb">
												<thead>
													<tr>
														...
														<th rowspan="2"><h6>
																Practical<span class="mandatory" maxlength="500">*</span>
															</h6></th>
														<th rowspan="2"><h6>
																Term<span class="mandatory">*</span>
															</h6></th>
														<th rowspan="2"><h6>
																Activity/Practical Description/Hours<span
																	class="mandatory" maxlength="1000">*</span>
															</h6></th>
													...
													<tr id="tr_id_att">
														...
														<td class="min-width">
															<div class="input-style-1">
																<input type="text" id="practical1" name="practical1"
														...
														<td class="min-width">
															<div class="input-style-1">
																<textarea id="activity_practical_description1"
																	name="activity_practical_description1" rows="5"
																	cols="50" autocomplete="off" maxlength="250"
																	placeholder="Activity/Practical Description"></textarea>
															</div>
														</td>
														<td>
								...
								<div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12">
										<ul class="buttons-group mainbtn">
											<li><a href="Search_List_of_practical_Url"
					...
					<div class="col-lg-12">
						<div class="card-style mb-30">
							<div class="custom-multi-table">
								...
								<h6 class="mb-10">List of Practicals</h6>
								...
								<div
									...
									<table class="table table-striped" id="pop">
										<thead>
											...
											<tr>
												<th><h6>Sr No</h6></th>
												<th><h6>Name of Practical</h6></th>
												<th><h6>Term</h6></th>
												<th><h6>Activity/Practical Description/Hours</h6></th>
...
<script nonce="${cspNonce}" type="text/javascript">
			...
			$("table#att_Tb")
					.append(
							'<tr align="center" id="tr_id_att'+att+'"><td>'
									+ att
									+ '</td>'
									+ '<td class="min-width"><div class="input-style-1"><input type="text" id="practical'+att+'" name="practical'+att+'" class="form-control"  autocomplete="off" placeholder="Practical" ></div></td>'
									...
									+ '</select></div></div> </td>'
									+ '<td class="min-width"><div class="input-style-1"><textarea id="activity_practical_description'+att+'" name="activity_practical_description'+att+'"  class="form-control"  autocomplete="off" placeholder="Activity/Practical Description" ></textarea></div></td>'
	...
	function Validation() {
		...
		for (var i = 1; i <= count; i++) {
			...
			if ($("#activity_practical_description" + i).val().trim() == "") {
				alert("Please Enter Activity Practical Description.");
				$("#activity_practical_description" + i).focus();
				return false;
			}
		}
	}
	...
	function getpop() {
		...
		$.post("getListOfPracticalsviewdata?" + key + "=" + value, {
			course_id : course_id
		}, function(j) {
			for (var i = 0; i < j.length; i++) {
				$("table#pop").append(
						'<tr>' + '<td><p id="sr_no">' + j[i][0] + '</p></td>'
								+ '<td><p id="practical">' + j[i][1]
								+ '</p></td>' + '<td><p id="term">' + j[i][2]
								+ '</p></td>' + '<td><p id="activity_practical_description">' + j[i][3]
								+ '</p></td>' + '</tr>');
				// 			}
			}
		});
