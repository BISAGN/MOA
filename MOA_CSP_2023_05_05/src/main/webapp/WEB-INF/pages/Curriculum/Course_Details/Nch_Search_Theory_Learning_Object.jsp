...
<section class="dashboard-page">
	<div class="container-fluid">
			...
			<div class="row align-items-center">
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="title mb-30">
						<h2>
							<span id="lbladd1"></span>Search Theory Learning Objectives
						</h2>
					</div>
				</div>
				<!-- end col -->
		...
		<div class="form-elements-wrapper">
					...
					<form:form name="course" id="theory_learning_object"
						...
						<div class="card-style mb-30">
							<div class="custom-field-block">
								<h6 class="mb-25">Search Theory Learning Objectives</h6>
								<div class="row">
									<div
								...
								<div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12">
										<ul class="buttons-group mainbtn">
											...
											<!-- 							<li> -->
											<!-- 								<a href="T3_Search_Learning_Object_Url" class="main-btn dark-btn n btn-hover " type="button">Reset</a> -->
											<!-- 							</li> -->
											<li>
												<!-- 							   <a href="T3_Search_Learning_Object_Url" class="main-btn secondary-btn btn-hover btn-iconic-icon" type="button">Search</a> -->
												<a id="btn-reload"
			...
			<!-- 				<table class="table" id="nch_search_Topic"> -->
			<!-- 					<thead> -->
			<!-- 							<tr>  -->
			<!-- 								<th rowspan="2"><h6>Sr No</h6></th> -->
			<!-- 									<th rowspan="2"><h6>A3 Course Outcome</h6></th> -->
			<!-- 									<th rowspan="2"><h6>B3 Learning Objective(At the end of the session,the students should be able to)</h6></th> -->
			<!-- 									<th rowspan="2"><h6>C3 Domain/sub</h6></th> -->
			<!-- 									<th rowspan="2"><h6>D3 Must to know/desirable to know/Nice to know</h6></th> -->
			<!-- 									<th rowspan="2"><h6>E3 Level Does/Shows how/Knows how/Know</h6></th> -->
			<!-- 									<th rowspan="2"><h6>F3 T-L method</h6></th> -->
			<!-- 									<th rowspan="2"><h6>G3 Assessment</h6></th> -->
			<!-- 									<th rowspan="2"><h6>H3 Formative/Summative</h6></th> -->
			<!-- 									<th rowspan="2"><h6>I3 Term</h6></th> -->
			<!-- 									<th rowspan="2"><h6>J3 Integration</h6></th> -->
							...
							<div class="custom-modal-inner">
								<div class="table-wrapper table-responsive custom-table">
									<table class="table model-table"
										id="NCHSearchLearningObject_ChildUrl">
										<thead>
											<tr>
												<th><h6>Sr No.</h6></th>
...
<c:url value="Edit_NCH_Search_Learning_Object_Url"
	var="Edit_NCH_Search_Learning_Object_Url" />
<form:form action="${Edit_NCH_Search_Learning_Object_Url}" method="post"
	id="editForm" name="editForm" modelAttribute="id1">
	<input type="hidden" name="id1" id="id1" />
</form:form>

<c:url value="delete_NCH_Search_Learning_Object_Url"
	var="delete_NCH_Search_Learning_Object_Url" />
<form:form action="${delete_NCH_Search_Learning_Object_Url}"
...
$(document).ready(function() {
	...
	mockjax1('nch_search_Topic');
	table = dataTable('nch_search_Topic');
...
function data(nch_search_Topic) {
	jsondata = [];
	var table = $('#' + nch_search_Topic).DataTable();
	...
	$.post("getFilterNCHSearchLearningObject_data?" + key + "=" + value, {
		startPage : startPage,
...
// 		}
		...
		for (var i = 0; i < j.length; i++) {
			jsondata.push([ j[i].ser,j[i].system_name,j[i].degree_name,j[i].professional,j[i].course_name,j[i].topic,
				j[i].vd,j[i].action]);
		}
	});
	$.post("getTotalNCHSearchLearningObject_dataCount?" + key + "=" + value, {
		system_id:system_id,
		degree_id:degree_id,
		professional_id:professional_id,
		course_id:course_id,
...
function setTimeLoadForTable(){
	...
	document.querySelectorAll('.daobtn').forEach((items, index) => {
		items.addEventListener('click', event => {
// 			debugger;
			var val=parseInt(index)+1;
...
// 	debugger;
	$('tbody#att_TbbodyNameMed').empty();
		$
				.post( 
						"NCHSearchLearningObject_ChildUrl?" + key
								+ "=" + value,
						{
							hid : hid
						},
