...
<section class="dashboard-page">
	<div class="container-fluid">
					...
					<div class="breadcrumb-wrapper mb-30">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page"> Add Assessment Summary</li>
							</ol>
						</nav>
					</div>
				</div>
		...
		<form:form name="Nch_Examination_Summary"
						id="Nch_Examination_Summary" action="Nch_Examination_Summaryaction" method="POST"
						class="form-horizontal" modelAttribute="Nch_Examination_SummaryCMD">
					...
					<!-- input style start -->
						...
						<div class="card-style mb-30">
							<div class="custom-field-block">
								<h6 class="mb-25"> Add Assessment Summary</h6>
								<div class="row">
											...
											<div class="col-lg-12 col-md-12 col-sm-12">
												<ul class="buttons-group mainbtn">
													...
													<li><input type="submit" id="btn-update"
														...
														value="Update"></li>
													<li><a href="Nch_Examination_SummUrl"
	...
	function Validation() {
		...
		for (var j = 1; j <= parseInt(count_exam); j++) {
			...
			if ($("#theory_comp_marks" + j).val().trim() == "" || $("#theory_comp_marks" + j).val().trim() == "0") {
				alert("Please Enter Theory Comp Marks.");
...
// 			debugger;
			if(Validation()){
				 $("#Nch_Examination_Summary").submit();
			}
		};
...
// 							}
	...
	function fetchNchsaveddata() {
		...
		$.post('getfetchNchsaveddata_ctrl?' + key + "=" + value,
						{
							system_id : system_id,
							degree_id : degree_id,
							professional_id:professional_id,
...
function fetchNchexam_sumdata(p_id) {
	
	$.post('getfetchNchexam_sumsaveddata_ctrl?' + key + "=" + value,{p_id : p_id}).done(function(j) {
