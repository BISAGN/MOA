...
<section class="dashboard-page">
			...
			<div class="row align-items-center">
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="title mb-30">
						<h2>
							<span id="lbladd1"></span>Topic Wise Learning Outcomes
						</h2>
					</div>
				</div>
				<!-- end col -->
					...
					<div class="breadcrumb-wrapper mb-30">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Topic Wise Learning Outcomes</li>
							</ol>
						</nav>
					</div>
				</div>
		...
		<div class="form-elements-wrapper">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<!-- input style start -->
					<form:form name="Topic_Learning_Outcome"
						id="Topic_Learning_Outcome"
						action="Topic_Learning_OutcomeAction" method='POST'
						commandName="Topic_Learning_OutcomeCMD"
						enctype="multipart/form-data">
						<div class="card-style mb-30">
							<div class="custom-field-block">
								<h6 class="mb-25">Topic Wise Learning Outcomes</h6>
								<div class="row">
												...
												<tr id="tr_id_att">
													...
													<td class="min-width">
														<div class="input-style-1">
															<input type="text" id="learning_outcome1"
																name="learning_outcome1" maxlength="500"
					...
					<div class="col-lg-12 col-md-12 col-sm-12">
						<div class="card-style mb-30">
							<div class="table-wrapper table-responsive custom-datatable-p">
								<table class="table" id="tb_topic_learning_outcome">
									<thead>
										<tr>
			...
			<div class="modal fade custom-modal bd-example-modal-lg"
				...
				<div class="modal-dialog modal-lg modal-dialog-scrollable">
					...
					<div class="modal-header">
							<h3 class="modal-title">Topic Wise Learning Outcomes</h3>
 ...
 <c:url value="Edit_Topic_Learning_OutcomeUrl"
	var="Edit_Topic_Learning_OutcomeUrl" />
<form:form action="${Edit_Topic_Learning_OutcomeUrl}" method="post"
	id="editForm" name="editForm" modelAttribute="id1">
	<input type="hidden" name="id1" id="id1" />
</form:form>

<c:url value="deleteTopic_Learning_OutcomeUrl"
	var="deleteTopic_Learning_OutcomeUrl" />
<form:form action="${deleteTopic_Learning_OutcomeUrl}"
...
$(document).ready(function() {
	...
	$("#pop").hide();
	mockjax1('tb_topic_learning_outcome');
	table = dataTable('tb_topic_learning_outcome');
	...
	$("#att_Tb").show();
		 ...
		 if(att < 51){
				 ...
				 $("table#att_Tb").append('<tr align="center" id="tr_id_att'+att+'"><td>'+att+'</td>'
					 +'<td class="min-width"><div class="input-style-1"><input type="text" id="learning_outcome'+att+'" name="learning_outcome'+att+'"  maxlength="500" class="form-control"  autocomplete="off" placeholder="Learning Outcomes" ></div></td>'
...
function Validation() {
	...
	for(var i=1;i<=count;i++){
		...
		if ($("#learning_outcome"+i).val() == "") {
			alert("Please Enter Learning Outcomes.");
			$("#learning_outcome"+i).focus();
			return false;
		}
	}
	return true;	
...
function data(search_Teaching_Learning_Method) {
	...
	$.post("getFilterLearning_Outcomedata?" + key + "=" + value, {
		startPage : startPage,
		...
		for (var i = 0; i < j.length; i++) {
			jsondata.push([ j[i].ser,j[i].system_name,j[i].degree_name,j[i].professional, j[i].course_name ,j[i].topic,j[i].vd,j[i].action]);
		}
	});
	$.post("getTotalLearning_OutcomedataCount?" + key + "=" + value, {
		system_id:system_id,
		degree_id:degree_id,
		professional_id:professional_id,
		course_id:course_id,
...
function Pop_Up_view_child_data(hid) {
	...
	$('tbody#att_TbbodyNameMed').empty();
		$
				.post( 
						"Topic_Learning_Outcome_ChilddUrl?" + key
								+ "=" + value,
						{
							hid : hid
						},
