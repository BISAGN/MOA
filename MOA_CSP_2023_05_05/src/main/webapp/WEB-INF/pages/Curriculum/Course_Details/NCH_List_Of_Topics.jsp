			...
			<div class="row align-items-center">
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="title mb-30">
						<h2>
							<span id="lbladd1"></span>List Of Topics
						</h2>
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					...
					<form:form name="list_topics" id="list_topics"
						action="NCH_list_topicsAction" method='POST'
						commandName="NCH_list_topicsCMD" enctype="multipart/form-data">
						<div class="card-style mb-30">
							<div class="custom-field-block">
								<h6 class="mb-25">List Of Topics</h6>
								<div class="row">
							...
							<section class="single-detail-block">
								<div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12">
										<div
											class="table-wrapper table-responsive custom-table-p custom-table b-top mt-0">
											<table class="table" id="att_Tb">
												<thead>
													<tr>
														...
														<th rowspan="2"><h6>
																Sub Topics<span></span>
															</h6></th>
														<th rowspan="2"><h6>
																Hours<span class="mandatory">*</span>
															</h6></th>
														<th rowspan="2"><h6>
													...
													<tr id="tr_id_att">
														...
														<td class="min-width">
															<div class="input-style-1">
																<input type="text" id="sub_topic1" name="sub_topic1"
														...
														<td class="min-width">
															<div class="input-style-1">
																<input type="text" id="hours1" name="hours1"
																	class="form-control" autocomplete="off"
																	placeholder="Hours">
															</div>
														</td>
														<td>
															<div class="select-style-1">
																<div class="select-position">
																	<select class="form-control" name="term_id1"
																		id="term_id1">
																		<option value="0">--Select--</option>
								...
								<div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12">
										<ul class="buttons-group mainbtn">
											...
											<li><a href="NCH_list_of_topics_url"
			...
			<section class="single-detail-block">
				<div class="row">
					<div id="pop">
						<div class="col-lg-12 col-md-12 col-sm-12">
								<div class="card-style mb-30">
									<h6 class="mb-10">List Of Topics</h6>
...
<script nonce="${cspNonce}" type="text/javascript">
	...
	function getpop() {
		...
		$.post("getNch_View_data?" + key + "=" + value, {
			course_id : course_id
		}, function(j) {
			for (var i = 0; i < j.length; i++) {
				if (i == 0) {
					...
					topic = j[i][0];
					$("table#pop").append(
							'<tr>' + '<tr>' + '<td><p id="sr_no">' + j[i][0]
									+ '</p></td>' 
									+ '<td><p id="topic_id">'
									+ j[i][1] 
									+ '</p></td>'
									+ '<td><p id="sub_topic">' + j[i][2]
									+ '</p></td>' + '<td><p id="hours">'
									+ j[i][3] + '</p></td>'
									+ '<td><p id="term_id">' + j[i][4]
									+ '</p></td>' + '</tr>');
				} else {
			...
			$("table#att_Tb")
					.append(
							'<tr align="center" id="tr_id_att'+att+'"><td>'
									+ att
									+ '</td>'
									+ '<td class="min-width"><div class="input-style-1"><input type="text" id="sub_topic'+att+'" name="sub_topic'+att+'"   class="form-control"  autocomplete="off" placeholder="Sub Topics" ></div></td>'
...
// 			getTopiclistbyCourse(att);
	...
	document.addEventListener('DOMContentLoaded', function() {
		...
		// 		document.getElementById('sub_topic1').onkeypress = function() {
...
// 		};
	...
	function addOnclick(index) {
		...
		// 		document.getElementById('sub_topic1' + index).onkeypress = function() {
		// 			return OnlyAlphaNumericWithoutSpace(event);
		// 		};
	}
