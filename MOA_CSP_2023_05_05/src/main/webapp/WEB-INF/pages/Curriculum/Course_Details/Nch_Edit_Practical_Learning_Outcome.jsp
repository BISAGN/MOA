			...
			<div class="row align-items-center">
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="title mb-30">
						<h2>
							<span id="lbladd1"></span>Edit Practical Wise Learning Outcomes
						</h2>
					</div>
				</div>
				<!-- end col -->
					...
					<div class="breadcrumb-wrapper mb-30">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Edit Practical Wise Learning Outcomes</li>
							</ol>
						</nav>
					</div>
				</div>
		...
		<div class="form-elements-wrapper">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<!-- input style start -->
					<form:form name="Edit_Practical_Learning_Outcome" id="Edit_Practical_Learning_Outcome"
					   action="edit_practical_learning_outcomeAction" method='POST'
						commandName="edit_practical_learning_outcomeCMD"
						enctype="multipart/form-data">
						<div class="card-style mb-30">
							<div class="custom-field-block">
								<h6 class="mb-25">Edit Practical Wise Learning Outcomes</h6>
								<div class="row">
									...
									<div class="col-12 col-sm-12 col-md-6 col-lg-4">
										<div class="select-style-1">
											<label for="text-input">Practicals<span
												class="mandatory">*</span></label>
											<div class="select-position">
...
<script nonce="${cspNonce}" type="text/javascript">
	...
	function addmoredatafetch1() {
		...
		var id = "${j[0]}";
		var learni_outcome = "${j[1]}";
// 		var no_of_activities = "${j[2]}";
		//	var non_lecture_hours = "${j[3]}";
		//	var term_id = "${j[4]}";

		$("#eid" + ind).val(id);
		$("#learni_outcome" + ind).val(learni_outcome);
			...
			$("table#att_Tb")
					.append(
							'<tr align="center" id="tr_id_att'+att+'"><td>'
									+ att
									+ '</td>'
									+ '<td class="min-width"><div class="input-style-2"><input type="text" id="learni_outcome'+att+'" name="learni_outcome'+att+'"  maxlength="500" class="form-control"  autocomplete="off" placeholder="Learning Outcomes" ></div></td>'
	...
	function Validation() {
		...
		for (var i = 1; i <= count; i++) {
			if ($("#learni_outcome" + i).val().trim() == "") {
				alert("Please Enter Practical Learning Outcome.");
