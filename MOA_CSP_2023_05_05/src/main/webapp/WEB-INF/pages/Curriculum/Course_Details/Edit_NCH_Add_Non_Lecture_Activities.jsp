			...
			<div class="row align-items-center">
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="title mb-30">
						<h2>
							<span id="lbladd1"></span>Edit Add Non Lecture Activities
						</h2>
					</div>
				</div>
				<!-- end col -->
		...
		<div class="form-elements-wrapper">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<!-- input style start -->
					<form:form name="course" id="edit_Nch_Add_Non_Lecture_Activities"
						action="edit_Nch_Add_Non_Lecture_ActivitiesAction" method='POST'
						commandName="edit_Nch_Add_Non_Lecture_ActivitiesCMD"
						enctype="multipart/form-data">
						<div class="card-style mb-30">
							<div class="custom-field-block">
								<h6 class="mb-25">Edit Add Non Lecture Activities</h6>
								<div class="row">
							...
							<div class="row">
								<div class="col-lg-12 col-md-12 col-sm-12">
									<ul class="buttons-group mainbtn">
										...
										<li><input href ="CC_Nch_Add_Non_Lecture_Activities_url"
...
<script nonce="${cspNonce}" type="text/javascript">
	...
	function addmoredatafetch1() {
		...
		var id = "${j[0]}";
		var non_lecture_tl_method = "${j[1]}";
		var no_of_hours = "${j[2]}";
		//	var non_lecture_hours = "${j[3]}";
		//	var term_id = "${j[4]}";

		$("#eid" + ind).val(id);
		$("#non_lecture_tl_method" + ind).val(non_lecture_tl_method);
			...
			$("table#att_Tb")
					.append(
							'<tr align="center" id="tr_id_att'+att+'"><td>'
									+ att
									+ '</td>'
									+ '<td class="min-width"><div class="input-style-2"><input type="text" id="non_lecture_tl_method'+att+'" name="non_lecture_tl_method'+att+'"  maxlength="250" class="form-control"  autocomplete="off" placeholder="Non Lecture T-L Method" ></div></td>'
									+ '<td class="min-width"><div class="input-style-2"><input type="text" id="no_of_hours'+att+'" name="no_of_hours'+att+'"  maxlength="3" class="form-control"  autocomplete="off" placeholder="No. Of Hours" ></div></td>'
