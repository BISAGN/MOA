			...
			<div class="row align-items-center">
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="title mb-30">
						<h2>
							<span id="lbladd1"></span>Search List Of Topics
						</h2>
					</div>
				</div>
				<!-- end col -->
		...
		<div class="form-elements-wrapper">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<!-- input style start -->
					<form:form name="search_list_topics" id="search_list_topics"
						action="searchlist_topicsAction" method='POST'
						commandName="search_list_topicsCMD" enctype="multipart/form-data">
						<div class="card-style mb-30">
							<div class="custom-field-block">
								<h6 class="mb-25">Search List Of Topics</h6>
								<div class="row">
				...
				<div class="modal-dialog modal-xl modal-dialog-scrollable">
					<div class="modal-content">
						<div class="modal-header">
							<h3 class="modal-title">List Of Topics</h3>
						...
						<div class="modal-body custom-modal-table">
							<div class="custom-modal-inner">
								<div class="table-wrapper table-responsive custom-table">
									<table class="table model-table" id="nch_Topic_ChildUrl">
										<thead>
											<tr>
												<th>Sr No</th>
												<th>Topic</th>
...
<c:url value="NCHEdit_Topic_Url" var="NCHEdit_Topic_Url" />
<form:form action="${NCHEdit_Topic_Url}" method="post" id="editForm"
	name="editForm" modelAttribute="id1">
	<input type="hidden" name="id1" id="id1" />
</form:form>

<c:url value="NCHdeleteTopic_Url" var="NCHdeleteTopic_Url" />
<form:form action="${NCHdeleteTopic_Url}" method="post" id="deleteForm"
...
function data(NCH_search_Topic) {
	...
	$.post("getFilterNCHTopic_data?" + key + "=" + value, {
		startPage : startPage,
		...
		for (var i = 0; i < j.length; i++) {
			jsondata.push([ j[i].ser,j[i].system_name,j[i].degree_name,j[i].professional, j[i].course_name,j[i].paper,j[i].topic,j[i].vd,j[i].action]);
		}
	});
	$.post("getTotalNCH_Topic_dataCount?" + key + "=" + value, {
		system_id:system_id,
		degree_id:degree_id,
		professional_id:professional_id,
		course_id:course_id,
