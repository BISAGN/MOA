			...
			<div class="row align-items-center">
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="title mb-30">
						<h2>
							<span id="lbladd1"></span>Search Practical Learning Objectives
						</h2>
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
					...
					<form:form name="searcht4_learning_object"
						...
						<div class="card-style mb-30">
							<div class="custom-field-block">
								<h6 class="mb-25">Search Practical Learning Objectives</h6>
								<div class="row">
				...
				<div class="modal-dialog modal-xl modal-dialog-scrollable">
					<div class="modal-content">
						<div class="modal-header">
							<h3 class="modal-title">Table 4: Learning objectives
								(Practical)</h3>
							...
							<div class="custom-modal-inner">
								<div class="table-wrapper table-responsive custom-table">
									<table class="table model-table"
										id="NchT4SearchLearningObject_ChildUrl">
										<thead>
											<tr>
												<th><h6>Sr No</h6></th>
...
<c:url value="Edit_Nch_T4_Learning_Object_Url"
	var="Edit_Nch_T4_Learning_Object_Url" />
<form:form action="${Edit_Nch_T4_Learning_Object_Url}" method="post"
	id="editForm" name="editForm" modelAttribute="id1">
	<input type="hidden" name="id1" id="id1" />
</form:form>

<c:url value="delete_Nch_T4_Learning_Object_Url"
	var="delete_Nch_T4_Learning_Object_Url" />
<form:form action="${delete_Nch_T4_Learning_Object_Url}"
...
function data(search_Topic) {
	...
	$.post("getFilterNchT4SearchLearningObject_data?" + key + "=" + value, {
		startPage : startPage,
...
// 		}
	...
	$.post("getTotalNchT4SearchLearningObject_dataCount?" + key + "=" + value, {
		system_id:system_id,
		degree_id:degree_id,
		professional_id:professional_id,
		course_id:course_id,
...
// 	debugger;
	$('tbody#att_TbbodyNameMed').empty();
		$
				.post( 
						"NchT4SearchLearningObject_ChildUrlpop?" + key
								+ "=" + value,
						{
							hid : hid
						},
