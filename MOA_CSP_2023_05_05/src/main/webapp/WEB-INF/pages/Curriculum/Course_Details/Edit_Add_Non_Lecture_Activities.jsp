		...
		<div class="form-elements-wrapper">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<!-- input style start -->
					<form:form name="course" id="edit_Add_Non_Lecture_Activities"
						action="edit_Add_Non_Lecture_ActivitiesAction" method='POST'
						commandName="edit_Add_Non_Lecture_ActivitiesCMD"
...
<script nonce="${cspNonce}" type="text/javascript">
	...
	function addmoredatafetch1() {
		...
		$("#no_of_activities" + ind).val(no_of_activities);
			...
			$("table#att_Tb")
					.append(
							'<tr align="center" id="tr_id_att'+att+'"><td>'
									...
									+ '<td class="min-width"><div class="input-style-2"><input type="text" id="no_of_activities'+att+'" name="no_of_activities'+att+'"  maxlength="3" class="form-control"  autocomplete="off" placeholder="No. Of Activities" ></div></td>'
