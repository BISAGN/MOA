				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="breadcrumb-wrapper mb-30">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="nch_inst_usermanual_main">User Guide</a></li>
								...
								<div class="col-lg-2 col-md-2 col-sm-12 col-12">
									<nav class="navi-tabs__nav">
										<ul class="verticalnav">
											...
											<li class="dropdown open"><a class="verticalnav-title">NCH Commission</a>
												<ul>
													<li><a href="#nch1" class="active">Institute Guide</a></li>
...
<!-- 																	class="custom-link">User Manual</a></li> -->
																<li><a class="custom-link no-hover">Videos</a>
																	<div class="uvp-list">
																		<ul class="video-list">
																			<li><a
																				href="db_ayusheducationusermanual?filename=/ayush_edu/nch/nch_admission.mp4"
																				class="custom-link" target="_blank">Hindi </a></li>
																			<li><a
																				href="db_ayusheducationusermanual?filename=/ayush_edu/nch/nch_admission_eng.mp4"
												...
												<div class="accordion-item accordion-itemstyle">
													<h2 class="accordion-header" id="panelsStayOpen-headingTwo">
														<button
															...
															aria-expanded="false"
															aria-controls="panelsStayOpen-collapseTwo">Faculty Details Updated by Institute</button>
													</h2>
													<div id="panelsStayOpen-collapseTwo"
														...
														<div class="accordion-body">
																<ul class="custom-dbsimple-list">
																	<li><a href="nch_facu_detailupload_usermanual" class="custom-link">User
																			Manual</a></li>
																	<li><a class="custom-link no-hover">Videos</a>
																		<div class="uvp-list">
																			<ul class="video-list">
																				<li><a
																					href="https://youtu.be/O0kfWkzH2vs"
																					class="custom-link" target="_blank">Hindi </a></li>
																				<li><a
																					href="https://youtu.be/Oxr_XVoEEDY"
																					class="custom-link" target="_blank">English</a></li>
																			</ul>
																		</div></li>
