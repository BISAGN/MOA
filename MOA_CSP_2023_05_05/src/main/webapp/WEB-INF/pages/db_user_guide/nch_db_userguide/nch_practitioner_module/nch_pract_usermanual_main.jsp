					...
					<div class="card-style mb-30">
						<div class="row">
							<div class="col-lg-12 col-md-12 col-sm-12 col-12 section-md-t3">
								...
								<a href="nch_pract_helptopics" class="custom-link">View All Topics<i
							...
							<div class="col-lg-2 col-md-2 col-sm-12 col-12 mx-auto">
						...
						<div class="row">	
							<div class="col-lg-3 col-md-4 col-sm-6 col-12">
								...
								<a href="db_ayusheducationusermanual?filename=/ayush_edu/nch/nch_practitioner.mp4" target="_blank" title="Play Video" class="card-image hindivideo">
								...
								<a href="db_ayusheducationusermanual?filename=/ayush_edu/nch/nch_practitioner_eng.mp4" title="Play Video" target="_blank" class="card-image englishvideo">
											<span class="card-image1"> 
											     <img src="assets/img/portalss.png" alt="portalss" title="Play Video">
									...
									<div class="card-content">
										<h5 class="custom-card-title"><a>Practitioner Guide</a></h5>
									</div>
