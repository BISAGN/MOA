					...
					<div class="card-style mb-30">
						<div class="row">
							<div class="col-lg-12 col-md-12 col-sm-12 col-12 section-md-t3">
								...
								<a href="nch_inst_helptopics" class="custom-link">View All Topics<i
						...
						<div class="row">
							...
							<div class="col-lg-3 col-md-4 col-sm-6 col-12">
								<div class="card-style-2">
									<div class="card-image-outer">
										<a href="db_ayusheducationusermanual?filename=/ayush_edu/nch/nch_admission.mp4"
										...
										<a href="db_ayusheducationusermanual?filename=/ayush_edu/nch/nch_admission_eng.mp4" title="Play Video" target="_blank" class="card-image englishvideo">
							...
							<div class="col-lg-3 col-md-4 col-sm-6 col-12">
								<div class="card-style-2">
									<div class="card-image-outer">
										<a href="https://youtu.be/O0kfWkzH2vs"
											title="Play Video" target="_blank" class="card-image hindivideo"> <span
											class="card-image1">
											 <img src="assets/img/portalss.png" alt="portalss"
												title="Play Video">
										...
										<a href="https://youtu.be/Oxr_XVoEEDY" title="Play Video" target="_blank" class="card-image englishvideo">
											<span class="card-image1"> 
											     <img src="assets/img/portalss.png" alt="portalss" title="Play Video">
										    </span><span class="comission_bedge_nch">NCH</span>
										    <span class="language_bedge">Language preference English</span>
									...
									<div class="card-content">
										<h5 class="custom-card-title">
											<a>Faculty Details Updated by Institute</a>
										</h5>
			...
			<div class="modal-content text-center">
				...
				<div class="modal-body">
					<div class="custom-model-img">
						...
						<iframe src="assets/pdf/nch/nch-admission.pdf"
							class="custom-pdf-view"> </iframe>
					</div>
				</div>
				<div class="modal-footer">
