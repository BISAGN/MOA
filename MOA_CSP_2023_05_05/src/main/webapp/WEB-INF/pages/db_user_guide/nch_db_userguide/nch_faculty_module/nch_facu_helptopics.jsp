				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="breadcrumb-wrapper mb-30">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="nch_facu_usermanual_main">User Guide</a></li>
									...
									<nav class="navi-tabs__nav">
										<ul class="verticalnav">
											...
											<li class="dropdown open"><a class="verticalnav-title">NCH Commission</a>
												<ul>
													<li><a href="#nch1" class="active">Faculty Guide</a></li>
													...
													<div id="panelsStayOpen-collapseOne"
														...
														<div class="accordion-body">
															<ul class="custom-dbsimple-list">
																<li><a href="nch_facu_usermanual"
																	class="custom-link">User Manual</a></li>
																<li><a class="custom-link no-hover">Videos</a>
																	<div class="uvp-list">
																		<ul class="video-list">
																			<li><a
																				href="db_ayusheducationusermanual?filename=/ayush_edu/nch/nch_faculty.mp4"
																				class="custom-link" target="_blank">Hindi </a></li>
																			<li><a
																				href="db_ayusheducationusermanual?filename=/ayush_edu/nch/nch_faculty_eng.mp4"
