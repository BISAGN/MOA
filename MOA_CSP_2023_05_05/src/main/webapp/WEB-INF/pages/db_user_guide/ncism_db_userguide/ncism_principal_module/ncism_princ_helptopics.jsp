				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="breadcrumb-wrapper mb-30">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								<!-- <li class="breadcrumb-item"><a href="ncism_inst_usermanual_main">Dashboard</a></li> -->
									...
									<nav class="navi-tabs__nav">
										<ul class="verticalnav">
											...
											<li class="dropdown open"><a class="verticalnav-title">NCISM Commission</a>
												<ul>
													<li><a href="#ncism1" class="active">User Creation Guide</a></li>
												...
												<div class="accordion-item accordion-itemstyle">
													<h2 class="accordion-header" id="panelsStayOpen-headingOne">
														<button
															...
															aria-expanded="true"
															aria-controls="panelsStayOpen-collapseOne">Principal user creation guide for Institute
															</button>
													</h2>
													<div id="panelsStayOpen-collapseOne"
														...
														<div class="accordion-body">
															<ul class="custom-dbsimple-list">
																<li><a href="ncism_inst_pmulti_ucreate_usermanual"
												...
												<div class="accordion-item accordion-itemstyle d-none">
													<h2 class="accordion-header" id="panelsStayOpen-headingTwo">
														<button
															...
															aria-expanded="false"
															aria-controls="panelsStayOpen-collapseTwo">Institute Guide</button>
													</h2>
