								...
								<div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12">
										...
										<ul class="buttons-group mainbtn">
											...
											<li><a href="e_form_summaryVacantReportUrl"
...
<c:url value="Search_e_form_summaryVacantReportUrl" var="Search_e_form_summaryVacantReportUrl" />
<form:form action="${Search_e_form_summaryVacantReportUrl}" method="post" id="searchForm"
...
<c:url value="getSummaryVaccantReport_Eform_Excel" var="getSummaryReport_Eform_Excel" />
...
name="ExcelDownload" modelAttribute="id2"> 
  ...
  <c:url value="getSummaryVacantReport_Eform_Pdf" var="getSummaryVacantReport_Eform_Pdf" />
<form:form action="${getSummaryVacantReport_Eform_Pdf}" method="post" id="PdfDownload"
name="ExcelDownload" modelAttribute="id2"> 
