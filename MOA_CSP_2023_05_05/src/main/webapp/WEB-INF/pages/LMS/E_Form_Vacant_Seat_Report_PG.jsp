								...
								<div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12">
										...
										<ul class="buttons-group mainbtn">
											...
											<li><a href="e_form_summary_PG_VacantReportUrl"
												...
												<table class="table" id="addNameOfMed">
													<thead>
														<tr>
															...
															<th>System </th>
															<th>Total College</th>
															<th>100 % Filled College</th>
															<th>0% Filled College</th>
															<th>1% to 99% Filled College</th>
														</tr>
													</thead>
...
<c:url value="Search_e_form_PG_summaryVacantReportUrl" var="Search_e_form_PG_summaryVacantReportUrl" />
<form:form action="${Search_e_form_PG_summaryVacantReportUrl}" method="post" id="searchForm"
...
<c:url value="getSummaryVaccantReport_Eform_PG_Excel" var="getSummaryVaccantReport_Eform_PG_Excel" />
<form:form action="${getSummaryVaccantReport_Eform_PG_Excel}" method="post" id="ExcelDownload"
name="ExcelDownload" modelAttribute="id2"> 
  ...
  <c:url value="getSummaryVacantReport_Eform_PG_Pdf" var="getSummaryVacantReport_Eform_PG_Pdf" />
<form:form action="${getSummaryVacantReport_Eform_PG_Pdf}" method="post" id="PdfDownload"
name="ExcelDownload" modelAttribute="id2"> 
...
<%-- <c:url value="delete_Cast_Category_Action" var="delete_Cast_Category_Action" /> --%>
<%-- <form:form action="${delete_Cast_Category_Action}" method="post" id="deleteForm" --%>
<%-- 	name="deleteForm" modelAttribute="id4"> --%>
<!-- 	<input type="hidden" name="id4" id="id4" value="0" /> -->
<%-- </form:form> --%>

<%-- <c:url value="Cast_Category_Masterreport2" var="searchUrlp" /> --%>
