					...
					<div class="col-lg-12 col-md-12 col-sm-12">
						...
						<div class="title mb-30">
							<h2>Start Your Exam</h2>
								...
								<ul class="inst_list">
									<li><p class="inst_text">Please create module wise MCQs in English and
													Roman Hindi.</p></li>
									<li><p class="inst_text">All fields are mandatory.</p></li>
									<li><p class="inst_text">Minimum 20 MCQs for each difficulty level should
													be entered.</p></li>
								</ul>
							</div>
