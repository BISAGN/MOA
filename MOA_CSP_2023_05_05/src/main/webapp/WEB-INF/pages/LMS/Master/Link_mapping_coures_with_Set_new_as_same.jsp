									...
									<div class="col-12 col-sm-12 col-md-6 col-lg-3">
										<div class="input-style-1">
											...
											<textarea id="description" name="description"
												autocomplete="off" maxlength="500" placeholder="Description" /></textarea>
...
function addMoreCsp(obj){
	...
	document.getElementById('set_id'+obj).onclick = function() {
		 getset(this.value,obj);
	};
}
...
// 	document.getElementById('in_course_id1').onclick = function() {
// 		mycheckindex(1);
// 	};
});
...
// 			+ '<input type="text" id="in_course_id_hid_ch'+ser+'" name="in_course_id_hid_ch'+ser+'">'
			+ '  <td><input type="hidden" id="in_course_id_hid_ch'+ser+'" name="in_course_id_hid_ch'+ser+'">'
	...
	$.ajaxSetup({
		...
		$.post("getcourselistby_degree?" + key + "=" + value,
						{
							degree_id : degree_id
						},
						function(k) {
...
// 										+"<input type='text' id='in_course_id_hid_ch"+ser+"' name='in_course_id_hid_ch"+ser+"'>"
										+"<input class='multi form-check-input mr-5' type='checkbox' id='in_course_id"
												+ser
												+ i
												+ "' name='in_course_id"
												+ ser
...
// 												+ ser
												+ "'/><label class='lbl' value='course_id"+i+ "' for='first'>"+ v2 + "</label></div>");
// 												alert("i-"+i+"-ser-"+ser);		
								setonclickofchbofcourses(ser,i);
	...
	function setonclickofchbofcourses(ser,i){
// debugger;
		document.getElementById('in_course_id'+ser+i).onclick = function() {
			mycheckindex(ser);
		};
	}
...
debugger;
		...
		console.log(myindex);
		document.getElementById('in_course_id_hid_ch' + myindex).value = gsida.toString();
