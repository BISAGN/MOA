					...
					<div class="breadcrumb-wrapper mb-30">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Cast Category
									    </li>
							</ol>
						</nav>
					</div>
				...
				<div class="col-12">
					...
					<form:form name="Cast_Category_masterUrl" id="Cast_Category_masterUrl" action="Cast_Category_masterUrlaction"
						...
						<div class="card-style mb-30">
							<h6 class="mb-25">Cast Category</h6>
							<div class="row">
					...
					<div class="table-wrapper table-responsive custom-datatable-p">
						<table class="table" id="search_system">
							<thead>
								<tr>
									<th><h6>Ser No</h6></th>
									<th id="${item.id}"><h6>Cast Category</h6></th>
									<th><h6>Action</h6></th>
...
<c:url value="getSearch_Cast_Category_Master" var="getSearch_Cast_Category_Master" />
<form:form action="${getSearch_Cast_Category_Master}" method="post" id="searchForm"
	name="searchForm" modelAttribute="searchUrl2">
	<input type="hidden" name="searchUrl2" id="searchUrl2" />
	<input type="hidden" name="status1" id="status1" value="0" />
</form:form>

<c:url value="Edit_Cast_Category_MasterUrl" var="Edit_Cast_Category_MasterUrl" />
<form:form action="${Edit_Cast_Category_MasterUrl}" method="post" id="updateForm"
...
function Search() {
	$("#Cast_Category1").val($('#Cast_Category').val());
