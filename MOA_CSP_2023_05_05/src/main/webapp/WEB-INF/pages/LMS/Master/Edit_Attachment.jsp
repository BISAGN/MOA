	...
	<div class="container-fluid">
					...
					<div class="breadcrumb-wrapper mb-30">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Update Attachment</li>
							</ol>
						</nav>
					</div>
				</div>
		...
		<div class="form-elements-wrapper">
			<div class="row">
				<div class="col-12">
					<!-- input style start -->
					<form:form name="Edit_Attachment_MasterUrl" id="Edit_Attachment_MasterUrl" action="edit_Attachment_Master_action"
						method="POST" class="form-horizontal"
						modelAttribute="edit_Attachment_MasterCMD">
						<div class="card-style mb-30">
							<h6 class="mb-25">Update Attachment</h6>
							<div class="row">
								<div class="col-12 col-sm-12 col-md-6 col-lg-4">
									<div class="input-style-2">
										<label>Attachment<span class="mandatory">*</span></label> <input
											...
											autocomplete="off" maxlength="100" placeholder="Enter Attachment" />
									</div>
									<!-- end input -->
								</div>
								<div class="col-12 col-sm-12 col-md-6 col-lg-4">
...
document.addEventListener('DOMContentLoaded', function() {
	...
	$(document).ready(function() {
		...
		$('#id').val('${Attachment_Master_details.id}'); 
		$('#Attachment').val('${Attachment_Master_details.doc_name}'); 
		$('#status').val('${Attachment_Master_details.status}'); 
