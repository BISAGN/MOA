			...
			<div class="row align-items-center">
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="title mb-30">
						<h2>Link System & Elective Course Master</h2>
					</div>
				</div>
				<!-- end col -->
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
						...
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Link
									System & Elective Course Master</li>
							</ol>
						</nav>
					</div>
				</div>
					...
					<form:form name="roleMst" id="roleMst"
						...
						<div class="card-style mb-30">
							<div class="custom-field-block">
								<h6 class="mb-25">Link System & Elective Course Master</h6>
								<div class="row">
									...
									<div class="col-12 col-sm-12 col-md-6 col-lg-6">
										<div class="input-with-selection">
											<div class="input-style-1 mb-0">
												<!-- 											<label id="elective_name"> Elective Course (0)<span class="mandatory">*</span></label>  -->
												<label><span id="elective_name">Elective
														Course (0)</span><span class="mandatory">*</span></label> <input
													type="text" id="search_data" autocomplete="off"
		...
		$.post(
				"getFilterLink_System_Elective_Course_data?" + key + "="
					...
					for (var i = 0; i < j.length; i++) {
						jsondata.push([ i + 1, j[i][0], j[i][1], j[i][2] ]);
					}
				});
