...
<div class="container-fluid">
					...
					<div class="breadcrumb-wrapper mb-30">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Course Publisher</li>
							</ol>
						</nav>
					</div>
				</div>
		...
		<div class="form-elements-wrapper">
			<div class="row">
				<div class="col-12">
					<!-- input style start -->
					<form:form name="course_publi_Act_Inact" id="course_publi_Act_Inact" action="course_publi_Act_InactAction"
						method="post" class="form-horizontal" modelAttribute="course_publi_Act_InactCMD">
						<div class="card-style mb-30">
							<h6 class="mb-25">Course Publisher</h6>
							<div class="row">
								<div class="col-12 col-lg-4 col-md-4 col-sm-12">
									<div class="input-style-2">
										<label>Course Publisher<span class="mandatory"></span></label> 
										<input type="text" id="name" name="name" autocomplete="off" maxlength="50" 
											class="form-control autocomplete UpperClassName txt-transupp" placeholder="Course Publisher"/>
									</div>
									<!-- end input -->
								</div>
...
<!-- 										<li><input type="submit" id="btn-save" id="btn-save" class="main-btn info-btn btn-hover" value="Save"> -->
										<li><a href="course_publisher_Act_InactUrl" class="main-btn dark-btn n btn-hover">Reset</a></li>
									</ul>
							</div>
						</div>
						<!-- end card -->
