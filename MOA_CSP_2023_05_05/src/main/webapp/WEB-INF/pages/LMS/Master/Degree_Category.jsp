	...
	<div class="container-fluid">
					...
					<div class="breadcrumb-wrapper mb-30">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Degree Category
									    </li>
							</ol>
						</nav>
					</div>
		...
		<div class="form-elements-wrapper">
			<div class="row">
				<div class="col-12">
					<!-- input style start -->
					<form:form name="Degree_Category_masterUrl" id="Degree_Category_masterUrl" action="Degree_Category_masterUrlaction"
					...
					<div class="table-wrapper table-responsive custom-datatable-p">
						<table class="table" id="search_system">
							<thead>
								<tr>
									<th><h6>Ser No</h6></th>
									<th id="${item.id}"><h6>Degree Category</h6></th>
									<th><h6>Action</h6></th>
...
<c:url value="getSearch_Degree_Category_Master" var="getSearch_Degree_Category_Master" />
<form:form action="${getSearch_Degree_Category_Master}" method="post" id="searchForm"
	name="searchForm" modelAttribute="searchUrl2">
	<input type="hidden" name="searchUrl2" id="searchUrl2" />
	<input type="hidden" name="status1" id="status1" value="0" />
</form:form>

<c:url value="Edit_Degree_Category_MasterUrl" var="Edit_Degree_Category_MasterUrl" />
<form:form action="${Edit_Degree_Category_MasterUrl}" method="post" id="updateForm"
	name="updateForm" modelAttribute="id3">
	<input type="hidden" name="id3" id="id3">
</form:form>

<c:url value="delete_Degree_Category_Action" var="delete_Degree_Category_Action" />
<form:form action="${delete_Degree_Category_Action}" method="post" id="deleteForm"
	name="deleteForm" modelAttribute="id4">
	<input type="hidden" name="id4" id="id4" value="0" />
</form:form>

<c:url value="Degree_Category_Masterreport2" var="searchUrlp" />
...
function setTimeLoadForTable(){
	...
	document.querySelectorAll('.ADDDegree_Category_Master').forEach((items, index) => {
...
function data(search_system ) {
	...
	var Degree_Category = $("#Degree_Category").val();
...
// 	}
	...
	$.post("getFilterDegree_Category_Master_data?" + key + "=" + value, {
		startPage : startPage,
...
console.log(j)
		for (var i = 0; i < j.length; i++) {
			jsondata.push([j[i].ser, j[i].degree_cate, j[i].action]);
		}
	});
	$.post("getTotalDegree_Category_Master_dataCount?" + key + "=" + value, {
		Search : Search,
		Degree_Category  : Degree_Category, 
		status : status
	}, function(j) {
...
function Search() {
	$("#Degree_Category1").val($('#Degree_Category').val());
