...
<div class="container-fluid">
 ...
 <form:form name="category_master" id="category_master" action="Edit_categoryAction" method="post" class="form-horizontal" commandName="Edit_categoryCMD">
							...
							<div class="col-12 col-sm-12 col-md-6 col-lg-4">
								<div class="input-style-2">
									...
									<input type="text" id="category" name="category"
										class="form-control autocomplete UpperClassName txt-transupp" placeholder="Category"
...
<script nonce="${cspNonce}" type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('#category').val('${Category_Details.category}');
