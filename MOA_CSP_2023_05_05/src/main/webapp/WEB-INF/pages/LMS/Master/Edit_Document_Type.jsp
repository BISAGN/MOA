	...
	<div class="container-fluid">
					...
					<div class="breadcrumb-wrapper mb-30">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Update Document Type</li>
							</ol>
						</nav>
					</div>
				</div>
		...
		<div class="form-elements-wrapper">
			<div class="row">
				<div class="col-12">
					<!-- input style start -->
					<form:form name="Edit_Document_Type_MasterUrl" id="Edit_Document_Type_MasterUrl" action="edit_Document_Type_Master_action"
						method="POST" class="form-horizontal"
						modelAttribute="edit_Document_Type_MasterCMD">
						<div class="card-style mb-30">
							<h6 class="mb-25">Update Document Type</h6>
							<div class="row">
								<div class="col-12 col-sm-12 col-md-6 col-lg-4">
									<div class="input-style-2">
										<label>Document Type<span class="mandatory">*</span></label> <input
											...
											autocomplete="off" maxlength="100" placeholder="Enter Document_Type" />
									</div>
									<!-- end input -->
								</div>
								<div class="col-12 col-sm-12 col-md-6 col-lg-4">
...
document.addEventListener('DOMContentLoaded', function() {
	...
	$(document).ready(function() {
		...
		$('#id').val('${Document_Type_Master_details.id}'); 
		$('#Document_Type').val('${Document_Type_Master_details.doc_type}'); 
		$('#status').val('${Document_Type_Master_details.status}'); 
