			...
			<div class="row align-items-center">
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="title mb-30">
						<span id="lbladd"></span>
						<h2>Feedback Category Master</h2>
					</div>
				</div>
				<!-- end col -->
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
			...
			<div class="row">
				<div class="col-12">
					...
					<form:form name="Categoryform" id="Categoryform"
						action="CategoryAction" method="post" class="form-horizontal"
						modelAttribute="CategoryCMD">
						<div class="card-style mb-30">
							<h6 class="mb-25">Feedback Category Master</h6>
							<div class="row">
								<div class="col-12 col-sm-12 col-md-6 col-lg-4">
									<div class="input-style-2">
										<label>Category<span class="mandatory">*</span></label> <input
											...
											maxlength="100" placeholder="Category" /> <input
...
<!-- 								<div class="col-12 col-sm-12 col-md-6 col-lg-4"> -->
<!-- 									<div class="input-style-2"> -->
<!-- 										<label>Feedback Detail<span class="mandatory">*</span></label> <input -->
<!-- 											type="text" id="feedback_detail" name="feedback_detail" -->
<!-- 											class="autocomplete  txt-transupp" autocomplete="off" -->
...
<!-- 								</div> -->
							...
							<ul class="buttons-group mainbtn">
								...
								<li><a href="Feedback_Category_Mstr_Url"
...
<c:url value="Edit_Feedback_Category_Mstr_Url" var="Edit_Url" />
<form:form action="${Edit_Url}" method="post" id="updateForm"
	name="updateForm" modelAttribute="id2">
	<input type="hidden" name="id2" id="id2">
</form:form>

<c:url value="Feedback_Category_Mstr_Delete_Url" var="deleteUrl" />
...
document.addEventListener('DOMContentLoaded', function () {	
	...
	function data(search_category) {
		...
		$.post("getFilterFeedBack_Category_data?" + key + "=" + value, {
			startPage : startPage,
		...
		$.post("getTotalFeedback_Category_dataCount?" + key + "=" + value, {
			Search : Search,
			category : category,
			status : status
		}, function(j) {
	...
	function editData(id,category,status) {
