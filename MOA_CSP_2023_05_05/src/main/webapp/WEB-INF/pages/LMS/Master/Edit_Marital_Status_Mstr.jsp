...
<div class="container-fluid">
 ...
 <form:form name="marital_status_master" id="marital_status_master" action="Edit_marital_statusAction" method="post" class="form-horizontal" commandName="Edit_marital_statusCMD">
