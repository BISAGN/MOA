			...
			<div class="row align-items-center">
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="title mb-30">
						<h2>
							<span id="lbladd1"></span> Staff Attendance Report
						</h2>
					</div>
				</div>
				<!-- end col -->
		...
		<div class="form-elements-wrapper">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<!-- 							input style start -->
					<form:form name="staff_attendance_report"
						id="staff_attendance_report"
						action="staff_attendance_reportAction" method="post"
						modelAttribute="staff_attendance_reportCMD">
						<div class="card-style mb-30">
							<div class="custom-field-block">
								<h6 class="mb-25">Staff Attendance Report</h6>
								<div class="row">
										...
										<div class="select-style-1">
											...
											<div class="input-style-2">
												<input type="month" name="month" id="month"
													...
													autocomplete="off" value="${month_year}">
									...
									<div class="col-12 col-sm-12 col-md-6 col-lg-4">
										<div class="select-style-1">
											...
											<div class="input-style-1">
												<input type="text" name="searchInputname"
													id="searchInputname" class="form-control-sm form-control"
									...
									<div class="col-12 col-sm-12 col-md-6 col-lg-4">
										<div class="select-style-1">
											<label for="text-input">Teacher Code<span
												class="mandatory"></span></label>
											<div class="input-style-1">
												<input type="text" name="searchInpuTC" id="searchInputTC"
													class="form-control-sm form-control"
													placeholder="Teacher Code" autocomplete="off">
								...
								<div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12">
										...
										<ul class="buttons-group mainbtn">
											...
											<li><a href="staff_attend_Report_url"
												...
												<table class="table" id="search_Add_Non_Lecture_Activities"
													...
													<thead>
														<tr>
															<th><h6>Sr
																No</h6></th>
															<th
																id="name"><h6>Staff name</h6></th>
															<th
																id="name"><h6>Teacher code</h6></th>
															<th id="1"><h6>01</h6></th>
															<th id="2"><h6>02</h6></th>
															<th id="3"><h6>03</h6></th>
															<th id="4"><h6>04</h6></th>
													...
													<tbody>
														<c:if test="${list.size()==0}">
															<tr>
																<td 
																	colspan="12"><p>Data not available</p></td>
															</tr>
														</c:if>
														<c:forEach var="item" items="${list}" varStatus="num">
															<tr>
																...
																<td
																	id="name2"><p>${item[0]}</p></td>
																<td
																	id="name2"><p>${item[1]}</p></td>
																<td id="01"><p>${item[2]}</p></td>
...
<%-- <form:form name="staff_attendance_report" id="staff_attendance_report" action="staff_attendance_reportAction"
	method="post" class="form-horizontal" modelAttribute="staff_attendance_reportCMD">
		<div class="container-fluid">
			...
			<div class="container" align="center">
				<div class="card">
						...
						<div class="col-12">
							<div class="col-6">
								<div class="row form-group">
									...
									<div class="col-12 col-lg-6">
										<input type="month" id="month" name="month" class="form-control wid"  autocomplete="off" min="1899-01-01" max="${current}"/>
									<input type="month" name="month" id="month"
											maxlength="10"
											class="form-control-sm form-control effect-9 custom_attend_staff_atnd_rprt_mo"
					...
					<!-- <div class="card-footer" align="center">
						<a href="staff_attend_Report_url" class="btn-clear">Reset</a> 
						<button type="button"  id="btn-search" class="btn-search" ><i class="fa fa-search" >SEARCH</i></button>
						<button class="btn-print"><i class="fa fa-print"></i>Print</button>
				
					<button type="button" class="btn-print"  onclick="get_StaffAtdncPDF()"><i class="fa fa-print" ></i>Print</button>
...
<c:url value="get_StaffAtdncReport" var="get_StaffAtdncReport" />

<form:form action="${get_StaffAtdncReport}" method="post" id="report1"
	name="report1">
	<input type="hidden" name="typeReport" id="typeReport" value="0" />
	<input type="hidden" name="date2" id="date2" />
</form:form>
<c:url value="search_month_staff_attend" var="searchmonthUrl" />
