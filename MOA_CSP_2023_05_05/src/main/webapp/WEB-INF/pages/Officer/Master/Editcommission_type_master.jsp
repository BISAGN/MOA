...
<form:form name="EditFormname" id="EditFormid" action="Editcommission_type_masterAction" method="POST" modelAttribute="Editcommission_type_masterCMD">
<div class="container" align="center">
	<div class="card">
    <div class="card-header"> <h5>EDIT COMMISSION TYPE MASTER</h5></div>
...
<form:input type="hidden" id="id" path="id" value="${Editcommission_type_masterCMD1.id}" ></form:input>
 <div class='col-md-6'>
	  <div class='row form-group'>
          ...
          <div class='col-12 col-md-6'>
	             <form:input type="text" id="ct_comm_type" path="ct_comm_type" value="${Editcommission_type_masterCMD1.ct_comm_type}" class="form-control" autocomplete='off'  ></form:input>
        </div>
    </div>
</div>
    </div>
