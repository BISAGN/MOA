...
<form:form name="EditFormname" id="EditFormid" action="EditEXAMINATION_NAME_MASTERAction" method="POST" modelAttribute="EditEXAMINATION_NAME_MASTERCMD">
<div class="container" align="center">
	<div class="card">
    <div class="card-header"> <h5>EDIT EXAMINATION_NAME_MASTER</h5></div>
...
<form:input type="hidden" id="id" path="id" value="${EditEXAMINATION_NAME_MASTERCMD1.id}" ></form:input>
 <div class='col-md-6'>
	  <div class='row form-group'>
          ...
          <div class='col-12 col-md-6'>
	             <form:input type="text" id="ec_exam_name" path="ec_exam_name" value="${EditEXAMINATION_NAME_MASTERCMD1.ec_exam_name}" class="form-control" autocomplete='off'  ></form:input>
        </div>
    </div>
</div>
    </div>
