...
<form:form name="EditFormname" id="EditFormid" action="Editofficer_personal_detailsAction" method="POST" modelAttribute="Editofficer_personal_detailsCMD">
<div class="container" align="center">
	<div class="card">
    <div class="card-header"> <h5>EDIT OFFICER PERSONAL DETAILS</h5></div>
...
<form:input type="hidden" id="id" path="id" value="${Editofficer_personal_detailsCMD1.id}" ></form:input>
 <div class='col-md-6'>
	  <div class='row form-group'>
          ...
          <div class='col-12 col-md-6'>
	             <form:input type="text" id="opd_officer_name" path="opd_officer_name" value="${Editofficer_personal_detailsCMD1.opd_officer_name}" class="form-control" autocomplete='off'  ></form:input>
        </div>
    </div>
</div>
 <div class='col-md-6'>
	  <div class='row form-group'>
          ...
          <div class='col-12 col-md-6'>
	             <form:input type="text" id="opd_unit" path="opd_unit" value="${Editofficer_personal_detailsCMD1.opd_unit}" class="form-control" autocomplete='off'  ></form:input>
        </div>
    </div>
</div>
 <div class='col-md-6'>
	  <div class='row form-group'>
         ...
         <c:forEach var="item" items="${getcccommandnameListDDL}" varStatus="num"  >
               <option value="${item.id}" name="${item.cc_command_name}" <c:if test="${item.id eq Editofficer_personal_detailsCMD1.cc_command_id}">selected="selected"</c:if>>${item.cc_command_name}</option>
         </c:forEach>
	 </form:select>
        </div>
    </div>
 ...
 <div class='col-md-6'>
	  <div class='row form-group'>
         ...
         <c:forEach var="item" items="${getctcommtypeListDDL}" varStatus="num"  >
               <option value="${item.id}" name="${item.ct_comm_type}" <c:if test="${item.id eq Editofficer_personal_detailsCMD1.ct_comm_id}">selected="selected"</c:if>>${item.ct_comm_type}</option>
         </c:forEach>
	 </form:select>
        </div>
    </div>
 ...
 <div class='col-md-6'>
	  <div class='row form-group'>
          ...
          <div class='col-12 col-md-6'>
	             <form:input type="text" id="opd_permanent_address1" path="opd_permanent_address1" value="${Editofficer_personal_detailsCMD1.opd_permanent_address1}" class="form-control" autocomplete='off'  ></form:input>
        </div>
    </div>
</div>
 <div class='col-md-6'>
	  <div class='row form-group'>
          ...
          <div class='col-12 col-md-6'>
	             <form:input type="text" id="opd_permanent_address2" path="opd_permanent_address2" value="${Editofficer_personal_detailsCMD1.opd_permanent_address2}" class="form-control" autocomplete='off'  ></form:input>
        </div>
    </div>
</div>
 <div class='col-md-6'>
	  <div class='row form-group'>
          ...
          <div class='col-12 col-md-6'>
	             <form:input type="text" id="opd_permanent_address3" path="opd_permanent_address3" value="${Editofficer_personal_detailsCMD1.opd_permanent_address3}" class="form-control" autocomplete='off'  ></form:input>
        </div>
    </div>
</div>
 <div class='col-md-6'>
	  <div class='row form-group'>
          ...
          <div class='col-12 col-md-6'>
	             <form:input type="text" id="opd_unit_address1" path="opd_unit_address1" value="${Editofficer_personal_detailsCMD1.opd_unit_address1}" class="form-control" autocomplete='off'  ></form:input>
        </div>
    </div>
</div>
 <div class='col-md-6'>
	  <div class='row form-group'>
          ...
          <div class='col-12 col-md-6'>
	             <form:input type="text" id="opd_unit_address2" path="opd_unit_address2" value="${Editofficer_personal_detailsCMD1.opd_unit_address2}" class="form-control" autocomplete='off'  ></form:input>
        </div>
    </div>
</div>
 <div class='col-md-6'>
	  <div class='row form-group'>
          ...
          <div class='col-12 col-md-6'>
	             <form:input type="text" id="opd_unit_address3" path="opd_unit_address3" value="${Editofficer_personal_detailsCMD1.opd_unit_address3}" class="form-control" autocomplete='off'  ></form:input>
        </div>
    </div>
</div>
 <div class='col-md-6'>
...
$(document).ready(function () {
	...
	if('${Editofficer_personal_detailsCMD1.opd_dob}' ==null){
	$("#opd_dob").val("");
}
else{
	 $("#opd_dob").val(ParseDateColumncommission('${Editofficer_personal_detailsCMD1.opd_dob}'));
...
$('img.ui-datepicker-trigger').css({'cursor' : 'pointer', "vertical-align" : 'middle'});
	...
	if('${Editofficer_personal_detailsCMD1.opd_date_of_comm}' ==null){
	$("#opd_date_of_comm").val("");
}
else{
	 $("#opd_date_of_comm").val(ParseDateColumncommission('${Editofficer_personal_detailsCMD1.opd_date_of_comm}'));
...
$('img.ui-datepicker-trigger').css({'cursor' : 'pointer', "vertical-align" : 'middle'});
	...
	if('${Editofficer_personal_detailsCMD1.opd_date_of_seniority}' ==null){
	$("#opd_date_of_seniority").val("");
}
else{
	 $("#opd_date_of_seniority").val(ParseDateColumncommission('${Editofficer_personal_detailsCMD1.opd_date_of_seniority}'));
