...
<form:form name="EditFormname" id="EditFormid" action="Editunfair_meansAction" method="POST" modelAttribute="Editunfair_meansCMD">
<div class="container" align="center">
	<div class="card">
    <div class="card-header"> <h5>EDIT UNFAIR MEANS</h5></div>
...
<form:input type="hidden" id="id" path="id" value="${Editunfair_meansCMD1.id}" ></form:input>
 <div class='col-md-6'>
	  <div class='row form-group'>
          ...
          <div class='col-12 col-md-6'>
	             <form:input type="text" id="opd_personal_id" path="opd_personal_id" value="${Editunfair_meansCMD1.opd_personal_id}" class="form-control" autocomplete='off' maxlength="" ></form:input>
        </div>
    </div>
</div>
 <div class='col-md-6'>
 ...
 <div class='col-md-6'>
	  <div class='row form-group'>
         ...
         <c:forEach var="item" items="${getscsubjectnameListDDL}" varStatus="num"  >
               <option value="${item.sc_subject_id}" name="${item.sc_subject_name}" <c:if test="${item.sc_subject_id eq Editunfair_meansCMD1.sc_subject_id}">selected="selected"</c:if>>${item.sc_subject_name}</option>
         </c:forEach>
	 </form:select>
        </div>
    </div>
 ...
 <div class='col-md-6'>
	  <div class='row form-group'>
          ...
          <div class='col-12 col-md-6'>
	             <form:input type="text" id="um_remarks" path="um_remarks" value="${Editunfair_meansCMD1.um_remarks}" class="form-control" autocomplete='off'  ></form:input>
        </div>
    </div>
</div>
    </div>
...
$(document).ready(function () {
	...
	if('${Editunfair_meansCMD1.es_id}' == 'Part B')
	$("#es_id1").prop("checked", true);

	if('${Editunfair_meansCMD1.es_id}' == 'Part D')
	$("#es_id2").prop("checked", true);

	if('${Editunfair_meansCMD1.es_id}' == 'DSSC/TSOC')
	$("#es_id3").prop("checked", true);
