...
<form:form name="Formname" id="Formid" action="dssc_tsoc_applicationAction" method="POST" modelAttribute="dssc_tsoc_applicationCMD">
<div class="container" align="center">
	<div class="card">
    <div class="card-header"> <h5>DSSC_TSOC_APPLICATION</h5></div>
...
<div class="col-md-12" id="divLine" style="display: none;"><span class="line"></span></div>
 ...
 <span class="errorClass" id="dta_dssc_lbl">${dta_dssc_lbl}</span>
        </div>
    </div>
</div>
 <div class='col-md-6'>
 ...
 <span class="errorClass" id="dta_tsoc_lbl">${dta_tsoc_lbl}</span>
        </div>
    </div>
</div>
 <div class='col-md-6'>
 ...
 <span class="errorClass" id="dta_course_pref_lbl">${dta_course_pref_lbl}</span>
        </div>
    </div>
</div>
 <div class='col-md-6'>
 ...
 <span class="errorClass" id="dta_type_of_entry_lbl">${dta_type_of_entry_lbl}</span>
        </div>
    </div>
</div>
 <div class='col-md-6'>
 ...
 <span class="errorClass" id="dta_regiment_lbl">${dta_regiment_lbl}</span>
        </div>
    </div>
</div>
 <div class='col-md-6'>
 ...
 <span class="errorClass" id="dta_address_corres1_lbl">${dta_address_corres1_lbl}</span>
        </div>
    </div>
</div>
 <div class='col-md-6'>
 ...
 <span class="errorClass" id="dta_address_coress2_lbl">${dta_address_coress2_lbl}</span>
        </div>
    </div>
</div>
 <div class='col-md-6'>
 ...
 <span class="errorClass" id="dta_medical_cat_lbl">${dta_medical_cat_lbl}</span>
        </div>
    </div>
</div>
 <div class='col-md-6'>
 ...
 <span class="errorClass" id="dta_jccourse_no_lbl">${dta_jccourse_no_lbl}</span>
        </div>
    </div>
</div>
 <div class='col-md-6'>
 ...
 <span class="errorClass" id="dta_jccourse_beg_date_lbl">${dta_jccourse_beg_date_lbl}</span>
        </div>
    </div>
</div>
 <div class='col-md-6'>
	  <div class='row form-group'>
          ...
          <div class='col-12 col-md-6'>
	         <form:input type="text" id="dta_jccourse_end_date" path="dta_jccourse_end_date" maxlength="10" value="DD/MM/YYYY"  class='form-control' style="width: 85%;display: inline;" autocomplete='off' onclick="clickclear(this, 'DD/MM/YYYY')" onblur="clickrecall(this,'DD/MM/YYYY');validateDate(this.value,this);" onkeyup="clickclear(this, 'DD/MM/YYYY')" 
								onchange="clickrecall(this,'DD/MM/YYYY')" aria-required="true"></form:input>
 <span class="errorClass" id="dta_jccourse_end_date_lbl">${dta_jccourse_end_date_lbl}</span>
        </div>
    </div>
</div>
 <div class='col-md-6'>
 ...
 <span class="errorClass" id="dta_182daycourse_no_lbl">${dta_182daycourse_no_lbl}</span>
        </div>
    </div>
</div>
 <div class='col-md-6'>
	  <div class='row form-group'>
          ...
          <div class='col-12 col-md-6'>
	         <form:input type="text" id="dta_182daycourse_init_date" path="dta_182daycourse_init_date" maxlength="10" value="DD/MM/YYYY"  class='form-control' style="width: 85%;display: inline;" autocomplete='off' onclick="clickclear(this, 'DD/MM/YYYY')" onblur="clickrecall(this,'DD/MM/YYYY');validateDate(this.value,this);" onkeyup="clickclear(this, 'DD/MM/YYYY')" 
								onchange="clickrecall(this,'DD/MM/YYYY')" aria-required="true"></form:input>
 <span class="errorClass" id="dta_182daycourse_init_date_lbl">${dta_182daycourse_init_date_lbl}</span>
        </div>
    </div>
</div>
 <div class='col-md-6'>
	  <div class='row form-group'>
          ...
          <div class='col-12 col-md-6'>
	         <form:input type="text" id="dta_182daycourse_term_date" path="dta_182daycourse_term_date" maxlength="10" value="DD/MM/YYYY"  class='form-control' style="width: 85%;display: inline;" autocomplete='off' onclick="clickclear(this, 'DD/MM/YYYY')" onblur="clickrecall(this,'DD/MM/YYYY');validateDate(this.value,this);" onkeyup="clickclear(this, 'DD/MM/YYYY')" 
								onchange="clickrecall(this,'DD/MM/YYYY')" aria-required="true"></form:input>
 <span class="errorClass" id="dta_182daycourse_term_date_lbl">${dta_182daycourse_term_date_lbl}</span>
        </div>
    </div>
</div>
 <div class='col-md-6'>
 ...
 <span class="errorClass" id="dta_waiver_lbl">${dta_waiver_lbl}</span>
        </div>
    </div>
</div>
 <div class='col-md-6'>
 ...
 <span class="errorClass" id="dta_firstchance_year_lbl">${dta_firstchance_year_lbl}</span>
        </div>
    </div>
</div>
 <div class='col-md-6'>
 ...
 <span class="errorClass" id="dta_firstchance_center_lbl">${dta_firstchance_center_lbl}</span>
        </div>
    </div>
</div>
 <div class='col-md-6'>
 ...
 <span class="errorClass" id="dta_secondchance_year_lbl">${dta_secondchance_year_lbl}</span>
        </div>
    </div>
</div>
 <div class='col-md-6'>
 ...
 <span class="errorClass" id="dta_secondchance_center_lbl">${dta_secondchance_center_lbl}</span>
        </div>
    </div>
</div>
 <div class='col-md-6'>
 ...
 <span class="errorClass" id="dta_thirdchance_year_lbl">${dta_thirdchance_year_lbl}</span>
        </div>
    </div>
</div>
 <div class='col-md-6'>
 ...
 <span class="errorClass" id="dta_thirdchance_center_lbl">${dta_thirdchance_center_lbl}</span>
        </div>
    </div>
</div>
    </div>
