...
<div class="container" align="center">
	<div class="card">
    <div class="card-header"> <h5>PART B EXAMINATION</h5></div>
...
<div class='col-md-6'>
	  <div class='row form-group'>
	      <div class='col col-md-4'>
	            <label for="text-input" class="form-control-label">Centre<strong style="color: red;">*</strong></label>
          </div>
          <div class='col-12 col-md-6'>
          <input type="text" id="OfficerName" name="OfficerName"  class="form-control" autocomplete='off' />
<%-- 	             <form:input type="text" id="ac_arm_description" path="ac_arm_description"  class="form-control" autocomplete='off'  ></form:input> --%>
...
<div class='col-md-6'>
	  <div class='row form-group'>
	      <div class='col col-md-4'>
	            <label for="text-input" class="form-control-label">Total reckonable service on the first day of exam<strong style="color: red;">*</strong></label>
          </div>
          <div class='col-12 col-md-6'>
          <input type="text" id="OfficerName" name="OfficerName"  class="form-control" autocomplete='off' />
<%-- 	             <form:input type="text" id="ac_arm_description" path="ac_arm_description"  class="form-control" autocomplete='off'  ></form:input> --%>
...
<div class='col-md-6'>
	  <div class='row form-group'>
	      <div class='col col-md-4'>
	            <label for="text-input" class="form-control-label">Unit<strong style="color: red;">*</strong></label>
          </div>
          <div class='col-12 col-md-6'>
          <input type="text" id="OfficerName" name="OfficerName"  class="form-control" autocomplete='off' />
<%-- 	             <form:input type="text" id="ac_arm_description" path="ac_arm_description"  class="form-control" autocomplete='off'  ></form:input> --%>
...
<div class='col-md-6'>
	  <div class='row form-group'>
	      <div class='col col-md-4'>
	            <label for="text-input" class="form-control-label">Unit Address1<strong style="color: red;">*</strong></label>
          </div>
          <div class='col-12 col-md-6'>
          <input type="text" id="OfficerName" name="OfficerName"  class="form-control" autocomplete='off' />
<%-- 	             <form:input type="text" id="ac_arm_description" path="ac_arm_description"  class="form-control" autocomplete='off'  ></form:input> --%>
...
<div class='col-md-6'>
	  <div class='row form-group'>
	      <div class='col col-md-4'>
	            <label for="text-input" class="form-control-label">Unit Address2<strong style="color: red;">*</strong></label>
          </div>
          <div class='col-12 col-md-6'>
          <input type="text" id="OfficerName" name="OfficerName"  class="form-control" autocomplete='off' />
<%-- 	             <form:input type="text" id="ac_arm_description" path="ac_arm_description"  class="form-control" autocomplete='off'  ></form:input> --%>
...
<div class='col-md-6'>
	  <div class='row form-group'>
	      <div class='col col-md-4'>
	            <label for="text-input" class="form-control-label">Address to receive Exam Correspondence Address1<strong style="color: red;">*</strong></label>
          </div>
          <div class='col-12 col-md-6'>
          <input type="text" id="OfficerName" name="OfficerName"  class="form-control" autocomplete='off' />
<%-- 	             <form:input type="text" id="ac_arm_description" path="ac_arm_description"  class="form-control" autocomplete='off'  ></form:input> --%>
...
<div class='col-md-6'>
	  <div class='row form-group'>
	      <div class='col col-md-4'>
	            <label for="text-input" class="form-control-label">Address to receive Exam Correspondence Address2<strong style="color: red;">*</strong></label>
          </div>
          <div class='col-12 col-md-6'>
          <input type="text" id="OfficerName" name="OfficerName"  class="form-control" autocomplete='off' />
<%-- 	             <form:input type="text" id="ac_arm_description" path="ac_arm_description"  class="form-control" autocomplete='off'  ></form:input> --%>
...
<div class='col-md-6'>
	  <div class='row form-group'>
	      <div class='col col-md-4'>
	            <label for="text-input" class="form-control-label">Address to receive Exam Correspondence Address3<strong style="color: red;">*</strong></label>
          </div>
          <div class='col-12 col-md-6'>
          <input type="text" id="OfficerName" name="OfficerName"  class="form-control" autocomplete='off' />
<%-- 	             <form:input type="text" id="ac_arm_description" path="ac_arm_description"  class="form-control" autocomplete='off'  ></form:input> --%>
