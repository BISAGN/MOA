...
<!-- 				       </div> -->
			      ...
			      <div class='col-md-12' style="margin-top: 10px;">
			       ...
			       <div class='col-md-12' style="margin-top: 10px;margin-bottom: 10px;">
					 <div class='col-md-6'>
							  <div class='row form-group'>
							      <div class='col col-md-4'>
							        <label for="text-input" class=" form-control-label">Letter No<br>(For DSCC)</label>
						          </div>
						          <div class='col-12 col-md-6'>
							         <input type="text" id="tender" name="tender" class="form-control" autocomplete="off" maxlength="30" >
				        ...
				        <div class='col-md-6'>
							  <div class='row form-group'>
							      <div class='col col-md-4'>
							        <label for="text-input" class=" form-control-label">Letter Dated<br>(For DSCC)</label>
						          </div>
						          <div class='col-12 col-md-6'>
			      ...
			      <div class='col-md-12' style="margin-top: 10px;margin-bottom: 10px;">
					 <div class='col-md-6'>
							  <div class='row form-group'>
							      <div class='col col-md-4'>
							        <label for="text-input" class=" form-control-label">Letter No<br>(For TSOC)</label>
						          </div>
						          <div class='col-12 col-md-6'>
							         <input type="text" id="tender" name="tender" class="form-control" autocomplete="off" maxlength="30" >
				        ...
				        <div class='col-md-6'>
							  <div class='row form-group'>
							      <div class='col col-md-4'>
							        <label for="text-input" class=" form-control-label">Letter Dated<br>(For TSOC)</label>
						          </div>
						          <div class='col-12 col-md-6'>
							         <input type="text" id="letter_date" name="letter_date" maxlength="10" value="DD/MM/YYYY"  
							         class='form-control' style="width: 85%;display: inline;" autocomplete='off' 
