			...
			<div class="row align-items-center">
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="title mb-30">
						<h2>Supplementary University Exam</h2>
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="breadcrumb-wrapper mb-30">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Supplementary
									University Exam</li>
							</ol>
						</nav>
					</div>
		...
		<div class="form-elements-wrapper">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<!-- input style start -->
					<form:form name="supplementary_univer_exam"
						id="supplementary_univer_exam"
						action="supplementary_univer_examAction" method='POST'
						commandName="supplementary_univer_examCMD"
						enctype="multipart/form-data">
						<div class="card-style mb-30">
							<div class="custom-field-block">
								<h6 class="mb-25">Supplementary University Exam</h6>
								<div class="row">
								...
								<div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12">
										<ul class="buttons-group mainbtn">
											...
											<li><a href="Supplementary_Univer_Exam_url"
									...
									<div class="col-lg-12 col-md-12 col-sm-12">
										<div id="checkheaddiv">
											<input type="hidden" id="CheckVal" name="CheckVal"> <input
												type="hidden" id="CheckValAyu" name="CheckValAyu"> <input
												type="hidden" id="CheckVal2" name="CheckVal2"> <input
												type="hidden" id="CheckVal3" name="CheckVal3">
									...
									<div class="col-lg-12 col-md-12 col-sm-12">
											<ul class="buttons-group mainbtn">
												<li><input type="button"
													class="main-btn success-btn btn-hover btnprom" value="Promote"
													id="pass"></li>
												<li><input type="button"
													class="main-btn danger-btn btn-hover" value="Fail"
													id="fail"></li>
											</ul>
											</div>
											</div>
...
<script nonce="${cspNonce}" type="text/javascript">
	...
	document.addEventListener('DOMContentLoaded', function() {
		...
		document.getElementById('pass').onclick = function() {
			return setUniversity_PassStatus();
		};
		document.getElementById('fail').onclick = function() {
			return setUniversity_DetainStatus();
		};
	...
	function getpop() {
		...
		$
				.post(
						"getstu_Supplementary_declare_data?" + key + "="
								+ value,
						{
							system_id : system_id,
							degree_id : degree_id,
									...
									$("#tbody_pop")
											.append(
													'<tr><td><div class="check-input-primary"><input class="form-check-input mr-5 mul_check chb nrCheckBox" type="checkbox" name="multiselect'
															...
															+ '<td><p id="dob">'
															+ j[i][2]
															+ '</p><input type="hidden" id="date_of_exam'
															+ parseInt(i + 1)
															+ '" name="date_of_exam'
															+ parseInt(i + 1)
															+ '" value="'
	...
	function setUniversity_PassStatus() {
		findselected();
		if (Validation()) {
			...
			$.post("University_Pass_Student_Data?" + key + "=" + value, {
				a : a,
				system_id : system_id,
				degree_id : degree_id,
				professional_id : professional_id,
	...
	function setUniversity_DetainStatus() {
		$("#subjecthide").show();
		findselected();
		if (Suppri_Validation()) {
			...
			$.post("University_Suppl_Student_Data?" + key + "=" + value, {
				a : check_list,
				system_id : system_id,
				degree_id : degree_id,
				professional_id : professional_id,
