								...
								<div class="row">
									...
									<div class="col-12 col-sm-12 col-md-6 col-lg-4"
										...
										<div class="input-style-1 mb-0">
											...
											<label>Payment(Applicable Only for Fee Schedule)<span class="mandatory">*</span></label>
										</div>
										<div class="custom-choose-one">
											<div class="input-style-form-check">
														...
														<td>
															<div class="input-style-1">
																<input type="text" id="fees_sub_cat_1"
																	placeholder="Enter Fees Sub Category" class="text-uppercase" name="fees_sub_cat_1"
																	autocomplete="off">
															</div>
														</td>
