...
<link rel="stylesheet" href="admin/js/assets/collapse/collapse.css">
...
<form:form name="Edit_b_Regulation" id="Edit_b_Regulation" action="Edit_b_Regulation_Action" method="post" class="form-horizontal" modelAttribute="Edit_b_RegulationCMD">
	<div class="animated fadeIn">
		<div class="container" align="center">
			<div class="card">
				<div class="card-header">
					<h5>Form B Regulation</h5>
					<h6 class="enter_by">
	              				 ...
	              				 <div class="col-md-6">
	              					<div class="row form-group">
						               ...
						               <div class="col-md-8">
										...
										<img class='d-block img5050 imageZomm' alt="No Image" id="myImg" src="MedicalImagePath1?i_id=${Edit_b_reg_mstr_Details.id}" />
						                  </div>
						                  <button type="button" onclick="imageView();"><i class="fa fa-eye" title="Print" style='color: #04474a; font-size: x-large;' ></i></button>
										<a href="MedicalImagePath1?i_id=${Edit_b_reg_mstr_Details.id}" download>
...
<div class="card-footer" align="center">
	        		     <a href="edu_search_b_reg_url" id=""	class="btn-cancel">BACK</a>
...
$(document).ready(function() {
	 ...
	 $('input#upload_img_hid').val('${TB_EDU_B_REGULATION.photo_path}'); 
	$('#id').val('${Edit_b_reg_mstr_Details.id}');
	$('input#nrh_en_no').val('${Edit_b_reg_mstr_Details.nrh_en_no}');
	//$('input#photo_path').val('${Edit_b_reg_mstr_Details.photo_path}');
	 $('input#first_name').val('${Edit_b_reg_mstr_Details.first_name}'); 
	 //$('input#gender').val('${Edit_b_reg_mstr_Details.gender}'); 
	 if ('${Edit_b_reg_mstr_Details.gender}' =="0")
		 {
		 $('#male').prop("checked",true);
		 }
	  if ('${Edit_b_reg_mstr_Details.gender}' =="1")
	 {
		  $('#female').prop("checked",true);
	 }
	 if  ('${Edit_b_reg_mstr_Details.gender}' =="2")
	 {
		 $('#other').prop("checked",true);
	 }
	 $('input#aadhaar_no').val('${Edit_b_reg_mstr_Details.aadhaar_no}');
	 $('input#mo_no').val('${Edit_b_reg_mstr_Details.mo_no}'); 
	 $('input#alt_mo_no').val('${Edit_b_reg_mstr_Details.alt_mo_no}'); 
	 $('input#fax_no').val('${Edit_b_reg_mstr_Details.fax_no}'); 
	 $('input#email_id').val('${Edit_b_reg_mstr_Details.email_id}'); 
	 
  
	// var dob = '${Edit_b_reg_mstr_Details.dob}'.substring(0,10);
	 // $('#dob').val('${Edit_b_reg_mstr_Details.dob}');
	 var d=  $("#dob").val(ParseDateColumn('${Edit_b_reg_mstr_Details.dob}'));
	 
	 $('input#father_name').val('${Edit_b_reg_mstr_Details.father_name}'); 
	 $('select#nationality').val('${Edit_b_reg_mstr_Details.nationality}'); 
	 $('textarea#per_address').val('${Edit_b_reg_mstr_Details.per_address}'); 
	 $('select#per_state').val('${Edit_b_reg_mstr_Details.per_state}'); 
	 $('select#per_district').val('${Edit_b_reg_mstr_Details.per_district}');
	 $('input#per_pincode').val('${Edit_b_reg_mstr_Details.per_pincode}');
	 $('textarea#pre_address').val('${Edit_b_reg_mstr_Details.pre_address}');
	 $('select#pre_state').val('${Edit_b_reg_mstr_Details.pre_state}');
	 $('select#pre_district').val('${Edit_b_reg_mstr_Details.pre_district}');
	 $('input#pre_pincode').val('${Edit_b_reg_mstr_Details.pre_pincode}');
	 $('input#name_reg').val('${Edit_b_reg_mstr_Details.name_reg}');
	 $('input#reg_renew_permanent').val('${Edit_b_reg_mstr_Details.reg_renew_permanent}');
	 $('input#degree').val('${Edit_b_reg_mstr_Details.degree}');
	 $('input#university').val('${Edit_b_reg_mstr_Details.university}');
	 $('input#month_year').val('${Edit_b_reg_mstr_Details.month_year}');
	 $('input#reg_no').val('${Edit_b_reg_mstr_Details.reg_no}');
	  
	 
	 $("#date_of_reg").val(ParseDateColumn('${Edit_b_reg_mstr_Details.date_of_reg}'));
	 
	 
	// $('input#date_of_reg').val('${Edit_b_reg_mstr_Details.date_of_reg}');
	 
	 
	 $('input#name_of_hospital_teaching').val('${Edit_b_reg_mstr_Details.name_of_hospital_teaching}');
	 $('input#name_of_patient').val('${Edit_b_reg_mstr_Details.name_of_patient}');
	 $('input#crh_no').val('${Edit_b_reg_mstr_Details.crh_no}');
	 $('input#cch_no').val('${Edit_b_reg_mstr_Details.cch_no}');
	 $('input#nch_no').val('${Edit_b_reg_mstr_Details.nch_no}');
	...
	function saveData(){
		...
		var form = $('#Edit_b_Regulation')[0];
			...
			$.ajax({
				...
				url : "Edit_b_Regulation_Action?"+key+"="+value,
				data : data,
				processData : false,
				contentType : false,
				cache : false,
				...
				success : function(data) {
					...
					//	alert(data);
						...
						if( data=="Update Successfully"){
							 ...
							 window.location = 'Edit_edu_b_reg_mstrUrl?msg='+data;	
						}
					}
				//}
			});
