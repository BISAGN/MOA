				...
				<div class="card-body card-block">
					<div class="row mb-3">
								...
								<div class="col-md-4">
									...
									<input id="login_name" name="login_name" class="edit_user"  value="${edit_User_MstCMD.login_name}" class="form-control" autocomplete="off" maxlength="70">
								</div>
					</div>
					<div class="row mb-3">
								<div class="col-md-2">
									<label for="text-input">User ID <strong class="user_id">*</strong>
									</label>
								</div>
								<div class="col-md-4">
									<input type="hidden" id="user_name" name="user_name" value="${edit_User_MstCMD.userName}"> <input id="user" name="user" class="u_name"  readonly="readonly" value="${edit_User_MstCMD.userName}" maxlength="30" class="form-control" autocomplete="off" required>
								</div>
					</div>
					<div class="row mb-3">
								<div class="col-md-2">
									<label for="text-input">Password <strong class="pass">*</strong>
									</label>
								</div>
								<div class="col-md-4">
					...
					<div class="row mb-3">
								<div class="col-md-2">
									<label for="text-input">Re-Password <strong class="pass">*</strong> </label>
								</div>
								<div class="col-md-4">
					...
					<div class="row mb-3">
								<div class="col-md-2">
									<label for="text-input">Role <strong class="pass">*</strong>
									</label>
								</div>
								<div class="col-md-4">
									<input type="hidden" id="role1" name="role1" class="form-control" value="${getRole[0].role}" autocomplete="off" required> 
									<select name="user_role_id" id="user_role_id" onchange="getaccess_lev(this.value);" class ="role_1"  class="select2 narrow wrap">
