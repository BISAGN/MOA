									...
									<div class="col-lg-4 col-md-6 col-sm-12 col-12">
										<div class="input-style-1">
											...
											<input type="text" name="pan" id="pan"
												class="form-control"
												placeholder="Enter PAN " maxlength="100">
										</div>
									</div>
                                                        ...
                                                        <tr>
														 ...
														 <tr>
														  <td>2</td>
															<td>Kriya Rao</td>
															<td>KR23898545</td>
															<td>Assistants or Attendants in Paediatrics (for P.G.)</td>
