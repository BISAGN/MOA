					...
					<form:form name="" id=""
						...
						<div class="card-style mb-30">
							<div class="custom-field-block">
								<h6 class="mb-25">Hospital ipdopd Report</h6>
								<div class="row">
										...
										<div class="select-style-1">
											...
											<div class="select-position">
												<select class="form-control" name="department"
													...
													<option value="5">Rehabilitation Unit Including Yoga</option>
													<option value="6">Other OPDs</option>
												...
												<table id="getSearch_college_Staff_Info_Report" class="table">
													<thead>
														<tr>
															...
															<th><h6>Month</h6></th>
															<th><h6>Total No of Beds</h6></th>
															<th><h6>Total Wards</h6></th>
                                                        ...
                                                        <tr>
														  <td>1</td>
															...
															<td><a class='main-btn dark-btn btn-hover btn-sm viewData' value='ADD' 
															 title='View Data' href="hospital_ipdopd_view" >
