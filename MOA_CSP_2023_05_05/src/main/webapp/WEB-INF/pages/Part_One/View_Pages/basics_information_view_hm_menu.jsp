						...
						<div class="row">
							<div class="col-lg-12 col-md-12 col-sm-12 col-12">
								<div class="custom-data-value custom-title custom-title-bg">
									<h5 class="custom-title-tag">Institution Details Institution Details Institution Details Institution Details</h5>
								</div>
							</div>
...
// 	alert('${getInstname[0].institute_name}')
	if('${role}'!="NCH"){
		$(".btnedit").css("visibility", "hidden");
				...
				$("select#per_state").val(${View_Search_Basic_InfoCMD.state_id});
				 var service = $('select#per_state').find(":selected").text();
				$("#per_statelabel").text(service);
				
				$("select#mang_per_state").val(${View_Search_Basic_InfoCMD.state_id});
				 var service1 = $('select#mang_per_state').find(":selected").text();
				$("#mang_per_statelabel").text(service1);
				
				$("select#state_rn_head1").val(${View_Search_Basic_InfoCMD.state_id});
				 var service2 = $('select#state_rn_head1').find(":selected").text();
				$("#state_rn_head").text(service2);
				
				$("select#per_state_head_inst").val(${View_Search_Basic_InfoCMD.state_id});
				 var service3 = $('select#per_state_head_inst').find(":selected").text();
				$("#hoiper_statelabel").text(service3);
				
				$("select#police_per_state").val(${View_Search_Basic_InfoCMD.state_id});
				 var service4 = $('select#police_per_state').find(":selected").text();
				$("#police_per_statelabel").text(service4);
