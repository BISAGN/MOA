			...
			<div class="row align-items-center">
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="title mb-30">
						<h2>View Hospital Staff Details</h2>
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
			...
			<div class="row viewmenu">
				<div class="col-lg-12 col-md-12 col-sm-12 col-12">
					<div class="hamburger-menu">
						...
						<div class="hm-title"><h4 class="hm-title-text">Hospital Staff Details view form report</h4></div>
					</div>
...
<!-- 							<li><a href="declaration_view">Declaration</a></li> -->
		...
		<div class="form-elements-wrapper tunnel-form preview-form">
			<form:form name="hospital_staffdetails_view1" id="hospital_staffdetails_view1" action="" method="post" modelAttribute="">
						...
						<input type="hidden" id="main_view_id" name="main_view_id" value="0">
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-12">
								<div class="custom-data-value custom-title custom-title-bg custom-title-btn">
									<h5 class="custom-title-tag">Hospital Staff</h5>
									<a href="#" class="main-btn active-btn btn-hover btn-sm btnedit custom-btn-tag" 
								title="Remarks" data-bs-toggle="modal" data-bs-target="#hosp_staff_Modal"><i class="lni lni-pencil-alt"></i></a>
								</div>
							</div>
									...
									<div class="table-wrapper table-responsive custom-table">
										<table class="table" id="hospitalstaff_table">
											...
											<tbody id="doc_Tbbody">
										 	...
										 	<c:forEach var="j" items="${View_Hospital_Staff_Details2}"
  												varStatus="num">  
												<tr>
													<td class="sr-no">
														<p></p>
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-12">
								<div class="custom-data-value custom-title custom-title-bg custom-title-btn">
									<h5 class="custom-title-tag">Uploaded Documents</h5>
										<a href="#" class="main-btn active-btn btn-hover btn-sm btnedit custom-btn-tag" 
								title="Remarks" data-bs-toggle="modal" data-bs-target="#hosp_staff_doc_Modal"><i class="lni lni-pencil-alt"></i></a>
								<input type="hidden" id="hosp_staff_detl_doc_id" value="${hsddocdata[0].id}"  
														name="hosp_staff_detl_doc_id" class="form-control"> 
								</div>
							</div>

							<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
								<div class="custom-data-value">
									<label>Attendance Register and Biometric attendance of Hospital Staff</label> <span
										class="value-bind daobtn" id=""> <a href="#"
										class="main-btn dark-btn btn-hover btn-sm btnview"
										title="View" id="attend_hospitalstaff_doc_view"><i class="lni lni-eye"></i></a></span>
								</div>
							</div>

							<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
								<div class="custom-data-value">
									<label>Acquittance Role of Hospital Staff</label> <span class="value-bind daobtn" id=""> <a
										href="#" class="main-btn dark-btn btn-hover btn-sm btnview"
										title="View" id="acquittancestaff_doc_view"><i class="lni lni-eye"></i></a></span>
								</div>
							</div>

							<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
								<div class="custom-data-value">
									<label>Doctors duty rosters *</label> <span
										class="value-bind daobtn" id=""> <a href="#"
										class="main-btn dark-btn btn-hover btn-sm btnview"
										title="View" id="doctor_rosters_doc_view"><i class="lni lni-eye"></i></a></span>
								</div>
							</div>

							<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
								<div class="custom-data-value">
									<label>Nurse duty rosters</label> <span
										class="value-bind daobtn" id=""> <a href="#"
										class="main-btn dark-btn btn-hover btn-sm btnview"
										title="View" id="nurse_rosters_doc_view"><i class="lni lni-eye"></i></a></span>
								</div>
							</div>
		...
		<div class="modal-content">
					...
					<div class="row">
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-12">
							...
							<div class="input-style-1">
								...
								<textarea id="hosp_staff_dtl_hospital_staff_rmk" name="hosp_staff_dtl_hospital_staff_rmk"  placeholder="Enter Remarks" rows="5"></textarea>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="modal-footer">
				<ul class="buttons-group">
					...
					<li><a class="main-btn success-btn  btn-hover" id="hosp_remark" type="button">Submit</a>
					</li>
				</ul>
			</div>
		</div>
		...
		<div class="modal-content">
				...
				<div class="custom-modal-inner" id="headData1" name="headData1">
					<div class="row">
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="input-style-1">
								<label>Enter Remarks</label>
								<textarea id="hosp_staff_dtl_upload_doc_rmk" name="hosp_staff_dtl_upload_doc_rmk"  placeholder="Enter Remarks" rows="5"></textarea>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="modal-footer">
				<ul class="buttons-group">
					<li><a type="button" class="main-btn dark-btn n btn-hover"
						data-bs-dismiss="modal">Close</a></li>
					<li><a class="main-btn success-btn  btn-hover" id="hosp_stafe" type="button">Submit</a>
					</li>
				</ul>
			</div>
		</div>
...
<div class="modal fade custom-modal custom-modal-pdf" tabindex="-1"
	aria-labelledby="myLargeModalLabel" id="hosp_staff_detl_doc"
	aria-hidden="true">
	<div
...
$(document).ready(function() {
	...
	if(getView_idFrom_Institute_id != "[]"){
		...
		$("#hosp_staff_dtl_hospital_staff_rmk").val('${getView_idFrom_Institute_id[0].hosp_staff_dtl_hospital_staff_rmk}');
		$("#hosp_staff_dtl_upload_doc_rmk").val('${getView_idFrom_Institute_id[0].hosp_staff_dtl_upload_doc_rmk}');
	}
	});

document.addEventListener('DOMContentLoaded', function() {
	if('${role}'=="NCH"){
	document.getElementById('hosp_remark').onclick = function() {
		Save_As_Draft_Remarks();
	};
	
	document.getElementById('hosp_stafe').onclick = function() {
		Save_As_Draft_Remarks();
	};
	}
...
// 	document View
	...
	document.getElementById('attend_hospitalstaff_doc_view').onclick = function() {
		file_view($("#hosp_staff_detl_doc_id").val(),"hosp_staff_details_upload_document","attend_hospitalstaff");
	};
	document.getElementById('acquittancestaff_doc_view').onclick = function() {
		file_view($("#hosp_staff_detl_doc_id").val(),"hosp_staff_details_upload_document","acquittancestaff");
	};
	document.getElementById('doctor_rosters_doc_view').onclick = function() {
		file_view($("#hosp_staff_detl_doc_id").val(),"hosp_staff_details_upload_document","doctor_rosters");
	};
	document.getElementById('nurse_rosters_doc_view').onclick = function() {
		file_view($("#hosp_staff_detl_doc_id").val(),"hosp_staff_details_upload_document","nurse_rosters");
	};
...
function Save_As_Draft_Remarks() {
	...
	$.ajaxSetup({
		...
		var form_data = new FormData(document.getElementById("hospital_staffdetails_view1"));
		$.ajax({
...
function file_view(id,val,field) {
	 $("#hosp_staff_detl_doc").modal('show');
