			...
			<div class="row align-items-center">
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="title mb-30">
						<h2>View Hospital Equipments Details</h2>
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
						...
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">
									View Hospital Equipments Details</li>
							</ol>
						</nav>
					</div>
				</div>
			...
			<div class="row viewmenu">
				<div class="col-lg-12 col-md-12 col-sm-12 col-12">
					<div class="hamburger-menu">
						...
						<div class="hm-title"><h4 class="hm-title-text">Hospital Equipments view form report</h4></div>
					</div>
...
<!-- 							<li><a href="declaration_view">Declaration</a></li> -->
		...
		<div class="form-elements-wrapper tunnel-form preview-form">
			<form:form name="View_Hospital_Equipment1" id="View_Hospital_Equipment1" action="" method="post" modelAttribute=" ">
					...
					<div class="field-box">
						...
						<input type="hidden" id="main_view_id" name="main_view_id" value="0">
							...
							<div class="custom-data-value custom-title custom-title-bg custom-title-btn">
									<h5 class="custom-title-tag">Instruments & Equipments</h5>
									<a href="#" class="main-btn active-btn btn-hover btn-sm btnedit custom-btn-tag" title="Remarks" data-bs-toggle="modal" data-bs-target="#exampleModal_instrument_equip"><i class="lni lni-pencil-alt"></i></a>
								</div>									
							</div>
										...
										<table class="table" id="comp_print_table">
											<thead>
												<tr>
													...
													<th><h6>
															Total Equipments<strong class="mandatory">*</strong>
														</h6></th>
												</tr>
											...
											<tbody id="doc_Tbbody">
										 	...
										 	<c:forEach var="j" items="${View_Search_Hospital_Equipments2}"
  												varStatus="num">  
												<tr>
													<td class="sr-no">
														<p></p>
					...
					<div class="field-box">
						<div class="row">
							<div class="col-lg-12 col-md-12 col-sm-12 col-12">
									...
									<a href="#" class="main-btn active-btn btn-hover btn-sm btnedit custom-btn-tag" title="Remarks" data-bs-toggle="modal" data-bs-target="#exampleModal_upload_doc"><i class="lni lni-pencil-alt"></i></a>
								</div>
							</div>

							<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
							<input type="hidden" id="hos_opr_thet_lab_ipd_Eqip_hid" value="${getHosp_Equipment_Document_Details_List[0].id}" name="hos_opr_thet_lab_ipd_Eqip_hid" class="form-control"> 
								<div class="custom-data-value">
									<label>If Other Hospital/Operation Theater/Labour/IPD equipment are available</label> <span
										class="value-bind daobtn" id=""> <a href="#"
										class="main-btn dark-btn btn-hover btn-sm btnview"
										title="View" id="hos_opr_thet_lab_ipd_Eqip_view"><i class="lni lni-eye"></i></a></span>
								</div>
							</div>

							<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
								<div class="custom-data-value">
									<label>Equipments in Pathology laboratory & Biochemistry laboratory</label> <span class="value-bind daobtn" id=""> <a
										href="#" class="main-btn dark-btn btn-hover btn-sm btnview"
										title="View" id="Eqip_Path_lab_Bio_lab_view"><i class="lni lni-eye"></i></a></span>
								</div>
							</div>
...
<div class="modal fade custom-modal" tabindex="-1" role="dialog"
	...
	id="exampleModal_instrument_equip">
		...
		<div class="modal-content">
					...
					<div class="row">
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="input-style-1">
								...
								<textarea placeholder="Enter Remarks" rows="5" id="hospi_equip_instru_equip_rmk" name="hospi_equip_instru_equip_rmk"></textarea>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="modal-footer">
				<ul class="buttons-group">
					...
					<li><a class="main-btn success-btn  btn-hover" type="button" id="hospi_equip_instru_equip_rmk_btn">Submit</a>
					</li>
				</ul>
			</div>
		</div>
		...
		<div class="modal-content">
				...
				<div class="custom-modal-inner" id="headData1" name="headData1">
					<div class="row">
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="input-style-1">
								<label>Enter Remarks</label>
								<textarea placeholder="Enter Remarks" rows="5" id="hospi_equip_upload_doc_rmk" name="hospi_equip_upload_doc_rmk"></textarea>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="modal-footer">
				<ul class="buttons-group">
					<li><a type="button" class="main-btn dark-btn n btn-hover"
						data-bs-dismiss="modal">Close</a></li>
					<li><a class="main-btn success-btn  btn-hover" type="button" id="hospi_equip_upload_doc_rmk_btn">Submit</a>
					</li>
				</ul>
			</div>
		</div>
...
// 	alert("${getHosp_Equipment_Document_Details_List[0].id}");
	if('${role}'!="NCH"){
	...
	if(getView_idFrom_Institute_id != "[]"){
		...
		$("#hospi_equip_instru_equip_rmk").val('${getView_idFrom_Institute_id[0].hospi_equip_instru_equip_rmk}');
		$("#hospi_equip_upload_doc_rmk").val('${getView_idFrom_Institute_id[0].hospi_equip_upload_doc_rmk}');
	}
	});
...
document.addEventListener('DOMContentLoaded', function() {
	...
	///remark save
	document.getElementById('hospi_equip_instru_equip_rmk_btn').onclick = function() {
		Save_As_Draft_Remarks();
	};
	
	document.getElementById('hospi_equip_upload_doc_rmk_btn').onclick = function() {
		Save_As_Draft_Remarks();
	};
...
// 	document View
	...
	document.getElementById('hos_opr_thet_lab_ipd_Eqip_view').onclick = function() {
		file_view($("#hos_opr_thet_lab_ipd_Eqip_hid").val(),"hosp_equipments_document","sother_equip");
	};
	document.getElementById('Eqip_Path_lab_Bio_lab_view').onclick = function() {
		file_view($("#hos_opr_thet_lab_ipd_Eqip_hid").val(),"hosp_equipments_document","patho_bio_equip");
	};
...
function Save_As_Draft_Remarks() {
	...
	$.ajaxSetup({
		...
		var form_data = new FormData(document.getElementById("View_Hospital_Equipment1"));
		$.ajax({
