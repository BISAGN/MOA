					...
					<form:form name="" id=""
						...
						<div class="card-style mb-30">
							<div class="custom-field-block">
								<h6 class="mb-25">Hospital Staff Report</h6>
								<div class="row">
										...
										<div class="select-style-1">
											...
											<div class="select-position">
												<select class="form-control" name="department"
													...
													<option value="2">Physiology including Biochemistry</option>
													<option value="3">Organon of Medicine</option>
													<option value="4">Homoeopathic Pharmacy</option>
													<option value="5">Homoeopathic Materia Medica</option>
													<option value="6">Pathology & Microbiology</option>
													<option value="7">Forensic Medicine & Toxicology</option>
													<option value="8">Practice of Medicine</option>
													<option value="9">Surgery</option>
													<option value="10">Obstetrics & Gynecology</option>
													<option value="11">Community Medicine</option>
													<option value="12">Repertory</option>
										...
										<div class="select-style-1">
											...
											<div class="select-position">
												<select class="form-control" name="post"
													...
													<option value="2">Lecturer/Assistant Professor</option>
									...
									<div class="col-lg-4 col-md-6 col-sm-12 col-12">
										<div class="input-style-1">
											...
											<input type="text" name="tft" id="tft"
												class="form-control"
												placeholder="Enter The Name" maxlength="100">
										</div>
									</div>
													...
													<tbody class="custom-datatablepra">
                                                        <tr>
														  <td>1</td>
															...
															<td>Dr. Piyush Godara</td>
															<td><a class='main-btn dark-btn btn-hover btn-sm viewData' value='ADD' 
															 title='View Data' href="hospital_staff_list_view" >
