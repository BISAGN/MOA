			...
			<div class="row align-items-center">
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="title mb-30">
						<h2>Department Equipment Report</h2>
					</div>
				</div>
				<!-- end col -->
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
						...
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">
									Department Equipment Report</li>
							</ol>
						</nav>
					</div>
				</div>
					...
					<form:form name="" id=""
						...
						<div class="card-style mb-30">
							<div class="custom-field-block">
								<h6 class="mb-25">Department Equipment Report</h6>
								<div class="row">
										...
										<div class="select-style-1">
											...
											<div class="select-position">
												<select class="form-control" name="item"
													...
													<option value="1">Dissection Tables with marble tops or stainless steel</option>
													<option value="2">Dissection Set Complete</option>
													<option value="3">Saw for Sectioning Body & Limbs</option>
													<option value="4">Storage Tanks to Hold Cadavers</option>
													<option value="5">Diagrams</option>
													<option value="6">Slides</option>
													<option value="7">Soft part (Wet)</option>
													<option value="8">Soft part (Dry)</option>
													<option value="9">Skeleton (Articulated)</option>
													<option value="10">Bones (Loose)</option>
													<option value="11">Mummified Bodies</option>
													<option value="12">Latest Diagrams</option>
													<option value="13">Microscope (Medical)</option>
...
<%-- 													</c:forEach> --%>
								 ...
								 <div class="col-lg-4 col-md-6 col-sm-12 col-12">
										<div class="input-style-1">
											<label>Founder & Philosophers Name</label>
								 ...
								 <div class="col-lg-4 col-md-6 col-sm-12 col-12">
										<div class="input-style-1">
										 ...
										 <div class="col-lg-4 col-md-6 col-sm-12 col-12">
										<div class="input-style-1">
											<label>Number of Equipments for Identification</label>
											<input type="text" name="name" id="name"
												class="form-control"
												placeholder="Enter Name" maxlength="100">
								</div>
												...
												<table id="getSearch_college_Staff_Info_Report" class="table">
													<thead>
														<tr>
															...
															<th><h6>Number of Equipments for Identification</h6></th>
															<th><h6>Additional Items</h6></th>
