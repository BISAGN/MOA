								...
								<div class="col-12 col-sm-12 col-md-6 col-lg-4">
									<div class="input-style-2">
										<label>Book Price<span class="mandatory">*</span></label> <input
											...
											class="autocomplete UpperClassName txt-transupp"
											autocomplete="off" maxlength="100" placeholder="Enter Book Price" />
									</div>
								</div>
								<div class="col-12 col-sm-12 col-md-6 col-lg-4">
									<div class="input-style-2">
										<label>Book Qty<span class="mandatory">*</span></label> <input
											type="text" id="total_book_qty" name="total_book_qty"
											class="autocomplete UpperClassName txt-transupp"
											autocomplete="off" maxlength="100" placeholder="Enter Book Qty" />
									</div>
								</div>
								<div class="col-lg-4 col-md-6 col-sm-12">
									<div class="input-style-2">
									<label class=" form-control-label">Date of Entered</label>
						...
						<table class="table" id="search_all_books">
							<thead>
								<tr>
									...
									<th><h6>Book Author</h6></th>
									<th><h6>Book Price</h6></th>
									<th><h6>Book Qty</h6></th>
									<th><h6>Date of Entered</h6></th>
									<th><h6>Book Course</h6></th>
									<th><h6>Action</h6></th>
...
// 		return Validation();
// 	};
	document.getElementById('book_number').onkeypress = function() {
		return Validation(this, event);	
	};
// 	 document.getElementById('book_name').onkeypress = function() {
// 		return Validation();
// 	}; 
// 	document.getElementById('book_author').onkeypress = function() {
// 		return Validation();
// 	}; 
...
function data(search_all_books) {
	...
	$.post("getFilterall_books_data?" + key + "=" + value, {
		...
		for (var i = 0; i < j.length; i++) {
			jsondata.push([ j[i].ser,j[i].book_number, j[i].book_name, j[i].book_author, j[i].book_price, j[i].total_book_qty,j[i].date_of_entered,j[i].book_dept, j[i].action ]);
		}
	});
...
function Search() {
 ...
 function Validation() {
		...
		if ($("#total_book_qty").val() =="" ) {
			alert("Please Enter Book Qty.");
			$("input#total_book_qty").focus();
			return false;
		}
		
		 if($("#date_of_entered").val() == "DD/MM/YYYY" || $("#date_of_entered").val() == "") {
				alert("Please select Date Of Entered");
	 			$("#date_of_entered").focus();
				return false;
			}
