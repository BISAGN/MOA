          ...
          <div class="row align-items-center">
            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
              <div class="title mb-30">
                <h2>University Search For Provisional</h2>
              </div>
            </div>
            <!-- end col -->
            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
              <div class="breadcrumb-wrapper mb-30">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">   University Search For Provisional
                    </li>
                  </ol>
                </nav>
              </div>
        ...
        <div class=" form-elements-wrapper search-regulation-wrapper">
          ...
          <div class="col-12 col-lg-12 com-md-12 col-sm-12">
              ...
              <div class="custom-field-block">
                <h6 class="mb-25"> University Search For Provisional</h6>
               <div class="row">

               <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="input-style-2">
                  <label>Full Name <strong class="mandatory">  </strong></label>
                  <input id="first_name" name="first_name" class="form-control" autocomplete="off" maxlength="25" placeholder="Full Name" >
													 ...
													 <div class="col-lg-4 col-md-6 col-sm-12">
														<div class="select-style-1">
															...
															<div class="select-position">
																<select name="gender" id="gender" class="singleselect form-control form-control-lg">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 custom-d-none">
                <div class="input-style-2">
                 ...
                 <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="select-style-1">
                  <label>Registration State<strong class="mandatory"> </strong></label><div class="select-position">
                  <select name="registration_state" id="registration_state" class="singleselect form-control form-control-lg" 	> <!--   onchange="getDistrictper();" -->
                ...
                <!-- Bottom Button Start -->
                  ...
                  <li>
                    <a href="edu_search_reg_url" class="main-btn dark-btn n btn-hover btn-clear" value="Reset">Reset</a>
                  </li>
          
                  <li id="apprvbt" class="custom-d-none">
                   
                    <input type="button" class="main-btn success-btn  btn-hover" value="Approve" >
                  </li>
                  <li id="rejbt" class="custom-d-none">
                    <input type="button" class="main-btn danger-btn btn-hover " value="Revert Back" >
                  </li>
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				<ul class="buttons-group">
					<li>
					<button type="button" class="main-btn dark-btn n btn-hover" data-bs-dismiss="modal" 	data-dismiss="modal" aria-label="Close" id ="ok">Submit
					</button>
					</li>
				</ul>
			</div>
...
<form:form action="${uni_DegreePopupUrl}" method="post" id="degreepopup_Form"
	name="degreepopup_Form" modelAttribute="id" target="result">
	<input type="hidden" name="popid" id="popid" value="0" />
	<input type="hidden" name="name_of_institute" id="name_of_institute" value="0" />
...
<!-- //janki -->
<c:url value="provisional_University_previewUrl" var="provisional_University_previewUrl" />
<form:form action="${provisional_University_previewUrl}" method="post" id="preview_uni_Form" name="preview_uni_Form" modelAttribute="u_id" >
  ...
  document.querySelectorAll('.pract_hos').forEach((items, index) => {
	...
	document.querySelectorAll('.p_a_u').forEach((items, index) => {
		items.addEventListener('click', event => {
			...
			if (confirm('Are You Sure You Want to View and Verify Details?')) {
				fn_pre_app_uni(gdid);
			} else {
				return false;
			}
	...
	function data(Search_regulation_Master) {
		...
		$.post("getFilter_Edu_Reg_provisional_data?" + key + "=" + value, {
			startPage : startPage,
...
// 				 }
		...
		$.post("getTotalEdu_provisional_dataCount?" + key + "=" + value, {
			//nrh_en_no:nrh_en_no,
				Search : Search,
			first_name:first_name,
			institute_status:institute_status,
