			...
			<div class="row">
				...
				<div class="col-lg-12 col-md-12 col-sm-12">
					<form:form action="RegulationPreview_Action" id="uploadForm"
						method="POST" modelAttribute="RegulationPreviewCMD"
															...
															<td class="min-width addminusbut">
																<ul class="buttons-group mainbtn action">
																	<li><a
																		...
																		id="downloadbtn1" title="Downlaod"> <!--                                			 onclick="download_file(1);" -->
																			<i class="lni lni-download pdfdown"></i></a> <input
													...
													<div class="col-lg-12 col-md-12 col-sm-12">
														<ul class="buttons-group mainbtn">
															<li><input type="button"
																class="main-btn success-btn  btn-hover custom-d-none"
																value="Approve" id="apprvbt"></li>
															<li><input type="button"
																class="main-btn danger-btn  btn-hover custom-d-none"
																value="Reject" id="rejbt" name="rejbt"></li>
														</ul>
													</div>
												</div>
											</div>
...
<%-- 																		class="form-control autocomplete"> --%>
                 ...
                 <input type="text" class="form-control" id="place_of_working_o1"
							...
							<ul class="buttons-group mainbtn">
								...
								<li><a href="edu_search_reg_url" type="button" id="preview"
...
function setRejectStatus(){
	...
	if(tempSt == ""){
				...
				window.location.href="edu_search_reg_url";
		}); 
	}
}
...
// 					 +'<td><input type="checkbox"  class="form-check-input" id="cbox'+att+'" value=" " ></td>'
					 +'<td class="min-width"><div id ="ck'+att+'"> </div></td><td class="min-width"><p id="typeOfDegree'+att+'"></p></td>'
						+'<td class="min-width"><p  id="DegreeName'+att+'"></p></td>'
					 	...
					 	+'<td class="min-width" >'
	  					+'<select id="NameOfUniversity'+att+'" i name="NameOfUniversity'+att+'"  class="auto-input" value=""  custom-d-none  >'
	 				 	+'	<option value="0">--Select--</option>'
...
debugger
			 ...
			 if(att < 51){
				 ...
				 $("table#addAttDoc"+R).append('<tr align="center" id="tr_id_attDoc'+seq+'"><td>'+att+'</td>'
				 	...
				 	+'</tr>');
// 				 onclick="formopen_re_attDoc('+R+','+att+');" onclick="formOpenattDoc('+R+','+att+');" onchange="attachmentDetails(this,'+seq+');" onkeypress="AutoCompleteNameOfUniversity(this);"
				 addOnClick2(R,att,seq)
...
return true;
	...
	function  addOnClick2(R,att,seq){
