					...
					<form:form action="ProvisionalRegulationPreview_Action"
						...
						<div class="card-style mb-30 ">
							...
							<section class="single-detail-block">
								<div class="tables-wrapper">
									<div class="row">
									 ...
									 <input class='nrCheckBox' type='checkbox' id="cbox1"   name='cbox'  /> 
															...
															<td class="min-width"><select
																...
																class="auto-input custom-d-none">
																	<option value="0">--Select--</option>
															...
															<td class="min-width addminusbut">
																<ul class="buttons-group mainbtn action">
																	<li id="viewattachment"><a
																		...
																		id="downloadbtnview1" title="Downlaod"> <i
											...
											<ul class="buttons-group mainbtn">
												<li><input type="button"
													class="main-btn success-btn  btn-hover" value="Approve"
													id="apprvbt"></li>
												<li><input type="button"
													class="main-btn danger-btn btn-hover" value="Reject"
													id="rejbt" name="rejbt"></li>
												<!-- 							style="display: block" -->
												<!-- 							style="display: block" -->
												<!-- 							<a href="edu_search_pro_uni_reg_url" class="main-btn danger-btn btn-hover" type="button" value="Reverted" id="rejbt" name="rejbt" style="display: block">Reverted</a></li> -->
												<!-- 							<a href="edu_search_pro_uni_reg_url" type="button"  class="main-btn danger-btn btn-hover" value="Reverted" id="rejbt" name="rejbt" style="display: block"  -->
												<!-- 									class="main-btn dark-btn n btn-hover" type="button">Reset</li></a> -->
											</ul>
							...
							<div class="modal fade custom-modal bd-example-modal-lg"
								...
								aria-hidden="true" id="modelWindowR">
								...
								<section class="single-detail-block">
									<div id="pl_wr">
										<div class="row">
											<div class="col-lg-12 col-md-12 col-sm-12 col-12">
												<div class="custom-data-value custom-title custom-title-bg">
													<h5 class="custom-title-tag">Institute / office/
														clinic/ hospital</h5>
												</div>
											</div>
											<div class="tables-wrapper">
															...
															<table class="table" id="addHospital">
																...
																<tbody id="att_TbbodyNameMed">
																	<tr id="tr_id_attNameMed">
																		...
																		<td class="min-width">
																			<!--  <div class="input-style-1" id="pow1"> 
								...
								<div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12">
										<ul class="buttons-group mainbtn">
											...
											<li><a href="edu_search_pro_uni_reg_url" type="button"
												id="preview"
...
function setRejectStatus(){
	...
	if(tempSt == ""){
				...
				$.post("University_Reject_Degree?"+key+"="+value, {a:a,status:"2",tempSt:tempSt}).done(function(j) {
					alert("Revert Back Successfully");
					window.location.href="edu_search_pro_uni_reg_url";
		}); 
	}
}
...
if(a == ""){
	alert("Please Select the Data for Approval"); 
		...
		$.post("University_Approve_Degree?"+key+"="+value, {a:a,status:"1",u_id:u_id}).done(function(j) {
...
// 					 	onclick="download_file_view('+att+');"
...
// 			$("#dlall_pdf").append(
// 					'<a class="main-btn success-btn-outline btn-hover btn-sm addminusbut"onclick="download_file_view('+k+');" id="downloadbtn'+k+'" title="Downlaod">'
		 ...
		 $("#addAttDoc"+R).show();
			 ...
			 if(att < 51){
				 ...
				 $("table#addAttDoc"+R).append('<tr align="center" id="tr_id_attDoc'+seq+'"><td>'+att+'</td>'
				 	+'<td class="min-width"><div class="input-style-1"><input type="text" id="NameOfAttachment'+seq+'" name="NameOfAttachment'+seq+'" value="" class="form-control autocomplete" autocomplete="off" placeholder="Name of Attachment"></div></td>'
				 	...
				 	+'<td class="min-width"><div class="input-style-1"><input type="file" id="attachmentDocument'+seq+'" name="attachmentDocument'+seq+'" accept=".PDF" class="form-control"><input type="hidden" id="attachmentDoc_hid'+seq+'" name="attachmentDoc_hid'+seq+'" class="form-control"></div></td>' 
				 	...
				 	+'</tr>');
				 addOnclickattR(R,att);
				 attachmenttforparentthisseq(seq);
				 attachmenttforparentthis(seq);
...
return true;
	...
	function dynamicTable(R,index){
		...
		$("div#dynamicDataTable"+R).append('<table class="table model-table" id="addAttDoc'+R+'"><thead><tr><th>Sr No</th>'
...
// 							+'				onkeypress="AutoCompleteNameOfUniversity(this);"'
		...
		attachmenttforparent(R,seq);
		attachmenttforparentthisseqfor1(seq);
		attachmenttforparentthis(seq);
...
document.getElementById('addHospital').onchange = function() {
	...
	function attachmenttforparent(R,seq){
	...
	function attachmenttforparentthisseqfor1(seq){
		document.getElementById('attachmentDocument'+seq).onchange = function () {
			attachmentDetails(this,1);
		};
	}
	
	function attachmenttforparentthis(seq){
		document.getElementById('NameOfAttachment'+seq).onkeypress = function () {
