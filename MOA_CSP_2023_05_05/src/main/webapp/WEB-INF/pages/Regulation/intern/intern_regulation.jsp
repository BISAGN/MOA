...
<section class="dashboard-page regulation regulation_intern">
			...
			<div class="row align-items-center">
				<div class="col-md-6">
					<div class="title mb-30">
						<h2> Certificate For Students</h2>
					</div>
				</div>
				<!-- end col -->
				<div class="col-md-6">
					<div class="breadcrumb-wrapper mb-30">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page"> Provisional Certificate For Students</li>
							</ol>
						</nav>
					</div>
				</div>
		...
		<div class="form-elements-wrapper">
			<div class="row">
				...
				<div class="col-lg-12 col-md-12 col-sm-12">
					<form:form action="intern_Regulation_Action" id="uploadForm" method="POST"
						class="form-horizontal" modelAttribute="intern_RegulationCMD"
							...
							<div class="accordion" id="accordionPanelsStayOpenExample">
								<div class="accordion-item accordion-itemstyle">
									<h2 class="accordion-header" id="panelsStayOpen-headingOne">
										<button class="accordion-button accordion-itemstylena accordion-primary-button "
										...
										<div class="accordion-body">
											<div class="card-style mb-30">
											 ...
											 <div class="row" id = "nr_ay"  >
													<div class="col-lg-6 col-md-12 col-sm-12 mb-4 custom-d-none" id="ny">
													<label>NRH No : <strong class="mandatory"> <span> <label type="text" id="nrh" name="nrh"  	> </label>  </strong>
													</span></label>
  											 		</div>
 											 
 											 <div class="col-lg-6 col-md-12 col-sm-12 mb-4 custom-d-none" id="ay">
														...
														<div class="input-style-2">
															<label>Father's Full Name <strong class="mandatory">*
															 ...
															 <input type="text" id="father_name" name="father_name"
																placeholder="Father's Full Name" 	maxlength="50" class="form-control" autocomplete="off">
 														</div>
													</div>
													...
													<div class="col-lg-4 col-md-6 col-sm-12">
														<div class="input-style-2">
															<label>Date Of Birth <strong class="mandatory">*
															 ...
															 <input type="text" name="dob" id="dob" maxlength="10" class="form-control-sm form-control effect-9 "
																aria-required="true" autocomplete="off" value="DD/MM/YYYY">
															<div class="info-value">
																<b>Age :</b><span class="text-heighlight get-value" id="age" name="age"></span>
															</div>
														</div>
							...
							<div class="form-check radio-style">
													...
													<!-- end input -->
														...
														<div class="input-style-2">
															<label>Aadhaar Number <strong class="mandatory">*
															 ...
															 <input type="text" id="aadhaar_no" name="aadhaar_no" maxlength="14" minlength="12" class="form-control" autocomplete="off"
											...
											<div class="col-lg-4 col-md-6 col-sm-12">
														<div class="input-style-2">
													 	...
													 	<label  class="mandatory"  id = "upl_img"> </label>  
													...
													<div class="col-lg-4 col-md-6 col-sm-12">
														<div class="select-style-1">
															<label>Nationality <strong class="mandatory">* </strong></label>
 															<div class="input-style-2">
															 <input type="text" id="nat" name="nat" maxlength="10" class="form-control" autocomplete="off" value="INDIAN" readonly="readonly">
														</div>
															<div class="select-position custom-d-none">
																<select name="nationality" id="nationality"  
																	class="form-control customeNaionality_intern">
													...
													<div class="col-lg-4 col-sm-12">
														<div class="select-style-1">
															...
															<div class="select-position">
																<select name="reg_state" id="reg_state" class="singleselect form-control form-control-lg autocomplete" >
													...
													<div class="col-lg-4 col-sm-12">
														<div class="input-style-2">
															<label>Mobile Number<strong class="mandatory">* </strong> </label>
															 <input type="text" id="mo_no" name="mo_no"  maxlength="10" minlength="10"   	placeholder="Mobile Number">
 														</div>
													</div>
												<div class="col-lg-4 col-sm-12">
														<div class="input-style-2">
								...
								<div class="accordion-item accordion-itemstyle">
									<h2 class="accordion-header" id="panelsStayOpen-headingThree">
										<button class="accordion-button accordion-itemstylena accordion-primary-button collapsed"
											...
											aria-expanded="false" aria-controls="panelsStayOpen-collapseThree">DETAILS FOR PROVISIONAL CERTIFICATE</button>
									</h2>
...
<!-- 															 <th>Action</th> -->
														...
														<!-- <input type="hidden" value="0" id="btopen_close1"> -->
																...
																<label id="degree1" name="degree1" ></label>
															</div>
														</td>
														 		...
														 		<td class="min-width">
																		  ...
																		  <label id="DegreeName1_hid" name="DegreeName1_hid" > </label>
																			</td>
																			
																			<td class="min-width" >
																				<div class="input-style-2">
																					<input type="month" id="monthYearOfDegree1" name="monthYearOfDegree1"
																						class="form-control-sm form-control effect-9 hasDatepicker custom-d-none"/>
<!-- 																 <input type="text" id="monthYearOfDegree1_hid" name="monthYearOfDegree1_hid" value="" class="form-control" autocomplete="off" /> -->
																<label id="monthYearOfDegree1_hid" name="monthYearOfDegree1_hid" ></label>
																				</div>
																			</td>
																			...
																			<td class="min-width" >
																				<div class="input-style-2">
																					...
																					<label  id="NameOfInstitute1" name="NameOfInstitute1" > </label>		
																							
																							<input type="hidden" id="NameOfInstitute1_hid" name="NameOfInstitute1_hid" value=""
																							class="form-control" autocomplete="off" /> 
...
<!-- 																			</td> -->
																<td class="min-width">
																				<div class="select-style-1 custom-d-none">
 																					<div class="select-position">
																						...
																						<input type="hidden" id="NameOfUniversity1" name="NameOfUniversity1" value="0">
														...
														<label id="NameOfUniversity1_hid" name="NameOfUniversity1_hid" ></label>						
 																			</td>
																		 <td class="min-width">
																		 <div class="input-style-2">
		 ...
		 <!-- end row -->
								...
								<div class="accordion-item accordion-itemstyle custom-d-none">
															...
															<div class="table-wrapper table-responsive custom-table">
															    ...
															    <input type="hidden" id="count_hidden_for_new" name="count_hidden_for_new" class="form-control autocomplete" value="">
																 <input type="hidden" id="count_hidden_for_old" name="count_hidden_for_old" class="form-control autocomplete" value="">
																  <input type="hidden" id="admmisson_dt_hidden" name="admmisson_dt_hidden" class="form-control autocomplete" value="">
																<!-- end table -->
															</div>
															<!-- end card -->
														</div>
...
<!-- ----after check -->
							...
							<div id="chek_confirm" class="custom-choose-one ">
...
<!-- <div id = "chek_confirm" class="form-check checkbox-style mb-20 chek_confirm custom-d-none"> -->
<!--  <input class="form-check-input" type="checkbox" id="terms" name="terms" />  -->
<!--  <label class="form-check-label" for="checkbox-1"> I attest that all of the details, including any attachments, are true and accurate.</label> -->
<!--  </div> -->

<!-- I have certified that the information and any attached documents are true and correct . -->
<!-- I certify that the facts and any supporting documentation are accurate and true. -->
<!-- I certify that all information is truthful and accurate, including any supporting materials. -->
<!-- I certify that all information, including any attachments, is true and accurate. -->
<!-- I attest that all of the details, including any attachments, are true and accurate. -->

							<ul class="buttons-group mainbtn">
								<li><input type="button"
									class="main-btn success-btn  btn-hover btnsave" id="draft" 
									value="Save as Draft"></li>
								<li><input type="button"
									class="main-btn success-btn  btn-hover btnsave custom-d-none" id="update"
									value="Update" ></li>
								<li>
								...
								<li><input type="button" id="renew" class="main-btn secondary-btn btn-hover btnsave custom-d-none" value="Renew" ></li>
								 <li><a href="stupract_previewUrl?id7=${userId}"><input type="button" id="preview"  class="main-btn dark-btn n btn-hover" value="Preview"></a></li>
<!-- 						  <li><a href="Payment_Url"><input type="button" id="pay_btn"  class="main-btn secondary-btn btn-hover btn-save" value="Pay" style="display: none"></a></li> -->
							<li><input type="button" id="pay_btn"  class="main-btn secondary-btn btn-hover btnsave custom-d-none" value="Pay"></li>
						 <li></li>
							</ul>
	...
	<div class="modal-dialog modal-xl modal-dialog-scrollable">
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<label class="errorClass">  Note : <br> 1)Documents need to Upload : Provisional Registration Certificate , Final Year Marksheet <br>
...
<!-- 					<div  id="downloadbtn"> -->
<!-- 					 <i id="downloadbtn" title="Download"   class='fa fa-download' style="position: initial; left: 5px;  font-size: 25px; top: -12px; padding: 10px 0px 0px 0px; color: #359ade;"></i> -->
<!-- 					 </div> -->
 				 </div>
					</div>
				</div>
...
// if(${p_id} == 0){
    ...
    $.post('getayusAbhaDatalistStudent?' + key + "=" + value,{userId:userId},function(k) {
 		...
 		var dob = k[0]["dob"];
 		var admission_date = k[0]["fire"];
 		$("#admmisson_dt_hidden").val(admission_date);
 		...
 		var tDegree = k[0]["tid"];
 		var typeOfDegree11 = k[0]["type_of_degree"];
  		   
 			$("#degree1").text(typeOfDegree11);
 			 $("select#typeOfDegree1").val(tDegree);
   			getDegreeName(tDegree,1);
   
 		 var NameOfInstitute1 = k[0]["institute_name"];
   		 var university_name = k[0]["university_name"]; 
		 var NameOfUniversity1 = k[0]["university_userid"];
   		 var DegreeName1 = k[0]["degree_name"];
   		 
  		
   		  
  		 
//   		 var degree_id = k[0]["degree"];
//   		 $("#DegreeName1").val(degree_id);
 		  
 		  
 		if(  university_name !="0"){ 
 			$("#NameOfUniversity1_hid").text(university_name);
  			$("#NameOfUniversity1").val(NameOfUniversity1);
  		} 
 		if(  DegreeName1 !="0"){ 
 			$("#DegreeName1_hid").text(DegreeName1);
  		}
 		if(  NameOfInstitute1 !=" "){ 
 			$("#NameOfInstitute1").text(NameOfInstitute1);
  		}
 		...
 		if(abha_no!= null && abha_no.trim()!=""){ 
 		  ...
 		  var month_year = new Date (k[0]["admission_date"]);
 		  
 		  var monthc ;
 		  var yearc;
 		  yearc = month_year.getFullYear();
 		  monthc = month_year.getMonth() + 1;
  		  var cleanDate = String(monthc);
 			...
 			$("#monthYearOfDegree1").val(d);
 			
 			//document.getElementById("monthYearOfDegree1").value = d ;
  			var m = month_year.toLocaleString('default', { month: 'long' });
 			var mm = m + "," + yearc
 			$("#monthYearOfDegree1_hid").text(mm);
 		   //month and year of degree  end
 		...
 		if(${p_id} == 0){
 			...
 			if(first_name!= null && first_name.trim()!=" "){ 
 	 		...
 	 		else if(gender!= null && gender.trim()!=" " && gender == "Other"){
...
// ===
					...
					+'<input type="hidden" id="med_degree_att_new'+att+'" name="med_degree_att_new'+att+'" class="form-control autocomplete"></td>'
 				 	...
 				 	+'<input type="text" id="degree_hid'+att+'" name="degree_hid'+att+'" value="0" class="form-control" autocomplete="off" /></tr>');
				 medicaldegree(att);
				 download(att);
				// check_exs(att);
				}else{
...
//		------------------------name of medical degree
		for(exp = 1; exp <= 1; exp++){
	   	    for(a1 = 1; a1 <= 2; a1++){
	   		var b = $("#attachmentDocument1_1").val();
	   		var bb = $("#attachmentDocument1_2").val(); 
	   		  
	   		var c = $("#attachmentDoc_hid1_1").val(); 
	   		var cc = $("#attachmentDoc_hid1_2").val(); 
	   		
			if((b == undefined || bb == undefined || b == "" || bb == "" ) && ( c == undefined || cc == undefined || c == "" || cc == "" ) ){
...
// 		------23/JAN/Urmik
				...
				if( parseInt($("#admmisson_dt_hidden").val())>= 2019){	
					var neet_count=0;
...
if("${setDataCMD[0]['pay_status']}" == 1){
	$("#pay_status").val("${setDataCMD[0]['pay_status']}");
	$("#pay_btn").hide();
 }
...
// 		------------------for corrospondind select
		...
		if("${setDataCMD[0]['photo_path']}" != null && "${setDataCMD[0]['photo_path']}" != ""){
			$("#upload_img_hid").val("${setDataCMD[0]['photo_path']}");
 			$("#upl_img").text("Image Uploaded");
 		}
		else{
			$("#upl_img").text("Image Not Uploaded");
		}
...
// 		alert('$("#file_id"+i).val(id)');
		if(id != null && id.trim() != ""){
			$("#file_id"+i).val(id);
		}
//   		alert(${setAddMoreMedicalAttachmentChildCMD.size()})
//   		alert("ii--"+i)
...
// 				alert('${setAddMoreMedicalAttachmentChildCMD}'); NameOfAttachmenthid1_4
				var at_id = "${k['id']}";
				// alert(at_id+"---at_id")
				var parent_id = "${k['parent_id']}";
				var path_of_att = "${k['attachment']}";
				var name_of_att = "${k['name_of_attachment']}";
// 				console.log("${k['name_of_attachment']}");
				...
				if(parent_id == id){
					...
					if(name_of_att != null && name_of_att.trim() != ""){
						$("#NameOfAttachment"+i+"_"+k).text(name_of_att);
						$("#NameOfAttachmenthid"+i+"_"+k).val(name_of_att);
						   if (valid_dt2  <= today2  && '${hid}' == "3"){
				 ...
				 //alert("path_of_att--"+path_of_att)
// 					console.log(path_of_att);
					//janki
					if(path_of_att == ""){
						//attachmentDoc_hid1_1
						$("#file_upld"+i+"_"+k).text("No File Uploded");
						$("#file_upld_dbtn"+i+"_"+k).text("No File Uploded");
...
// 						console.log("no - ");
						...
						$("#file_upld_dbtn"+i+"_"+k).text("File Uploded");
// 						console.log("file --"+i+"--"+k);
					}
					...
					if(path_of_att != null && path_of_att.trim() != ""){
						...
						$("#attachmentDoc_hid"+i+"_"+k).attr("disabled","disabled");
								...
								//$("#file_upld"+i+"_"+k).text("File Not Uploded");
								if($("#draft").is(":hidden") && $("#update").is(":hidden") && $("#final_submit").is(":hidden"))
								 $("#attachmentDoc_hid"+i+"_"+k).attr("disabled","disabled");
		...
		if("${setAddMoreHospCMD.size()}" > 0){
			...
			if(place_of_working != null || place_of_working != ""){
				$("#place_of_working"+i).val(place_of_working);
				 if (valid_dt2  <= today2  && '${hid}' == "3"){
						$("#place_of_working"+i).attr("disabled","disabled");
						   }else{
								if($("#draft").is(":hidden") && $("#update").is(":hidden") && $("#final_submit").is(":hidden"))
									$("#place_of_working"+i).attr("disabled","disabled");
						   }
			...
			if(place_of_working_name != null || place_of_working_name != ""){
				...
				if (valid_dt2  <= today2  && '${hid}' == "3"){
					$("#place_of_working_name"+i).attr("disabled","disabled");
					   }else{
							if($("#draft").is(":hidden") && $("#update").is(":hidden") && $("#final_submit").is(":hidden"))
								$("#place_of_working_name"+i).attr("disabled","disabled");
					   }
			...
			if(adjunct_place != null || adjunct_place != ""){
				...
				if (valid_dt2  <= today2  && '${hid}' == "3"){
					$("#adjunct_place"+i).attr("disabled","disabled");
					   }else{
							if($("#draft").is(":hidden") && $("#update").is(":hidden") && $("#final_submit").is(":hidden"))
								$("#adjunct_place"+i).attr("disabled","disabled");
					   }
			...
			if(landline != null || landline != ""){
				...
				if (valid_dt2  <= today2  && '${hid}' == "3"){
					$("#landline"+i).attr("disabled","disabled");
					   }else{
							if($("#draft").is(":hidden") && $("#update").is(":hidden") && $("#final_submit").is(":hidden"))
								$("#landline"+i).attr("disabled","disabled");
					   }
			...
			if(mobile_no != null || mobile_no != ""){
				...
				if (valid_dt2  <= today2  && '${hid}' == "3"){
					$("#mobileHosp"+i).attr("disabled","disabled");
					   }else{
							if($("#draft").is(":hidden") && $("#update").is(":hidden") && $("#final_submit").is(":hidden"))
								$("#mobileHosp"+i).attr("disabled","disabled");
					   }
			...
			if(authority_type != null || authority_type != ""){
				...
				if (valid_dt2  <= today2  && '${hid}' == "3"){
					$("#authority_type"+i).attr("disabled","disabled");
					   }else{
							if($("#draft").is(":hidden") && $("#update").is(":hidden") && $("#final_submit").is(":hidden"))
								$("#authority_type"+i).attr("disabled","disabled");
			...
			if(hos_address1 != null || hos_address1 != ""){
				...
				if (valid_dt2  <= today2  && '${hid}' == "3"){
					$("#hos_address1_"+i).attr("disabled","disabled");
					   }else{
							if($("#draft").is(":hidden") && $("#update").is(":hidden") && $("#final_submit").is(":hidden"))
								$("#hos_address1_"+i).attr("disabled","disabled");
			...
			if(hos_address2 != null || hos_address2 != ""){
				...
				if (valid_dt2  <= today2  && '${hid}' == "3"){
					$("#hos_address2_"+i).attr("disabled","disabled");
					   }else{
							if($("#draft").is(":hidden") && $("#update").is(":hidden") && $("#final_submit").is(":hidden"))
								$("#hos_address2_"+i).attr("disabled","disabled");
			...
			if(hos_address3 != null || hos_address3 != ""){
				...
				if (valid_dt2  <= today2  && '${hid}' == "3"){
					$("#hos_address3_"+i).attr("disabled","disabled");
					   }else{
							if($("#draft").is(":hidden") && $("#update").is(":hidden") && $("#final_submit").is(":hidden"))
								$("#hos_address3_"+i).attr("disabled","disabled");
			...
			if(hos_state != null || hos_state != ""){
				...
				if (valid_dt2  <= today2  && '${hid}' == "3"){
					$("#hos_state"+i).attr("disabled","disabled");
					   }else{
							if($("#draft").is(":hidden") && $("#update").is(":hidden") && $("#final_submit").is(":hidden"))
								$("#hos_state"+i).attr("disabled","disabled");
			...
			if(hos_district != null || hos_district != ""){
				...
				if (valid_dt2  <= today2  && '${hid}' == "3"){
					$("#hos_district"+i).attr("disabled","disabled");
					   }else{
							if($("#draft").is(":hidden") && $("#update").is(":hidden") && $("#final_submit").is(":hidden"))
								$("#hos_district"+i).attr("disabled","disabled");
					   }
			...
			if(name_of_res_p != null || name_of_res_p != ""){
				...
				if (valid_dt2  <= today2  && '${hid}' == "3"){
					$("#name_of_res_p"+i).attr("disabled","disabled");
					   }else{
							if($("#draft").is(":hidden") && $("#update").is(":hidden") && $("#final_submit").is(":hidden"))
								$("#name_of_res_p"+i).attr("disabled","disabled");
					   }
	...
	function renewFunction(){ 
	 ...
	 var form = new FormData($("#uploadForm")[0]);
		 $.ajax({
		        type: "POST",
		        enctype: "multipart/form-data",
		        url: 'intern_Renew_Data_Action?' + key + "=" + value,
		        data: form,
		        processData: false,
		        contentType: false,
		        cache: false,
 ...
 function fileValidation() {
	...
	function formOpenattDoc(R,index){
		 ...
		 $("#addAttDoc"+R).show();
			 ...
			 var seq = ""+R+"_"+att+"";
// 			 console.log("add doc -- "+R+"--"+att)
			 if(att < 51){
				 $("input#count_hidden_att_doc"+R).val(att);//current serial Noinput#count_hidden_att_doc"+R).val(att)')
// 				 alert($('input#count_hidden_att_doc'+R).val(att));
				 $("table#addAttDoc2").append(	'<tr id="tr_id_attDoc'+seq+'">'
					+'		<td class="min-width">'
					+'			<div class="lead">'
 					+'				<div class="lead-text">'
					+'					<p>'+att+'</p>'
	...
	// // 					+'value="" class="form-control autocomplete" autocomplete="off"   >  
	  					 +'	<select name="NameOfAttachmenthid'+seq+'" id="NameOfAttachmenthid'+seq+'" class="form-control autocomplete" >  '
	 					 +' <option value="0">--Select--</option> 	'
...
// 	 					 +' <option value="Provisional Degree Certificate" name="Provisional Degree Certificate">Provisional Degree Certificate</option>  ' 
	 					...
	 					+'<td class="min-width"><div class="input-style-2 custom_inter_rg_attachDoc">'
						...
						+'	<td class="td_width custom_inter_rg_DownloadFile">'
					    +' <label id="file_upld_dbtn'+seq+'" name="file_upld_dbtn'+seq+'" value= " ">No File Uploded</label>' 
							+'<ul class="buttons-group mainbtn action custom-d-none" id="dbtn'+seq+'">'
						+' <li><a class="main-btn dark-btn-outline btn-hover btn-sm" id="downloadbtn'+att+'" title="Downlaod"><i class="lni lni-download pdfdown"></i></a><input type="hidden" '
						+' id="file_id" value="${item.file_id}"></li> '
						+' </ul>  '
						+'</td>'
						...
						+'<td class="min-width addminusbut">'
					 	+'<ul class="buttons-group mainbtn action">'
					 	+'<li><a class="main-btn success-btn-outline btn-hover btn-sm addminusbut" '
					 	+'id="downloadbtn' +seq+'" title="Downlaod">'
//	 				 	+'onclick="download_file_view('+att+');" id="downloadbtnview' +att+ '" title="Downlaod">'
						...
						+'	<td class="td_width d-none custom_inter_rg_NameofAttachDiv">'
						...
						+'				class="form-control autocomplete" autocomplete="off">'
  								...
  								+' ></label></div>'
  								+'			<input type="hidden" id="NameOfAttachmenthid'+seq+'"'
  								+'				name="NameOfAttachmenthid'+seq+'" value=""'
  								+'				class="form-control autocomplete" autocomplete="off">'
 
								+'	</div> </td>'
								+'  </tr>' 
// 						 '<tr align="center" id="tr_id_attDoc'+seq+'"><td>'+att+'</td>'
// 				 	+'<td class="min-width">'
// 					+' <div class="input-style-2">'
// // 					--change 22/12/22
// // 					+'<input type="text" mexlength="30" id="NameOfAttachment'+seq+'" name="NameOfAttachment'+seq+'" value="" class="form-control autocomplete" '
...
// // 				 	+'<span class="errorClass" id="attachmentDoc_file_lbl'+seq+'"></span> '
// // 				 	+'<span class="tikClass" id="attachmentDoc_file_lbltik'+seq+'"></div>'
// 			    	 +'<td><input type="hidden" id="attachmenttsss_hid'+att+'" name="attachmenttsss_hid'+att+'"  class="form-control" autocomplete="off" />'
// 					+'</td>'
...
// 				 	+'<i class="lni lni-download pdfdown"></i></a>'
// 				 	+'<input type="text" id="file_id'+att+'" name="file_id'+att+'"></li></ul>'
//  					+'</td>'
				 attachmentt(R,att);
				 download(att);
				 downloadView(R,att,seq);
// 				 ---urmik
...
function dynamicTable(R,index){
		...
		for(var a  = 1 ; a <= index ; a++){
			$("#id_add_attDoc"+R+"_"+(a-1)).hide();
			 $("#att_id_removeattDoc"+R+"_"+(a-1)).hide();
			if(a== 1){
				 
 				lbl = "${Attachment_data[0].doc_name}";
				lbl_id='${Attachment_data[0].id}';
			 
			}
			if(a== 2){
				 
				lbl = "${Attachment_data[1].doc_name}";
				lbl_id='${Attachment_data[1].id}';
			...
			$("div#dynamicDataTable"+R).append('<table class="table model-table" id="addAttDoc'+a+'"> '
					...
					+'			</div>'
						...
						+'	<td class="td_width custom_inter_rg_DynamicTb">'
						...
						+'				class="form-control autocomplete" autocomplete="off">'
  								...
  								+'<label  id="NameOfAttachment'+seq+'" name="NameOfAttachment'+seq+'" value="'+lbl+'"  '
  								+' >'+lbl+'</label></div>'
  								+'			<input type="hidden" id="NameOfAttachmenthid'+seq+'"'
  								+'				name="NameOfAttachmenthid'+seq+'" value="'+lbl+'"'
  								+'				class="form-control autocomplete" autocomplete="off">'
 
								+'	</div> </td>'
								
								+'<td class="min-width"><div class="input-style-2 custom_inter_rg_DynamicTb2" >'
							 	+'<input type="file" id="attachmentDocument'+seq+'" name="attachmentDocument'+seq+'" accept=".pdf"  class="form-control">'
							 	+'<input type="hidden" id="attachmentDoc_hid'+seq+'" name="attachmentDoc_hid'+seq+'" class="form-control">'
								+' <label id="file_upld'+seq+'" name="file_upld'+seq+'" value= " ">No File Uploded</label>' 
							 	+'<span class="errorClass" id="attachmentDoc_file_lbl'+seq+'"></span> '
								...
								+'	<td class="td_width sty">'
							    +' <label id="file_upld_dbtn'+seq+'" name="file_upld_dbtn'+seq+'" value= " ">No File Uploded</label>' 
 								+'<ul class="buttons-group mainbtn action custom-d-none" id="dbtn'+seq+'">'
								+' <li><a class="main-btn dark-btn-outline btn-hover btn-sm"  id="downloadbtn'+a+'" title="Downlaod"><i class="lni lni-download pdfdown"></i></a><input type="hidden" '
								+' id="file_id" value="${item.file_id}"></li> '
								+' </ul>  '
								+'</td>'
...
//			 				 	+'onclick="download_file_view('+att+');" id="downloadbtnview' +att+ '" title="Downlaod">'
						...
						+'  </tr> </tbody><input type="hidden" id="oldattachmenttsss_hid'+R+'" name="oldattachmenttsss_hid'+R+'" value=2 class="form-control" autocomplete="off" /><input type="hidden" id="Newattachmenttsss_hid'+R+'" name="Newattachmenttsss_hid'+R+'" value="0"  class="form-control" autocomplete="off" /></table>'
						+'<input type="hidden" id="count_hidden_att_doc'+R+'" name="count_hidden_att_doc'+R+'" value=2 class="form-control autocomplete">');
			 
			downloadView(R,a,seq)
			download(a);
		}
...
// 				----05/01/2022 CSP
				...
				document.getElementById('id_add_attNameMed1').onclick = function() {
					formOpenNameMed(1);
// 					onclick="formOpenNameMed(1);"
				};

				document.getElementById('btn-close-pdf').onclick = function() {
					return hide_PDF();
				};
...
function download(a){
	document.getElementById('downloadbtn'+a).onclick = function () {
		download_file(a);
// 		onclick="download_file('+a+');"
	};
 
}

function downloadView(R,a,seq){ 

	document.getElementById('downloadbtn'+seq).onclick = function () {
		download_file_view2(R,a);
	};
// 	onclick="download_file_view2('+R+' , '+a+');" 
}

function fnPay_btn() {
	 var a = $("#p_id").val();
	$.post("paymentStatusUrl?"+key+"="+value, {a:a,status:"1"}).done(function(j) {
