          ...
          <div class="row align-items-center">
            <div class="col-md-6">
              <div class="title mb-30">
                <h2>PROVISION CERTIFICATE SEARCH DETAILS FOR INTERN</h2>
              </div>
            </div>
            <!-- end col -->
            <div class="col-md-6">
              <div class="breadcrumb-wrapper mb-30">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="#0">Intern Forms</a></li>
                    <li class="breadcrumb-item active" aria-current="page">
                    PROVISION CERTIFICATE SEARCH DETAILS FOR INTERN
                    </li>
                  </ol>
                </nav>
              </div>
          ...
          <div class="row">
           <div class="col-lg-12">
              ...
              <div class="card-style mb-30">
                <h6 class="mb-25">NCH SEARCH FOR INTERN </h6>
               <div class="row">
...
<!--                  /////////Pending -->
               ...
               <div class="select-style-1">
                 ...
                 <select name="per_state" id="per_state" class="form-control customselect">
         ...
         <div class="col-lg-4 col-md-6 col-sm-12" style="display: block;">
               <div class="select-style-1">
                  <label>Registration State<strong class="mandatory"> </strong></label>	<div class="select-position">
                    <select name="registration_state" id="registration_state" class="form-control customselect">
						 <option value="0">--Select--</option>
							 <c:forEach var="item" items="${MedStateName}" varStatus="num">
					 	<option value="${item[0]}" name="${item[1]}">${item[1]}</option>
							 </c:forEach>
 ...
 -->
          <div class="col-lg-4 col-md-6 col-sm-12">
               <div class="select-style-1">
                  ...
                  <li>
                    <a href="Search_NCH_pracUrl" class="main-btn dark-btn n btn-hover btn-clear" value="Reset">Reset</a>
                  </li>
                  <li>
                    <input type="button" class="main-btn success-btn  btn-hover"  id="apprvbt" style="display: none"  value="Approve">
                  </li>
                  <li>
                    <input type="button" class="main-btn danger-btn btn-hover" id="rejbt"  style="display: none" value="Revert Back">
                  </li>
                </ul>
              </div>
              <!-- end card -->
...
// 		};
		document.getElementById('per_state').onkeypress = function() {
			getDistrictper();
		};
...
// 		 var type_status = $("#type_status").val(); 
		...
		$.post("getFilter_NCH_Intern_data?" + key + "=" + value, {
			startPage : startPage,
...
// 			}
			 ...
			 if(institute_status=='0'){
				 ...
				 if( j[i].nrh_en_no == null){
						 $("#apprvchk").show();
 					 $("#checkheaddiv").show();
 					 jsondata.push([ j[i].ser ,j[i].chekboxaction,(ayu_abha ),j[i].state_reg_no,j[i].nrh_en_no,j[i].valid_up_to,j[i].first_name, gender, j[i].img, j[i].father_name,
					 j[i].pre_district, j[i].pre_state, j[i].pre_pincode,  
					 j[i].per_district, j[i].per_state, j[i].per_pincode,
					 j[i].email_id , j[i].dob, j[i].nationality,j[i].reject_remarks,j[i].vd, j[i].vioch
					, j[i].vm1 
		...
		$.post("getTotalNCH_Intern_dataCount?" + key + "=" + value, {
			//nrh_en_no:nrh_en_no,
			first_name:first_name,
			institute_status:institute_status,
			 gender:gender,
	...
	function setApproveStatus(){
		...
		if(a == ""){
			alert("Please Select the Data for Approval"); 
 				...
 				$.post("Approve_NCHregulation_Intern_Data?"+key+"="+value, {a:a,status:"1"}).done(function(j) {
...
//	 			}
		...
		if(tempSt == ""){
			alert("Please Select the Data for Revert Back"); 
				...
				$.post("reject_NCHregulation_Intern_Data?"+key+"="+value, {a:a,status:"2",tempSt:tempSt}).done(function(j) {
...
// 		var r1 = "'"+R+"_"+"'";
	...
	$.post("get_Intern_by_NCHReject_id?" + key + "=" + value, {
		id:idx
		}, function(p) {
				nam = p;
		});
