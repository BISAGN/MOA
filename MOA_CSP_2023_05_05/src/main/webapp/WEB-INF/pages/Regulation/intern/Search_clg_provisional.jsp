...
<section class="dashboard-page search_regulation">
	<div class="container-fluid">
			...
			<div class="row align-items-center">
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="title mb-30">
						<h2>Collage Search For Provisional</h2>
					</div>
				</div>
				<!-- end col -->
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
						...
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">
									Collage Search For Provisional</li>
							</ol>
						</nav>
					</div>
				</div>
		...
		<!-- title-wrapper end -->
		<div class="search-regulation-wrapper form-elements-wrapper">
			<div class="row">
				<div class="col-12 col-sm-12 col-md-12 col-lg-12">
					...
					<div class="card-style mb-30">
						<div class="custom-field-block">
							<h6 class="mb-25">Collage Search For Provisional</h6>
							<div class="row">
								...
								<div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12">
										<ul class="buttons-group mainbtn">
											...
											<li><a href="edu_search_pro_clg_reg_url"
...
<!-- //janki -->
<c:url value="provisional_Clg_previewUrl"
	var="provisional_Clg_previewUrl" />
<form:form action="${provisional_Clg_previewUrl}" method="post"
...
<script nonce="${cspNonce}" type="text/javascript">
	...
	$(document).ready(function() {
 		...
 		datepicketDate('dob');;
		 $("#inst_id").val('${institute_id}'); // institute id == univercity id
...
// 		};
  ...
  document.querySelectorAll('.pract_hos').forEach((items, index) => {
	...
	function data(Search_regulation_Master) {
		...
		$.post("getFilter_Edu_clg_provisional_data?" + key + "=" + value, {
			startPage : startPage,
...
// 				 }
		...
		$.post("getTotalclg_provisional_dataCount?" + key + "=" + value, {
			//nrh_en_no:nrh_en_no,
				Search : Search,
			first_name:first_name,
			institute_status:institute_status,
