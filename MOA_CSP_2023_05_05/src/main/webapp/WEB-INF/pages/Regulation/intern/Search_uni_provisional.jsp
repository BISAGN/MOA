	...
	<div class="container-fluid">
						...
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">
									University Search For Provisional</li>
							</ol>
						</nav>
					</div>
				</div>
		...
		<div class=" form-elements-wrapper search-regulation-wrapper">
								...
								<div class="col-lg-12 col-md-12 col-sm-12">
									...
									<ul class="buttons-group mainbtn">
										...
										<li id="rejbt" class="custom-d-none"><input type="button"
											class="main-btn danger-btn btn-hover btnreject" value="Revert Back">
										</li>
			...
			<div class="modal fade custom-modal bd-example-modal-lg"
				tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"custom-d-none
...
<!-- //janki -->
<c:url value="provisional_University_previewUrl"
	var="provisional_University_previewUrl" />
<form:form action="${provisional_University_previewUrl}" method="post"
