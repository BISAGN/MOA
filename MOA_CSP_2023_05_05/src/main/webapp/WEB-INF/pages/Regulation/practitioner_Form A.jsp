		...
		<div class="form-elements-wrapper">
			<div class="row">
				...
				<div class="col-lg-12 col-md-12 col-sm-12">
					<form:form action="Practitioner_Action" id="uploadForm"
						method="POST" class="form-horizontal"
						modelAttribute="PractitionerCMD" enctype="multipart/form-data">
									...
									<div id="panelsStayOpen-collapseOne"
										...
										<div class="accordion-body">
											...
											<ul class="custom-uniqueid">
												...
												<li id="nrDiv"><p class="custom-id custom-success-badge">
														<span class="custom-id-title">NR No:</span><span
															class="custom-id-value" id="nrh" name="nrh"></span>
													</p></li>
												...
												<li id = "ayDiv"><p class="custom-id custom-active-badge">
														<span class="custom-id-title">Ayush ID:</span><span
															class="custom-id-value" id="ayu" name="ayu"></span>
													</p></li>
											</ul>
											...
											<div class="row">
												...
												<div class="col-lg-4 col-sm-12">
													<div class="input-style-1">
														<label>Full Name <strong class="mandatory">*
											 ...
											 <div class="col-lg-4 col-md-6 col-sm-12">
													...
													<div class="custom-choose-one">
														...
														<c:forEach var="item" items="${getgenderList}"
																			varStatus="num">
																			<div class="form-check radio-style">
																<input type="radio" id="${item[1]}" name="gender"
																	class="form-check-input" value="${item[0]}" required /> <label
																	for="${item[1]}" class="form-check-label">${item[1]}</label>
															</div>
																		</c:forEach>
														</div>
													</div>
												...
												<div class="col-lg-4 col-sm-12">
													<div class="input-style-1">
														<label>Aadhaar Number <strong class="mandatory">*
															...
															maxlength="14" minlength="12" class="form-control"
															autocomplete="off" placeholder="Aadhaar Number">
													</div>
												</div>
												...
												<div class="col-lg-4 col-sm-12">
													<div class="input-style-1">
														<label>Mobile Number<strong class="mandatory">*
															...
															readonly="readonly" maxlength="10" minlength="10"
												...
												<div class="col-lg-4 col-md-6 col-sm-12">
													<div class="input-style-1">
														<label>Upload Photograph <strong class="mandatory">*
														</strong>
														</label> <input type="file" accept="image/*" id="photo_path"
															name="photo_path" class="form-control">
														<div class="note-text">
<!-- 															<span class="errorClass" id="img_up">Image Not -->
<!-- 																Uploaded </span> -->
														</div>
														<!-- 														---21-02-2023 -->
														<!-- 				 <label >  <strong id = "img_up" class="errorClass"> Image Not Uploaded </strong> </label>  -->

														<input type="hidden" id="upload_img_hid"
															name="upload_img_hid" class="form-control"> <input
															type="hidden" id="upload_img_forV" name="upload_img_forV"
												...
												<div class="col-lg-4 col-sm-12">
													<div class="select-style-1">
														...
														<div class="input-style-1">
															<input type="text" id="nat" name="nat" maxlength="10"
																class="form-control" autocomplete="off" value="INDIAN"
																readonly="readonly">
														</div>
												...
												<div class="col-lg-4 col-sm-12">
													<div class="input-style-1">
														<label>Alternative Mobile Number 1</label> <input
															type="text" id="alt_mo_no1" name="alt_mo_no1"
															maxlength="10" minlength="10" class="form-control mb2"
															autocomplete="off"
															placeholder="Alternate Mobile Number 1">
													</div>
												</div>
												...
												<div class="col-lg-4 col-sm-12">
													<div class="input-style-1">
														<label>Alternative Email ID 1 </label> <input type="email"
															id="alt_email_id1" name="alt_email_id1" maxlength="50"
															class="form-control mb2" autocomplete="off"
															pattern="^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$" 
															placeholder="Alternate Email Id 1">
													</div>
												...
												<div class="col-lg-4 col-sm-12">
													<div class="input-style-1">
														<label>Alternative Email ID 2 </label> <input type="email"
															id="alt_email_id2" name="alt_email_id2" maxlength="50"
															pattern="^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$"
															class="form-control mb2" autocomplete="off"
															placeholder="Alternate Email Id 2">
													</div>
												</div>
												<input type="hidden" id="state_reg_no_hid"
													name="state_reg_no_hid" value="0" class="form-control"
													autocomplete="off" />
												<div class="col-lg-4 col-sm-12" id="reg_div">
													<div class="select-style-1">
														<label>Registration State <strong
									...
									<div id="panelsStayOpen-collapseTwo"
										...
										<div class="accordion-body">
											<div class="row">
												...
												<div class="col-lg-12 col-sm-12">
													<div class="select-style-1">
														<label> Permanent Address <strong
															class="mandatory">* </strong></label>
													</div>
												</div>
												<div class="col-lg-4  col-sm-12">
												...
												<div class="input-style-1 input-sm">
													<label>Pincode<span class="mandatory">*</span></label> <input
														type="text" id="per_pincode" name="per_pincode"
											...
											<div class="col-lg-12 col-sm-12">
												...
												<div class="row">
													...
													<div class="input-style-1 input-sm">
														<label>Pincode<span class="mandatory">*</span></label> <input
															type="text" id="pre_pincode" name="pre_pincode"
															maxlength="6" minlength="6" placeholder="Pincode">
													</div>
													</div>
													<!-- 														<div class="col-lg-4 col-sm-12"> -->
											...
											<div class="col-lg-12 col-sm-12">
															...
															<div class="row">
																	...
																	<div class="input-style-form-check">
																		<div class="form-check radio-style">
																			<input type="radio" class="form-check-input"
																				id="check_address1" name="check_address"> <label
																...
																<div class="col-lg-4 col-md-4 col-sm-12">
																	<div class="input-style-form-check">
																		<div class="form-check radio-style">
																			<input type="radio" class="form-check-input"
																				id="check_address2" name="check_address"> <label
																...
																<div class="col-lg-4 col-md-4 col-sm-12">
																	<div class="input-style-form-check">
																		<div class="form-check radio-style">
																			<input type="radio" class="form-check-input"
																				id="check_address3" name="check_address"
																				checked="checked"> <label
																				class="form-check-label" for="check_address3">Other</label>
																		</div>
																	</div>
																</div>
																<div class="col-lg-12 col-md-12 col-sm-12">
												...
												<div class="row">
													<div class="col-lg-12 col-sm-12">
														<div class="select-style-1">
															<label> Corresponding Address <strong
																class="mandatory">* </strong></label>
														</div>
													</div>
													<div class="col-lg-4 col-sm-12">
													...
													<div class="col-lg-4 col-sm-12">
														<div class="input-style-1">
															<input type="text" id="curr_address2"
																name="curr_address2" maxlength="100"
													...
													<div class="col-lg-4 col-sm-12">
														<div class="input-style-1">
															<input type="text" id="curr_address3"
																name="curr_address3" maxlength="100"
																class="form-control autocomplete" autocomplete="off"
													...
													<div class="input-style-1 input-sm">
														<label>Pincode<span class="mandatory">*</span></label> <input
															type="text" id="curr_pincode" name="curr_pincode"
															maxlength="6" minlength="6" placeholder="Pincode">
													</div>
													</div>
													<!-- 														<div class="col-lg-4 col-sm-12"> -->
								...
								<div class="accordion-item accordion-itemstyle">
									<h2 class="accordion-header" id="panelsStayOpen-headingThree">
										<button
											...
											medical degree graduate / postgraduate</button>
									</h2>
															...
															<div class="table-wrapper table-responsive custom-table">
																<table class="table" id="addNameOfMed">
																	<thead>
																		<tr>
																			<th>Sr No</th>
																			<th>Type of degree<strong class="mandatory">*
																			</strong></th>
																			<th>Degree name<strong class="mandatory">*
																			</strong></th>
																			<th>Month and Year<strong class="mandatory">*
																			</strong></th>
																			<th>Name of institute / board<strong
																				class="mandatory">* </strong></th>
																			<th>Attachment<strong class="mandatory">*
																			</strong></th>
																			<th>Action</th>
																		</tr>
																		<!-- end table row-->
																	...
																	<tbody id="att_TbbodyNameMed">
																		<tr id="tr_id_attNameMed">
																					...
																					<div class="select-position">
																						<select name="typeOfDegree1" id="typeOfDegree1"
																							...
																							<c:forEach var="item" items="${TypeOfDegree}"
																								begin="0" end="0" varStatus="num">
																								<option value="${item.id}"
																									name="${item.type_of_degree}">${item.type_of_degree}</option>
																							</c:forEach>
																						</select> <input type="hidden" id="degree_hid1"
																							name="degree_hid1" value="0" class="form-control"
																							autocomplete="off" />
																					</div>
																				</div>
																			</td>
																				...
																				<div class="select-style-1">
																					<div class="select-position">
																						<select name="DegreeName1" id="DegreeName1"
																							class="form-control autocomplete">
																							<option value="0">--Select--</option>
																						</select> <input type="hidden" id="DegreeName1_hid"
																							name="DegreeName1_hid" value="0"
																							class="form-control" autocomplete="off" />
																					</div>
																				</div>
																			</td>
																			...
																			<td class="min-width">
																				<div class="input-style-2">
																					<input type="month" id="monthYearOfDegree1"
																						name="monthYearOfDegree1" max="${Todaydate}"
																						class="form-control-sm form-control effect-9 hasDatepicker" />
																					<input type="hidden" id="monthYearOfDegree1_hid"
																						name="monthYearOfDegree1_hid" value=""
																						class="form-control" autocomplete="off" />
																				</div>
																			</td>
																			<!-- 																			<td class="min-width"> -->
																			...
																			<!-- 																		main-btn success-btn btn-hover btn-sm btnaddmore				name="NameOfUniversity1" value="" class="form-control autocomplete"  -->
																			...
																			<td class="min-width">
																				<div class="select-style-1">
																					<div class="select-position">
																						...
																						</select> <input type="hidden" id="NameOfUniversity1_hid"
																							name="NameOfUniversity1_hid" value="0"
																							class="form-control" autocomplete="off" />
																					</div>
																				</div>
																			</td>
																			<td class="min-width">
																				<div>
																					<input type="button" id="btnmodel1"
																						class="main-btn secondary-btn btn-hover btn-sm"
																						value="Attachment"> <input type="hidden"
																						id="med_degree_att_old1"
																						name="med_degree_att_old1"
																						class="form-control autocomplete"> <input
																						type="hidden" id="med_degree_att_new1"
																						name="med_degree_att_new1"
																						class="form-control autocomplete">
																				</div>
																			</td>
													...
													<div class="col-lg-12 col-md-12 col-sm-12">
														<div class="table-wrapper table-responsive custom-table">
															<table class="table" id="addHospital">
																<thead>
																	<tr>
																		...
																		<th>Name of responsible owner<strong
																			class="mandatory"></strong></th>
																...
																<tbody id="att_TbbodyNameMed">
																	<tr id="tr_id_attNameMed">
																		...
																		<td class="min-width">
																			<div class="select-style-1">
																				<div class="select-position">
																					...
																					</select> <input type="hidden" id="working_hid1"
																						name="working_hid1" value="0" class="form-control"
																						autocomplete="off" />
																				</div>
																			</div>
																		</td>
																		<td class="min-width">
																			<div class="input-style-1">
																				<input type="text" class="form-control autocomplete"
																					...
																					name="place_of_working_name1" maxlength="50"
																					class="form-control autocomplete"
																		...
																		<td class="min-width">
																			<div class="input-style-1">
																				<input type="text" class="form-control autocomplete"
																					id="adjunct_place1" name="adjunct_place1"
																					maxlength="50" class="form-control autocomplete"
																					placeholder="Adjunct Place" />
																			</div>
																		</td>
																		<td class="min-width">
																			<div class="input-style-1">
																				<input type="text" class="form-control autocomplete"
																					id="landline1" maxlength="10" minlength="10"
																					name="landline1" placeholder="Landline No" />
																			</div>
																		</td>
																		<td class="min-width">
																			<div class="input-style-1">
																				<input type="text" class="form-control autocomplete"
																					id="mobileHosp1" name="mobileHosp1" maxlength="10"
																					minlength="10" placeholder="Mobile No" />
																			</div>
																		</td>
																		...
																		<td class="min-width">
																			<div class="select-style-1">
																				<div class="select-position">
																					<select name="authority_type1" id="authority_type1"
																						class="form-control autocomplete">
																						<option value="0">--Select--</option>
																					...
																					</select> <input type="hidden" id="authority_type1_hid"
																						name="authority_type1_hid" value="0"
																						class="form-control" autocomplete="off" />
																				</div>
																			</div>
																		</td>
															...
															<input type="hidden" id="count_hidden_att_name_med"
																name="count_hidden_att_name_med"
																class="form-control autocomplete" value="1"> <input
																type="hidden" id="count_hidden_for_new"
																name="count_hidden_for_new"
																class="form-control autocomplete" value=""> <input
																type="hidden" id="count_hidden_for_old"
																name="count_hidden_for_old"
																class="form-control autocomplete" value=""> <input
																type="hidden" id="admmisson_dt_neet_hidden"
																name="admmisson_dt_neet_hidden"
							...
							<!-- 								<input class="form-input" type="checkbox" id="terms" -->
							<!-- 									name="terms"> <span class="text-heighlight"> I -->
							<!-- 									attest that all of the details, including any attachments, are -->
							<!-- 									true and accurate.</span> -->
							<!-- 							</div> -->

							<div class="custom-choose-one custom-d-none" id="chek_confirm">
								<div class="input-style-form-check_block check-multi-list">
									<div class="form-check checkbox-style">
										<input class="form-check-input" type="checkbox" id="terms"
											name="terms"> <label class="check-list">I
											attest that all of the details, including any attachments,
											are true and accurate. </label>
									</div>
								</div>
							</div>
							<!-- <-- Bottom Button Start -->
								...
								<div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12">
										<ul class="buttons-group mainbtn">
											<li id="draft"><input type="button"
												class="main-btn success-btn  btn-hover btn-save"
												value="Save as Draft"></li>
											<li id="final_submit" class="custom-d-none"><input
												type="submit"
												class="main-btn secondary-btn btn-hover btnsave"
												value="Final Submit" name="final_submit"></li>
											<li id="update" class="custom-d-none"><input
												type="button" class="main-btn deactive-btn btn-hover "
												value="Update"></li>


											<li id="renew" class="custom-d-none"><input
												type="button"
												class=" main-btn secondary-btn btn-hover btnsave "
												value="Revision"></li>
											<li id="preview"><a href="pract_previewUrl"><input
													type="button"
						...
						<input type="hidden" id="count_hidden_att_His"
							...
							value="1">
						<input type="hidden" id="nrh_hid" name="nrh_hid"
							class="form-control autocomplete" value="">
						...
						<div class="modal fade custom-modal bd-example-modal-lg"
							...
							<div class="modal-dialog modal-xl modal-dialog-scrollable">
								<div class="modal-content">
													...
													<div class="row">
														<div class="col-lg-12 col-md-12 col-sm-12">
															<div class="inst_block">
																...
																<ul class="inst_list">
																	<li><p class="inst_text">Documents to be
																			Uploaded : Aadhar Card,Leaving Certificate/Date Of
																			Birth Certificate, Neet Marksheet,First Year Marksheet,Second Year
																			Marksheet, Third Year Marksheet,Fourth Year
																			Marksheet,Provisional Degree Certificate, Degree
																			Certificate</p></li>
																	<li><p class="inst_text">Maximum file size
																			upto 200 kb and Allowed only *.pdf File.</p></li>
																...
																<div id="zoom_controls" class="pdf_zoom_control">
																	...
																	<div class="zoom_btn">
																		<button type="button" class="btn btn-sm pdfbtnzoom"
																			value="">
																			<i id="zoom_in" class="lni lni-zoom-in"
																				title='Zoom in'></i>
																		</button>
																	</div>
																	<br />
																	<div class="zoom_btn">
																		<button type="button" class="btn btn-sm pdfbtnzoom"
																			value="">
																			<i id="zoom_out" class="lni lni-zoom-out"
																				title='Zoom out'></i>
																		</button>
																	</div>
																</div>
															...
															<div class="footer_btn">
																<div class="footer_btn_control">
																	<i id="go_previous"
																		...
																		class="pdfbtnzoom-current-page" value="1"
									...
									<div class="modal fade custom-modal custom-modal-pdf"
										...
										<div
											...
											<div class="modal-content">
												...
												<div class="modal-body">
													...
													<div class="custom-modal-inner" id="headData1"
														name="headData1">
														<div class="row">
															<div class="col-lg-12 col-md-12 col-sm-12 col-12">
									...
									<input type="hidden" id="attachmenttsss_hid1"
										name="attachmenttsss_hid1" value="0" class="form-control"
										autocomplete="off" />
								</div>
							</div>
						</div>
...
//		--23-02-2023 URMIK
 		var stateNo = k[0]["statenum"];
 		var regState=k[0]["reg_state"];
//  		---22-02-2022  fsdfsd
 		var admission_date_practitionner = k[0]["fire2"];
 		$("#state_reg_no_hid").val(stateNo);
 		$("#admmisson_dt_neet_hidden").val(admission_date_practitionner);
//  		alert(admission_date_practitionner);
...
//  		--23-02-2023
 		if(stateNo!= null && stateNo.trim()!=" "){ 
 			$("select#reg_state").val(regState);
 			$("#reg_state").attr("readonly","readonly");
 		 }
...
// 				 +'	<input type="hidden" value="0" id="btopen_close'+att+'"> '
				 +'	<select name="typeOfDegree'+att+'" id="typeOfDegree'+att+'" class="form-control autocomplete" >  <option value="0">--Select--</option> <c:forEach var="item" items="${TypeOfDegree}" begin = "1"  varStatus="num">	<option value="${item.id}" name="${item.type_of_degree}">${item.type_of_degree}</option> </c:forEach></select></select></div></div></td>'
 				 	...
 				 	+'<td class="min-width"><div class="input-style-2"><input type="month" id="monthYearOfDegree'+att+'" name="monthYearOfDegree'+att+'" class="form-control-sm form-control effect-9 hasDatepicker" max="${Todaydate}">  </div</td>'
 				 	+'<td class="min-width">'
 				 	+'<div class="select-style-1">'
 				 	+'<div class="select-position">'
					...
					+'</div>'
					+'</td>'
 				 	+'<td class="min-width"><div><input type="button" id="btnmodel'+att+'" name="btnmodel'+att+'" class="main-btn secondary-btn btn-hover btn-sm" value="Attachment"></div>'
...
// 		$("#count_hidden_att_doc"+att).val(att);
		 ...
		 $("#addHospital").show();
			 ...
			 if(att < 51){
				 ...
				 $("table#addHospital").append('<tr align="center" id="tr_id_attHospital'+att+'"><td>'+att+'</td>'
					...
					+'</div></div></td>'
				 	+'<td class="min-width"><div class="input-style-1"><input type="text" class="form-control autocomplete" placeholder="Name Of Place" maxlength="50"  class="" id="place_of_working_name'+att+'"	name="place_of_working_name'+att+'" /></div></td>'
				 	+'<td class="min-width"><div class="input-style-1"><input type="text" class="form-control autocomplete" placeholder="Adjunct Place" maxlength="50"  class="" id="adjunct_place'+att+'"	name="adjunct_place'+att+'" /></div></td>'
				 	+'<td class="min-width"><div class="input-style-1"><input type="text" class="form-control autocomplete"   placeholder="Landline No" maxlength="10" minlength="10" id="landline'+att+'" name="landline'+att+'" /></div></td>' /* <input type="text" class="form-control autocomplete"  placeholder="Landline No" style="width: 90%" id="landline'+att+'" name="landline'+att+'" /> </td>' */
				 	+'<td class="min-width"><div class="input-style-1"><input type="text" class="form-control autocomplete" id="mobileHosp'+att+'" name="mobileHosp'+att+'" placeholder="Mobile No" maxlength="10" minlength="10"/></div></td>'
				 	+'<td class="min-width"><div class="input-style-1"><input type="text" class="form-control autocomplete" placeholder="Email Id" maxlength="50" id="email'+att+'" name="email'+att+'"></div></td>'
				 	+'<td class="min-width"><div class="input-style-1"><input type="text" id="hos_address1_'+att+'" name="hos_address1_'+att+'" maxlength="100" class="form-control autocomplete mb2" autocomplete="off" placeholder="Address Line 1"><input type="text" id="hos_address2_'+att+'"	name="hos_address2_'+att+'" maxlength="100" class="form-control autocomplete mb2" autocomplete="off"	placeholder="Address Line 2"><input type="text" id="hos_address3_'+att+'"	 name="hos_address3_'+att+'" maxlength="100" class="form-control autocomplete mb2" autocomplete="off"	placeholder="Address Line 3" ></div></td>'
				 	...
				 	+'<td class="min-width"><div class="input-style-1"><input  class="form-control autocomplete"  placeholder="Responsible Owner" maxlength="50" type="text" id="name_of_res_p'+att+'"  name="name_of_res_p'+att+'" /></div></td>' 
	...
	var mandatoryDocList = ["Aadhar Card",
		"Leaving Certificate/Date Of Birth Certificate",
...
// 	}
	...
	function Validate() {
	if( parseInt($("#admmisson_dt_neet_hidden").val().substring(0, 4))>= 2019){
		mandatoryDocList = ["Aadhar Card",
			"Leaving Certificate/Date Of Birth Certificate",
			"Neet Marksheet",
			"First Year Marksheet",
			"Second Year Marksheet",
...
// 		mandatoryDocList.push("Neet Marksheet")
	}
		/* personal details */
...
// 		---21-02-2023
		...
		if ( $("#photo_path").val().trim() == "" &&  $("#upload_img_hid").val().trim() == "") {
			alert("Please Select Photo");
			$("input#photo_path").focus();
			return false;
		}
...
// 			if( parseInt($("#admmisson_dt_neet_hidden").val())>= 2019){
// 				var neet_count=0;
// 			for(a1 = 3; a1 <= $('#count_hidden_att_doc1').val(); a1++){
// 				debugger;
				
// 			 	if($("#NameOfAttachmenthid1"+"_"+a1).val() == "Neet Marksheet"){
// 			 		neet_count++;
// 			 		if($("#attachmentDoc_hid1"+"_"+a1).val() == ""){
// 			 			alert("Neet Certificate Is Required "+a1+" Row");
// 						$("#NameOfAttachmenthid1"+"_"+a1).focus();
// 						return false;
// 			 		}
// 				}
// 		}
// 			if(neet_count==0)
// 				{alert("Neet Certificate Is Required ");
// 				return false;
// 				}
// 		}
// 		-----subchilde
   	for(a1 = 1; a1 <= $('#count_hidden_att_doc'+exp).val(); a1++){
	 	if($("#NameOfAttachment"+exp+"_"+a1).val() == "0"   ){
					alert("Please Select Name of Attachment In Row "+a1+" of degree "+$("#DegreeName"+exp+" option:selected").text());
					$("#NameOfAttachment"+exp+"_"+a1).focus();
					return false;
			}
			if($("#attachmentDocument"+exp+"_"+a1).val().trim()=='' && $("#attachmentDoc_hid"+exp+"_"+a1).val().trim()==''){
						alert("Please Select Attachment File "+$("#NameOfAttachment"+exp+"_"+a1+" :selected").text()+" In Row "+a1+" of degree "+$("#DegreeName"+exp+" option:selected").text());
						$("#name_of_degree"+exp+"_"+a1).focus();
						return false;
			}
		 }
		var selectedDocList = [];
   		$('.attach-doc-class'+exp).each(function(i, obj) {
	   		var ind = i+1;
	   		selectedDocList[i]=$("#"+obj.id+" :selected").text();
		 });
   		if (exp>1) {
   			mandatoryDocList = ["Degree Certificate"]
		}
   		for (var d = 0; d < mandatoryDocList.length; d++) {debugger
   			var getLocDoc = $.inArray( mandatoryDocList[d], selectedDocList );
			if (getLocDoc == -1) {
				alert("Please Add Attachment "+mandatoryDocList[d]+" of "+$("#DegreeName"+exp+" option:selected").text());
				return false;
			}
		}
...
// 		02-03-2023
		 var image = document.getElementById("photo_path");
		    if (typeof (image.files) != "undefined") {
		        var size = parseFloat(image.files[0].size / (50 * 50)).toFixed(50); 
		        if(size > 50) {
...
// 					+'<input type="text" mexlength="30" id="NameOfAttachment'+seq+'" name="NameOfAttachment'+seq+'" value="" class="form-control autocomplete"  autocomplete="off"  placeholder="Name of Attachment">'
                    //janki yash
					 ...
					 +'	<select name="NameOfAttachment'+seq+'" id="NameOfAttachment'+seq+'" class="form-control autocomplete attach-doc-class'+R+'" >  '
					 +' <option value="0">--Select--</option> 	'
// 					 -- //		--Practitionner Dynamic Doc LIst URMIK
 					 +'<c:forEach var="item" items="${getattachmentNameForOnlyPractitionner}" varStatus="num"> <option value="${item[0]}" name="${item[1]}">${item[1]}</option> </c:forEach>'
 					 
//  					 +' <option value="Leaving Certificate/Date Of Birth Certificate" name="Leaving Certificate/Date Of Birth Certificate"> Leaving Certificate/Date Of Birth Certificate</option>  '
// //  					 +' <option value="Date Of Birth Certificate" name="Provisional Registration Certificate">Date Of Birth Certificate</option>  '
//  					 +' <option value="Neet Marksheet" name="Neet Marksheet">Neet Marksheet</option>  '
// //  					 +' <option value="Profession Marksheets" name="Profession Marksheets">Profession Marksheets</option>  '
//  					 +' <option value="First Year Marksheet" name="First Year Marksheet"> First Year Marksheet</option>  '
//  					 +' <option value="Second Year Marksheet" name="Second Year Marksheet"> Second Year Marksheet</option>  '
//  					 +' <option value="Third Year Marksheet" name="Third Year Marksheet"> Third Year Marksheet</option>  '
//  					 +' <option value="Fourth Year Marksheet" name="Fourth Year Marksheet"> Fourth Year Marksheet</option>  '
...
// 					 +' <option value="Degree Certificate" name="Provisional Degree Certificate">Degree Certificate</option>  '
					 +'</select>'
					 +'</div>'
					 +' </div>'
					 +' </td>' 
					 
					+'<td class=""><div class="input-style-1 regupractaddmoretd">'
...
// 					+' <label id="file_upld'+seq+'" name="file_upld'+seq+'" value= " ">No File Uploded</label>' 
				 	+'<div class="note-text"><span class="errorClass" id="attachmentDoc_file_lbl'+seq+'"></span> '
				 	+'<span class="tikClass" id="attachmentDoc_file_lbltik'+seq+'"></div></div>'
				 	+'</td>' 
...
// 	  				+'<input type="text" id="file_id1" name="file_id1"></li></ul>'
	  				...
	  				+'<li><a class="main-btn info-btn btn-hover btn-sm btndownload addminusbut"  '
...
// 		alert(R+"-"+index);
		...
		var attachmentNameselect = '	<select name="NameOfAttachment'+seq+'" id="NameOfAttachment'+seq+'" class="form-control autocomplete attach-doc-class'+R+'" >  '
		 +' <option value="0">--Select--</option> 	'
//			--Practitionner Dynamic Doc LIst URMIK
+'<c:forEach var="item" items="${getattachmentNameForOnlyPractitionner}" varStatus="num"> <option value="${item[0]}" name="${item[1]}">${item[1]}</option> </c:forEach>'
// 		 +' <option value="Aadhar Card" name="Aadhar Card">Aadhar Card</option>  '
// 			 +' <option value="Driving Licence" name="Driving Licence">Driving Licence</option>  '
// 		 +' <option value="Leaving Certificate/Date Of Birth Certificate" name="Leaving Certificate/Date Of Birth Certificate"> Leaving Certificate/Date Of Birth Certificate</option>  '
// //			 +' <option value="Date Of Birth Certificate" name="Provisional Registration Certificate">Date Of Birth Certificate</option>  '
// 			 +' <option value="Neet Marksheet" name="Neet Marksheet">Neet Marksheet</option>  '
// // 			 +' <option value="Profession Marksheets" name="Profession Marksheets">Profession Marksheets</option>  '
...
// 		 +' <option value="Degree Certificate" name="Provisional Degree Certificate">Degree Certificate</option>  '
		 ...
		 var addbt = ' <ul class="buttons-group mainbtn daobtn">'
				...
				+' </ul>';
		 if (parseInt(R)>1) {
			 attachmentNameselect = '	<select name="NameOfAttachment'+seq+'" id="NameOfAttachment'+seq+'" class="form-control autocomplete attach-doc-class'+R+'" >  '
			 +' <option value="0">--Select--</option> 	'
...
// 		 		document.getElementById('photo_path').onchange = function(){
// // 		 			photoValidate();
// 		 			return imgFileSizeValidation(this,this.value,'upload_img_hid','50kb','upload_photo_doc_lbl');
// 		 		};
// 		 		--comment 26-04-2023
		 		document.getElementById('photo_path').onchange = function() {
// 		 			photoValidate();
...
// 		 		};
				...
				document.getElementById('per_address').onkeypress = function() {
					return onlyAlphaNumeric(event,this);
				};
		 		
				document.getElementById('per_address').onkeyup= function() {
				...
				document.getElementById('per_address2').onkeypress = function() {
					return onlyAlphaNumeric(event,this);
				};
				
				document.getElementById('per_address2').onkeyup= function() {
					return isAlphaNumeric_SpecialsWithSpace(this);
				};
				...
				document.getElementById('per_address3').onkeypress = function() {
					return onlyAlphaNumeric(event,this);
				};
				
				document.getElementById('per_address3').onkeyup= function() {
					return isAlphaNumeric_SpecialsWithSpace(this);
				};
				...
				document.getElementById('pre_address').onkeypress = function() {
					return onlyAlphaNumeric(event,this);
				};
				document.getElementById('pre_address').onkeyup= function() {
					return isAlphaNumeric_SpecialsWithSpace(this);
				};
				document.getElementById('pre_address2').onkeypress = function() {
					return onlyAlphaNumeric(event,this);
				};
				document.getElementById('pre_address2').onkeyup= function() {
					return isAlphaNumeric_SpecialsWithSpace(this);
				};
				document.getElementById('pre_address3').onkeypress = function() {
					return onlyAlphaNumeric(event,this);
				};
				document.getElementById('pre_address3').onkeyup= function() {
					return isAlphaNumeric_SpecialsWithSpace(this);
				};
...
// 				--23-02-2023
				...
				document.getElementById('curr_address').onkeypress = function() {
					return onlyAlphaNumeric(event,this);
				};
				document.getElementById('curr_address').onkeyup= function() {
					return isAlphaNumeric_SpecialsWithSpace(this);
				};
				document.getElementById('curr_address2').onkeypress = function() {
					return onlyAlphaNumeric(event,this);
				};
				document.getElementById('curr_address2').onkeyup= function() {
					return isAlphaNumeric_SpecialsWithSpace(this);
				};
				document.getElementById('curr_address3').onkeypress = function() {
					return onlyAlphaNumeric(event,this);
				};
				document.getElementById('curr_address3').onkeyup= function() {
					return isAlphaNumeric_SpecialsWithSpace(this);
				};
...
function myKeyPress(e){
    ...
    if( keynum==62 || keynum==60 || keynum==64 || keynum==34 || keynum==35 || keynum==36 || keynum==37 || keynum==43 || keynum==47 || keynum==91 || keynum==92 || keynum==93 || keynum==94 || keynum==188 )
        e.preventDefault();
  }
//   --14-03-2022
window.onload = () => {
	 const myInput = document.getElementById('place_of_working_name1');
	 myInput.onpaste = e => e.preventDefault();
	 const myInput1 = document.getElementById('adjunct_place1');
