...
<!-- 														---21-02-2023 -->
				 <label  id = "img_up">  <strong   class="errorClass"> Image Not Uploaded </strong> </label> 
																				...
																				<div class="select-style-1">
																					...
																					<div class="select-position">
																						<select name="typeOfDegree1" id="typeOfDegree1"
																							...
																							<option value="0">--Select--</option>
																							<c:forEach var="item" items="${TypeOfDegree}"  begin = "0" end = "0"
																								varStatus="num">
												...
												<div class="row">
													<div class="col-lg-12">
														<div class="table-wrapper table-responsive custom-table">
														  ...
														  <input type="hidden" id="admmisson_dt_neet_hidden" name="admmisson_dt_neet_hidden" class="form-control autocomplete" value="">
...
<!-- 							</div> -->
							...
							<div class="custom-choose-one custom-d-none" id="chek_confirm">
								<div class="input-style-form-check_block check-multi-list">
									...
									name="terms">
										 <label class="check-list">I
									attest that all of the details, including any attachments, are
									true and accurate. </label> 
									</div>
								</div>
							</div>
							<ul class="buttons-group mainbtn">
								<li  id="draft"><input type="button"
									...
									<li  id="final_submit" class="custom-d-none"><input type="submit"
									class="main-btn secondary-btn btn-hover btnsave"
									value="Final Submit" name="final_submit"></li>
								<li id="update" class="custom-d-none"><input type="button"
									class="main-btn deactive-btn btn-hover "
								value="Update"></li>
								
								
								<li  id="renew" class="custom-d-none"><input type="button"
									class=" main-btn secondary-btn btn-hover btnsave "
									value="Revision"></li>
								<li id="preview"><a href="pract_previewUrl"><input type="button"
															...
															<div class="inst_block">
																...
																<ul class="inst_list">
																	<li><p class="inst_text">Documents to be
																			Uploaded : Aadhar Card,Leaving Certificate/Date Of Birth Certificate,
																			Neet Marksheet,Profession Marksheets,First Year Marksheet,Second Year Marksheet,
																			Third Year Marksheet,Fourth Year Marksheet,Provisional Degree Certificate,
																			Degree Certificate
																			 </p></li>
	...
	<!-- end container -->
</section><!-- regulation components end -->
   	...
   	for(a1 = 1; a1 <= $('#count_hidden_att_doc'+exp).val(); a1++){
	 	if($("#NameOfAttachment"+exp+"_"+a1).val() == "0"   ){
			...
			if($("#attachmentDocument"+exp+"_"+a1).val().trim()=='' && $("#attachmentDoc_hid"+exp+"_"+a1).val().trim()==''){
						alert("Please Select Attachment File "+$("#NameOfAttachment"+exp+"_"+a1).val()+" In Row "+a1+" of degree "+$("#DegreeName"+exp+" option:selected").text());
...
//  					 +' <option value="Date Of Birth Certificate" name="Provisional Registration Certificate">Date Of Birth Certificate</option>  '
					...
					+'<td class="min-width"><div class="input-style-1 regupractaddmoretd">'
...
function myKeyPress(e){
    ...
    if(keynum==62 || keynum==60 || keynum==64 || keynum==34 || keynum==35 || keynum==36 || keynum==37 || keynum==43 || keynum==47 || keynum==91 || keynum==92 || keynum==93 || keynum==94)
        e.preventDefault();
  }
	</script>
