		...
		<div class="form-elements-wrapper">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<!-- input style start -->
					<form:form name="EditEnhance_Research_Category_Mstr" id="EditEnhance_Research_Category_Mstr"
						action="EditEnhance_Research_Category_MstrAction" method='POST'
						modelAttribute="EditEnhance_Research_Category_MstrCMD" enctype="multipart/form-data">
...
<script nonce="${cspNonce}" type="text/javascript">
	$(document).ready(function() {
		$('#id').val('${Enhance_Research_Mstr.id}');
		$('#category_name').val('${Enhance_Research_Mstr.category_name}');
		$('select#status').val('${Enhance_Research_Mstr.status}');
