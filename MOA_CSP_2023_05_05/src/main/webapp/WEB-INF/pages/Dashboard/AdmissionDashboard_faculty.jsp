				...
				<div class="col-12 col-sm-12 col-md-12 col-lg-12">
					<div class="card-style mb-30">
						...
						<c:if test="${getSystemList.size() != 0}">
							...
							<div class="row">
							<h5 class="text-medium mb-10">Admission Details</h5>
...
<div class="row">
				<div class="col-12 col-sm-12 col-md-12 col-lg-12">
					<div class="card-style mb-30">
						<div class="custom-field-block">
						<h5 class="text-medium mb-10">Faculty Details</h5>
							<div class="row">
								<div class="col-lg-3 col-md-6 col-sm-12 col-12">
									<div class="icon-card primary-shade bg-shape">
										...
										<div class="content">
											<h4 class="counter-title">No. of Colleges </h4>
											<h3 class="counter-count" id="count11">
											</h3>
<!-- 											<p class="counter-subcount"> -->
<!-- 												<span id="dcc1" name="dcc1" class="subcount-block"> <span id="arrow4" name="arrow4"></span> -->
<!-- 													<span class="subcount"><b id="count7"></b>%</span>Current -->
...
<!-- 											</p> -->
								...
								<!-- End Col -->
								<div class="col-lg-3 col-md-6 col-sm-12 col-12">
									<div class="icon-card pink-shade bg-shape">
										<div class="icon">
											<i class="lni lni-blackboard"></i>
										</div>
										<div class="content">
											<h4 class="counter-title">College Register Faculty</h4>
											<h3 class="counter-count" id="count12">
												<!-- <span id="count2" class="display-4" class="h3 font-bold mb-0"></span> -->
											</h3>
...
<!-- 											</p> -->
								...
								<div class="col-lg-3 col-md-6 col-sm-12 col-12">
									<div class="icon-card success-shade bg-shape">
										...
										<div class="content">
											<h4 class="counter-title">Total Faculty Register</h4>
											<h3 class="counter-count" id="count13">
												<!-- <span id="count2" class="display-4" class="h3 font-bold mb-0"></span> -->
											</h3>
...
<!-- 											</p> -->
								...
								<div class="col-lg-3 col-md-6 col-sm-12 col-12">
									<div class="icon-card orange-shade bg-shape">
										...
										<div class="content">
											<h4 class="counter-title">Total Teacher Code Generator</h4>
											<h3 class="counter-count" id="count14">
												<!-- <span id="count3" class="display-4"
													class="h3 font-bold mb-0"></span> -->
											</h3>
<!-- 											<p class="counter-subcount"> -->
...
//								 counter("count6", Math.round(lasttotalp), 1); //AVRAGE TOTAL DOWN
			...
			$.post('getDashBoardDataMainReload_Faculty?' + key + "=" + value,{val : ''},function(data) {
				 $("#count11").text(data[0].no_clg);
				 $("#count12").text(data[0].fac_reg);
				 $("#count13").text(data[0].final_submitted);
				 $("#count14").text(data[0].tech_code);

// 				counter("count11", 0, data[0].no_clg, 1000);
// 				counter("count12", 0, data[0].fac_reg, 1000);
// 				counter("count13", 0, data[0].final_submitted, 1000);
// 				counter("count14", 0, data[0].tech_code, 1000);
// 				 $('.counter-count').each(function () {
// 					    $(this).prop('Counter',0).animate({
// 					        Counter: $(this).text()
// 					    }, {
