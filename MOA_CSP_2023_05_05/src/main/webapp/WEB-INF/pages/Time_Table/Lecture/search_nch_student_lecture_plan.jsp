			...
			<div class="row align-items-center">
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="title mb-30">
						<h2>
							<span id="lbladd">Search Nch Student Lesson Plan</span>
						</h2>
					</div>
				</div>
				<!-- end col -->
					...
					<div class="breadcrumb-wrapper mb-30">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Search Nch
		...
		<div class="form-elements-wrapper">
			<div class="row">
				<div class="col-12 col-sm-12 col-md-12 col-lg-12">
					...
					<form:form name="nchlecturer_plan" id="nchlecturer_plan" method="post"
...
<!-- 											<th id="5"><h6>Sub-Topic</h6></th> -->
											<th id="6"><h6>Learning Outcme</h6></th>
...
<c:url value="edit_nch_student_lecture_planUrl"
	var="edit_nch_student_lecture_planUrl" />
<form:form action="${edit_nch_student_lecture_planUrl}" method="post"
	id="updateForm" name="updateForm" modelAttribute="sdate1">
	<input type="hidden" name="sdate1" id="sdate1" value="0" />
</form:form>

<c:url value="delete_Nch_Student_LectureUrl" var="delete_Nch_Student_LectureUrl" />
<form:form action="${delete_Nch_Student_LectureUrl}" method="post"
...
// 			sub_topic : sub_topic,
			...
			for (var i = 0; i < j.length; i++) {
				jsondata.push([ j[i].sr_no, j[i].professional,j[i].start_time,j[i].end_time,
					j[i].course_name, j[i].faculty, j[i].topic,j[i].learning_outcome, 
...
function getTopic(){
	...
	$.post("getNchTopic_name1?" + key + "=" + value, {
...
function getFacultyDtl(){
	...
	$.post("getNchfacutlydetails1?" + key + "=" + value, {
		course_id : course_id
}, function(j) {
...
//		var degree_id = $("#degree").val();
	...
	$.post("getNchCourseList_for_Curri?" + key + "=" + value, {
