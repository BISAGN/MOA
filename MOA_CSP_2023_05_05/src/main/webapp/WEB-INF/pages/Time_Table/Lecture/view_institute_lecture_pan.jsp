			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					...
					<form:form name="lecturer" id="lecturer" action="Lecturer_Action"
						method="post" class="form-horizontal" modelAttribute="LecturerCMD">
								...
								<div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12">
										<ul class="buttons-group mainbtn">
											...
											<li><a href="View_Institute_Lecture_PlanUrl"
...
// 	var faculty = $("#faculty").val();
	...
	$.post("getFilter_LecturerIns_data?" + key + "=" + value, {
		startPage : startPage,
...
// 	j[i].faculty,
	$.post("getTotal_LecturerIns_dataCount?" + key + "=" + value, {
		Search : Search,
		course_name : course_name,
		topic : topic,
		professional : professional,
