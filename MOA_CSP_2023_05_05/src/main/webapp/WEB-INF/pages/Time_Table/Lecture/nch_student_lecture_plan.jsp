...
<section class="dashboard-page">
	<div class="container-fluid">
			...
			<div class="row align-items-center">
				<div class="col-lg-6 col-md-6 col-sm-12 col-12">
					<div class="title mb-30">
						<h2>
							<span id="lbladd">Nch Student Lecture Plan</span>
						</h2>
					</div>
				</div>
				<!-- end col -->
					...
					<div class="breadcrumb-wrapper mb-30">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Nch Student
									Lecture Plan</li>
							</ol>
						</nav>
					</div>
		...
		<div class="form-elements-wrapper">
			<form:form name="lecturerNch_plan" id="lecturerNch_plan" method="post"
				modelAttribute="Nch_Student_LecturerCMD">
				<div class="row">
										...
										<table class="table" id="family_table" class="custom-d-none">
											<thead>
												<tr>
													...
													<th><h6>Subject</h6></th>
													<th><h6>Faculty</h6></th>
													<th><h6>Topic<span class="mandatory">*</span></h6></th>
													<th><h6>Learning Outcome<span class="mandatory">*</span></h6></th>
													<th><h6>Instructional Method<span class="mandatory">*</span></h6></th>
													<th class="hide-action"><h6>Attended<span class="mandatory">*</span></h6></th>
												</tr>
											</thead>
											...
											<div class="col-lg-12 col-md-12 col-sm-12 col-12">
												<ul class="buttons-group mainbtn">
													...
													<li><input id="btn-save"
														...
														value="Save" /></li>
													<li><a href="Nch_Student_Lecturer_PlanUrl"
...
<script nonce="${cspNonce}" type="text/javascript">
	...
	function student() {
		...
		// 	alert(course_name);
		var sdate = $("#sdate").val();
		var form = $("#lecturerNch_plan").serialize();
		$.post("getNchStudent_Details?" + key + "=" + value, form, function(j) {
		...
		$.post("getFilter_Nch_Student_Lecturer_data?" + key + "=" + value, {
			...
			for (var i = 0; i < j.length; i++) {
				jsondata.push([ j[i].sr_no, j[i].professional, j[i].start_time,
						...
						j[i].topic_id, j[i].learning_outcome,
...
// 		var sub_topic = $("#sub_topic").val();
		...
		$
				.post(
						'getNchLecturedetailsbyDate?' + key + "=" + value,
						{
							ldate : ldate,
							course : course,
							faculty : faculty,
								...
								$("table#family_table")
										.append(
												'<tr id="tr_id_att'+att+'"><td><p>'
														...
														+ '<td><div class="select-style-1"><div class="select-position"><select name="topic_id'+att+'" id="topic_id'+att+'" class="singleselect form-control form-control-lg" ><option value="0"---Select---></option></select></div></div></td>'
// 														+ '<td><div class="select-style-1"><div class="select-position"><select name="sub_topic'+att+'" id="sub_topic'+att+'" class="singleselect form-control form-control-lg" ><option value="0">---Select---</option></select></div></div></td>'
														...
														+ '<td><div class="select-style-1"><div class="select-position"><select name="learning_outcome'+att+'" id="learning_outcome'+att+'" class="singleselect form-control form-control-lg" ><option value="0">---Select---</option></select></div></div></td>'
