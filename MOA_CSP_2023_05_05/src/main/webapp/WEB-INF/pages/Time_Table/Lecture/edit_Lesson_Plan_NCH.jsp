		...
		<div class="form-elements-wrapper">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<!-- input style start -->
					<form:form name="lecturernch_edit" id="lecturernch_edit"
						action="LecturerNch_Edit_Action" method="post"
						 modelAttribute="LecturerNch_Edit_CMD">
						<div class="card-style mb-30">
							<div class="custom-field-block">
								<h6 class="mb-25">Update Nch Lesson Plan</h6>
								<div class="row">
...
// });
	$(document).ready(function() {
		...
		$('select#topic_id').val('${lecture_Details.topic_id}');
		$('#topic_id').trigger('change');
		Nchgetlearn_outListby_Topic()
		$('select#learning_outcome').val('${lecture_Details.learning_outcome}');
