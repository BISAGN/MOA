					...
					<div class="breadcrumb-wrapper mb-30">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">View Nch Lesson Plan</li>
							</ol>
						</nav>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					...
					<form:form name="lecturer_nch" id="lecturer_nch" action="Lecturer_Nch_Action"
						method="post" modelAttribute="LecturerNchCMD">
...
function data(search_plan) {
	...
	$.post("getFilter_Lecturer_Nch_data?" + key + "=" + value, {
		startPage : startPage,
	...
	$.post("getTotal_Lecturer_Nch_dataCount?" + key + "=" + value, {
		Search : Search,
		course_name : course_name,
		topic_id : topic_id,
		professional : professional,
...
function Search() {
	...
	$("select#course_name").val($('select#course_name').val());
	$("select#topic_id").val($('select#topic_id').val());
	$("select#learning_outcome").val($('#learning_outcome').val());
	$("#lecture_hours").val($('#lecture_hours').val());
	$("#non_lecture_hours").val($('#non_lecture_hours').val());
	$("select#instructional_method").val($('#instructional_method').val());
	...
	$("select#assessment_method").val($('select#assessment_method').val());
...
function getL_N_Hours() {
	...
	$.post("getL_N_Hours_Nch?" + key + "=" + value, {
