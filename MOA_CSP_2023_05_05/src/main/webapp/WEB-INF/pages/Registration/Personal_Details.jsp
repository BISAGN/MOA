										...
										<div class="row">
												...
												<div class="select-style-1">
													...
													<div class="form-group stepform-groupadd">
														<div class="select-position">
															<select id="cand_prifix" name="cand_prifix"
																class="form-control">
														...
														<div class="input-style-1 form-group buttonmergeinput m-0">
											...
											<div class="col-lg-4 col-md-6 col-sm-12">
												<div class="input-style-1">
													<label>Middle Name<span class="mandatory"></span>
													</label> <input type="text" id="pers_middel_name"
														name="pers_middel_name" placeholder="Enter Middle Name"
														maxlength="50" autocomplete="off">
												</div>
											</div>
											<div class="col-lg-4 col-md-6 col-sm-12">
											...
											<div class="col-lg-4 col-md-6 col-sm-12">
												<div class="input-style-1">
													<label>Father's Name <span class="mandatory">*</span></strong></label>
													<div class="form-group stepform-groupadd">
														<div class="input-style-1 form-group buttonmergeinput m-0">
															<input type="text" id="pers_father_name"
																name="pers_father_name" class="form-control"
																maxlength="50" placeholder="Enter Father's Name"
																autocomplete="off">
														</div>
													</div>
												</div>
													...
													<div class="form-group stepform-groupadd">
														<div class="input-style-1 form-group buttonmergeinput m-0">
															<input type="text" id="pers_mother_name"
																...
																maxlength="50" placeholder="Enter Mother's Name"
																autocomplete="off">
														</div>
													</div>
												</div>
											...
											<div class="col-lg-4 col-md-6 col-sm-12">
												<div class="input-style-2">
													...
													<input type="text" name="pers_date_of_birth"
														...
														autocomplete="off" value="DD/MM/YYYY" /> <input
														type="hidden" id="yrr" name="yrr" value="">
												</div>
											</div>
										...
										<div class="row">
											...
											<div class="col-lg-4 col-md-4 col-sm-12">
												<div class="input-style-1">
													<label for="text-input">Tehsil<span
														class="mandatory">*</span>
													</label> <input type="text" id="pers_present_tehsil"
														name="pers_present_tehsil" maxlength="50"
											...
											<div class="col-lg-4 col-md-4 col-sm-12">
												<div class="input-style-1">
													<label for="text-input">Police Station<span
														class="mandatory">*</span>
													</label> <input type="text" id="pers_present_policestation"
										...
										<div class="row">
											...
											<div class="col-lg-4 col-md-4 col-sm-12">
												<div class="input-style-1">
													<label for="text-input">Tehsil<span
														class="mandatory">*</span>
													</label> <input type="text" id="corre_tehsil" name="corre_tehsil"
														maxlength="50" autocomplete="off"
														placeholder="Enter Tehsil">
												</div>
											</div>
...
$(document).ready(function() {
	 ...
	 $("#personal_details").on("keypress", function (event) {
...
// 	quota and councelling
	...
	$("#pers_permanent_house_no").val('${pddata[0][15]}');
	$("#pers_permanent_village").val('${pddata[0][16]}');
	$("#pers_permanent_postoffice").val('${pddata[0][17]}');
	$("#pers_permanent_tehsil").val('${pddata[0][18]}');
	$("#pers_permanent_policestation").val('${pddata[0][19]}');
...
// 	alert('${pddata[0][21]}');
	...
	$("#pers_permanent_district").val('${pddata[0][21]}');
	
	$('#pers_permanent_district').change(); 
	$("#pers_permanent_pincode").val('${pddata[0][22]}');
	$("#pers_permanent_lendmark").val('${pddata[0][23]}');
...
function get_p_id_pers_info() {
	...
	debugger;
	$.post('get_ayush_id_ctrl?' + key + "=" + value,{userid : userid},function(j) {
		if (j.length > 0) {
			if (j[0][0] != null && j[0][0]!="") {
				$("#ayush_id").html(j[0][0]);
...
function getbesicinfo() {
	...
	var value = "${_csrf.token}";
	var userid =  "${userid}";
	$.post('getBesicdetails_ctrl?' + key + "=" + value,{userid : userid},function(j) {
...
function saveData(){
	  ...
	  if( $("#cand_prifix").val() == "0" ){
		...
		if( $("#pers_date_of_birth").val() == "" ||  $("#pers_date_of_birth").val() == "DD/MM/YYYY"){
...
// 			} 
	    ...
	    var pin_pre =$("#pers_present_pincode").val().trim();
		 if (pin_pre == "") {
				alert("Please Enter the Present Pincode");
				$("#pers_present_pincode").focus();
				return false;
...
// 		}
	...
	if($("#e_id").val() == 0){
		return true;
			...
			var pers_permanent_postoffice =  $("#pers_permanent_postoffice").val();
			var pers_permanent_tehsil =  $("#pers_permanent_tehsil").val();
			var pers_permanent_policestation =  $("#pers_permanent_policestation").val();
			...
			var pers_present_policestation =  $("#pers_present_policestation").val();
			...
			$.post('getUpdatePerDetails?' + key + "=" + value,{e_id : e_id,pers_name : pers_name,pers_father_name : pers_father_name,pers_mother_name : pers_mother_name,pers_date_of_birth : pers_date_of_birth,pers_gender : pers_gender,pers_mob_no : pers_mob_no,
				pers_email : pers_email,pers_category : pers_category,pers_religion : pers_religion,pers_marital_status : pers_marital_status,pers_nationality : pers_nationality,state_id : state_id,district_id : district_id,village : village,pers_aadhar_no1 : pers_aadhar_no1,pers_aadhar_no2:pers_aadhar_no2,pers_aadhar_no3:pers_aadhar_no3,
				quota_id : quota_id,counselling_authority : counselling_authority,pers_permanent_house_no : pers_permanent_house_no,
				pers_permanent_village : pers_permanent_village,pers_permanent_postoffice : pers_permanent_postoffice,pers_permanent_tehsil : pers_permanent_tehsil,pers_permanent_policestation : pers_permanent_policestation,pers_permanent_district : pers_permanent_district,pers_permanent_state : pers_permanent_state,
				pers_permanent_pincode : pers_permanent_pincode,pers_permanent_lendmark : pers_permanent_lendmark,pers_present_house_no : pers_present_house_no,pers_present_village : pers_present_village,pers_present_postoffice : pers_present_postoffice,pers_present_tehsil : pers_present_tehsil,
				pers_present_policestation : pers_present_policestation,pers_present_district : pers_present_district,pers_present_state : pers_present_state,pers_present_pincode : pers_present_pincode,pers_present_lendmark : pers_present_lendmark,cand_prifix : cand_prifix,pers_father_title : pers_father_title,pers_mother_title : pers_mother_title,
				neet_rank:neet_rank,neet_marks:neet_marks,neet_percentile:neet_percentile,pers_middel_name:pers_middel_name,pers_surname:pers_surname,yrr:yrr,neet_roll_no:neet_roll_no,neet_application_no:neet_application_no,
				corre_house_no:corre_house_no,corre_village:corre_village,corre_postoffice:corre_postoffice,corre_tehsil:corre_tehsil,corre_policestation:corre_policestation,corre_district:corre_district,corre_state:corre_state,corre_pincode:corre_pincode,corre_lendmark:corre_lendmark
			},function(j) {
				...
				}).fail(function(xhr, textStatus, errorThrown) {alert("fail to Update Data")
				});
	}
}
...
function copy_address() {
	...
	if($("#check_address").is(":checked") == true){
		$("#pers_present_house_no").val($("#pers_permanent_house_no").val());
		$("#pers_present_house_no").attr('readonly',true);
		$("#pers_present_village").val($("#pers_permanent_village").val());
		$("#pers_present_village").attr('readonly',true);
		$("#pers_present_postoffice").val($("#pers_permanent_postoffice").val());
		$("#pers_present_postoffice").attr('readonly',true);
		$("#pers_present_tehsil").val($("#pers_permanent_tehsil").val());
		$("#pers_present_tehsil").attr('readonly',true);
		$("#pers_present_policestation").val($("#pers_permanent_policestation").val());
		$("#pers_present_policestation").attr('readonly',true);
		$("#pers_present_state").val($("#pers_permanent_state").val());
		$("#pers_present_state").trigger('change');
		$("#pers_present_state").attr('readonly',true);
	//	$('#pers_present_state').change(); 
		getpresDistrict();
		$("#pers_present_state").attr('tabindex','-1');		
		$("#pers_present_district").val($("#pers_permanent_district").val());
		$("#pers_present_district").attr('readonly',true);
		$("#pers_present_district").attr('tabindex','-1');		
		$('#pers_present_district').change(); 
		$("#pers_present_pincode").val($("#pers_permanent_pincode").val());
		$("#pers_present_pincode").attr('readonly',true);
		$("#pers_present_lendmark").val($("#pers_permanent_lendmark").val());
		$("#pers_present_lendmark").attr('readonly',true);
	}
...
function copy_permanent_address() {
	...
	if($("#check_address1").is(":checked") == true){
		...
		$("#corre_policestation").val($("#pers_permanent_policestation").val());
		$("#corre_policestation").attr('readonly',true);
...
function copy_present_address() {
	...
	if($("#check_address2").is(":checked") == true){
		...
		$("#corre_tehsil").attr('readonly',true);
		$("#corre_policestation").val($("#pers_present_policestation").val());
		$("#corre_policestation").attr('readonly',true);
...
// 			if(confirm('Are you sure you want to Proceed?')){return saveData(); }else{return false;}
	...
	document.getElementById('pers_date_of_birth').onchange = function() {
		  clickrecall(this,'DD/MM/YYYY');validateDate_FutureDate(this.value,this); 
