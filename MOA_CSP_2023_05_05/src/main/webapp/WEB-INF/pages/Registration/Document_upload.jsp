			...
			<div class="row">
				<div class="col-lg-12 col-sm-12">
					...
					<form:form name="doc_upload" id="doc_upload"
						action="Doc_Upload_Action?${_csrf.parameterName}=${_csrf.token}"
						method='POST' commandName="doc_uploadCMD"
						...
						<div class="card-style mb-30 uploaddoc">
									...
									<div class="col-12 col-sm-12 col-md-6 col-lg-3">
										<div class="input-style-1">
											<label for="text-input">Photo<strong
												...
												accept="image/*" id="photograph" name="photographimg"
												class="form-control"> <input type="hidden"
												id="photograph_hid" name="photograph_hid" value="0">
											<div class="note-text">
									...
									<div class="col-12 col-sm-12 col-md-6 col-lg-3">
										<div class="input-style-1">
											<label for="text-input">Signature<strong
												...
												id="signature_hid" name="signature_hid" class="form-control"
												value="0">
											<div class="note-text">
							...
							<section class="detail-block">
								...
								<div class="row custom-d-none" id="div_co">
									<div class="col-12 col-sm-12 col-md-6 col-lg-3">
										<div class="input-style-1">
											...
											<div class="d-flex">
												...
												<ul
													...
													<li><a href="#" type="button"
														class="main-btn dark-btn btn-hover btn-sm view_uploadDraftdoc">
									...
									<%-- <div class="col-lg-12 col-md-12 col-sm-12 col-12">
										<div id="my_pdf_viewer" class="custom-pdf-viewer custom-d-none">
											...
											<div class="footer_btn">
												<div class="footer_btn_control">
													<i id="go_previous"
														...
														class="pdfbtnzoom-current-page" readonly="readonly" value="1" type="number" />
												</div>
							...
							<section class="detail-block">
								<div class="row">
									...
									<input type="hidden" id="count_hidden" name="count_hidden"
										...
										class="form-control autocomplete" value="1"> <input
										type="hidden" id="forupdate_hidden" name="forupdate_hidden"
										class="form-control autocomplete" value="0"> <input
										type="hidden" id="old_count_hidden" name="old_count_hidden"
										class="form-control autocomplete" value="0"> <input
										type="hidden" id="new_count_hidden" name="new_count_hidden"
										class="form-control autocomplete" value="0"> <input
										type="hidden" id="del_id_hidden" name="del_id_hidden"
										class="form-control autocomplete" value="0"> <input
										type="hidden" id="late_admission_status"
...
<c:url value="getDownloadPdfUrlfor_Doc" var="downloadUrl" />
...
<c:url value="Std_pers_details_Url" var="appUrl" />
...
// 		return false;
	...
	$("#addunitserved").show();
		 ...
		 if(att < 51){
				 ...
				 $("table#addunitserved").append('<tr id="tr_id_att'+att+'"><td>'+att+'</td>'
...
function get_p_id_pers_info() {
	...
	$.post('get_uploded_imgthumb_ctrl?' + key + "=" + value,{p_id : id},function(j) {
		if (j.length > 0) {
...
function data(search_doc_details_table) {
	...
	$.post("getFilterDoc_data?" + key + "=" + value, {
		startPage : startPage,
	...
	$.post("getTotalDoc_dataCount?" + key + "=" + value, {Search:Search}, function(j) {
		FilteredRecords = j;
	});
...
function isValidateClientSide(){
	...
	var las = $('#late_admission_status').val();
	
	if (parseInt(las) > 0 ) {
		var court_order_hid = $('#court_order_hid').val();
		var court_order = $('#court_order').val();
		if((court_order_hid == '0' || court_order_hid == "") && (court_order == "")){
			alert("Please Upload Court Order");
			 $('#court_order').focus();
			return false
		}
	}
...
// 	for(at = 1; at <= $('#count_hidden_att').val(); at++){
	...
	document.getElementById('upload_document1').onchange = function() {
		...
		if (this.accept == "") {
			alert("Please Select Document Type In Row 1");
			$("#doc_type1").focus();
