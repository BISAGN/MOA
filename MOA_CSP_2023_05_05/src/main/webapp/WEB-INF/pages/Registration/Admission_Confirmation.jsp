								...
								<div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12">
										<ul class="buttons-group mainbtn">
											...
											<li><a href="Admission_Confirmation_Url"
											...
											<li id="rejbt"><input type="button"
												...
												value="Not-Present" name="rejbt"></li>
								...
								<table class="table" id="ScreenReport">
									...
									<tbody>
										<c:if test="${list.size()==0}">
											<tr>
												<td colspan="6"><p class="no-data">No Data
														Available</p></td>
...
<c:url value="getSearch_StatusVise" var="getSearch_StatusVise" />
<form:form action="${getSearch_StatusVise}" method="post"
