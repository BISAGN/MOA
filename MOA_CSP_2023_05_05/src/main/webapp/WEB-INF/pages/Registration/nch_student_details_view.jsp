					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-12">				
						...
						<div class="field-box">
							...
							<div class="row">
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-12">
									<span class="value-bind t no-data d-none" id="no_neet_data"
										></span>
								</div>
								<div class="col-lg-12 col-md-12 col-sm-12 col-12">
									<div class="table-wrapper table-responsive simple-table" id="neettable">
										<table class="table">
											<thead>
												<tr>
													<th><h6>Roll No</h6></th>
							...
							<div class="row">
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-12">
									<span class="value-bind no-data d-none" id="no_edu_data"
										></span>
								</div>
								<div class="col-lg-12 col-md-12 col-sm-12 col-12">
									<div class="table-wrapper table-responsive custom-table" id="edutable">
										<table class="table">
											<thead>
												<tr>
													<th><h6>Ser No</h6></th>
							...
							<div class="row">
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-12">
									<span class="value-bind no-data d-none" id="no_uploaded_doc"
										></span>
								</div>
								<div class="col-lg-12 col-md-12 col-sm-12 col-12">
									<div class="table-wrapper table-responsive custom-table" id="table_uploaded_doc">
										<table class="table">
											<thead>
												<tr>
													<th><h6>Ser No</h6></th>
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-12">							
								...
								<div class="inst_block simple-instruction d-none">
								 <span class="concat-string" id="co_remarks" > 
								</span>
							</div>
															
							<div class="col-lg-12 col-md-12 col-sm-12 col-12">
										<div class="full-data-value">
											<label>Check court order here : </label> 
                                             <span id="draft_pdf"></span>
										</div>										
									</div>									
							</div>							
							</div>
							...
							<div class="row">
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-12">
									<span class="value-bind no-data d-none" id="no_adm_data"
										></span>
								</div>
								<div class="col-lg-12 col-md-12 col-sm-12 col-12">
									<div class="table-wrapper table-responsive simple-table" id="table_adm">
										<table class="table">
											<thead>
												<tr>
...
// 		$('div#table_adm').empty();
// 		document.getElementById("no_neet_data").style. = "block";
// 						if ($("#no_neet_data").hasClass("d-none")) {
// 					 $( "#no_neet_data").removeClass("d-none");
...
if (id != "") {
	 ...
	 getuploaded_doc(id);
	 $("#p_id").val(id);
		var signaturephoto="ViewRefImageFileDownload5?kmlId="+id+"&kmlfildname=signature";
	 	$("img#upload_signature_doc_preview").attr('src',signaturephoto);
	 	
		var photographphoto="ViewRefImageFileDownload5?kmlId="+id+"&kmlfildname=photograph";
...
// 	  list.getElementsByTagName("img")[0].removeAttribute("style");
	
	var iframe = document.getElementById("embedpdf");
...
//    var iframe = document.getElementById("myFrame");
   ...
   var elmnt1 = iframe.contentWindow.document.getElementsByTagName("body")[0];
   elmnt1.removeAttribute("style");

   var elmnt2 = iframe.contentWindow.document.getElementsByTagName("img")[0];
...
// 	 $('#embedpdf').contents().find('style').remove();
}
...
function getadmDetails() {
	...
	$.post('get_ayush_id_bypid_ctrl?' + key + "=" + value,{pid : pid},function(j) {
...
// 			document.getElementById("no_adm_data").style. = "block";
...
function getuploaded_doc(p_id){
	$.post("getuploaded_doc_NCH_Ctrl?" + key + "=" + value, {
		p_id:p_id
	}, function(j) {
		strdata ="";
		if (j.length > 0) {
...
// 			document.getElementById("no_uploaded_doc").style. = "block";
	...
	$.post("getuploaded_Court_Order_NCH_Ctrl?" + key + "=" + value, {
		p_id:p_id
	}, function(j) {
...
// 		var loadingTask = pdfjsLib.getDocument(path1);
...
// 		    var scale = 1.5;
// 		    var viewport = page.getViewport({scale: scale,zoom: zoom});
