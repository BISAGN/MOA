					...
					<div class="head-top-left">
						<div class="head-top-logo">
							<a href="https://india.gov.in" title="Government of India"
								target="blank" class="logo-subtext"> 
						...
						<div class="custom-search">
							<div class="search-box">
								<button type="button"
									class="detail-button detail-button-iconic sm-btn hvr-icon-pulse-shrink searchicon"
					...
					<div class="head-top-right">
						<div class="head-top-link">
							<ul class="d-flex link-list">
								<li><a href="ncismscreenreaderaccess"> Screen Reader
										Access </a></li>
						...
						<div id="google_translate_element" class="custom-lang"
							title="Change Language"></div>
						<div class="dropdown custom-lang2">
							<button class="btn btn-secondary dropdown-toggle" type="button"
								id="dropdownMenuButton1" data-bs-toggle="dropdown"
								aria-expanded="false">Language</button>
							<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
								<li><a class="dropdown-item" href="ncismlandinghindi">हिन्दी</a></li>
								<li><a class="dropdown-item" href="ncismlandingpage">English</a></li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="header-inner">
					<div class="logo-main">
						<a href="https://main.ayush.gov.in/" target="_blank"
							title="Ministry of Ayush"> <img
							data-src="admin/assets/img/ayushlogo.png" class="img-fluid lazy"
							alt="Ministry of Ayush">
						</a> <a href="landingpage" title="Go to Home" class="logo-subtext">
							<img alt="Ayush Grid" data-src="admin/assets/img/ayushgridleaf.png"
							class="moa-logo lazy">Ayush Grid
						</a>
...
<!-- 											class="dropdown-item" href="usermanualncism">User Manual</a> -->
<!-- 									</div></li> -->
								...
								<li class="nav-item dropdown"><a
									class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
									role="button" data-bs-toggle="dropdown" aria-haspopup="true"
									aria-expanded="false">Courses</a> <!-- 									<div class="dropdown-menu"> -->
									<%-- 										<c:set var="sys" value="" /> --%> <%-- 										<c:forEach var="item" items="${degreelist}" varStatus="num"> --%>
									<%-- 											<c:if test="${item[0] != sys}"> --%> <%-- 												<c:set var="sys" value="${item[0]}" /> --%>
									<%-- 												<a class="dropdown-item menu-title" href="#">${item[0]}</a> --%>
									<%-- 											</c:if> --%> <%-- 											<c:if test="${item[0] == sys}"> --%>
									<%-- 												<a class="dropdown-item" href="portalsignin">${item[2]}</a> --%>
									<%-- 											</c:if> --%> <%-- 										</c:forEach> --%> <!-- 									</div> -->
									<div class="dropdown-menu">
										<a class="dropdown-item" href="ayurvedacoursencism">Ayurveda</a>
										<a class="dropdown-item" href="unanicoursencism">Unani</a> <a
											class="dropdown-item" href="siddhacoursencism">Siddha</a> <a
											class="dropdown-item" href="sowacoursencism">Sowa-Rigpa</a>
									</div></li>
								<li class="nav-item"><a class="nav-link"
									href="https://apps.bisag.co.in/BERISM/landingpage">BERISM</a></li>
								<!-- 								<li class="nav-item dropdown"><a -->
								<!-- 									class="nav-link dropdown-toggle" href="#" id="navbarDropdown" -->
								<!-- 									role="button" data-bs-toggle="dropdown" aria-haspopup="true" -->
...
<!-- 									</div></li> -->
								...
								<li class="nav-item"><a class="nav-link"
									href="ncismcontact">Contact</a></li>
								<li class="nav-item"><a class="nav-link"
									href="ncism_usermanual_main">User Guide</a></li>
					...
					<div class="site-logo">
						<ul class="site-logo-inner d-flex">
							<li class="logo-s1"><a href="https://ncismindia.org/"
								target="_blank"
								title="National Commission for Indian System of Medicine"> <img
									data-src="admin/assets/img/ncism_logo.png"
									alt="National Commission for Indian System of Medicine" class="lazy"></a>
							</li>
							<li class="logo-s1 d-none"><a href="landingpage"
								title="Go to Home"><img alt="Ayush Grid"
									data-src="admin/assets/img/ayush-grid.png" class="img-fluid lazy"></a></li>
						</ul>
					</div>
				</div>
			</div>
	...
	<header>
				...
				<div class="head-top d-flex">
					...
					<div class="head-top-right">
						...
						<div class="dropdown custom-lang2">
							...
							<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
								<li><a class="dropdown-item" href="ncismlandinghindi">हिन्दी</a></li>
								<li><a class="dropdown-item" href="ncismlanding">English</a></li>
							</ul>
						</div>
					</div>
				</div>
		...
		<nav
			...
			<div class="container">
				<div class="header-inner">
					<div class="logo-main">
						<a href="landingpagehindi"><img
							data-src="admin/assets/img/grid-logo.png" class="img-fluid lazy"></a> <a
							href="https://main.ayush.gov.in/" target="_blank"
							title="Ministry of Ayush" class="logo-subtext"> <img
							alt="Ministry of Ayush" data-src="admin/assets/img/emblem.png"
							class="moa-logo lazy">Ministry of <span class="org-text">Ayush</span>
						</a>
					</div>
					<button class="navbar-toggler collapsed" type="button"
						data-bs-toggle="collapse" data-bs-target="#navbarDefault"
							...
							<ul class="navbar-nav">
								...
								<li class="nav-item dropdown"><a
									...
									<div class="dropdown-menu">
										...
										<a class="dropdown-item" href="ncismunanihindi">यूनानी</a> <a
											class="dropdown-item" href="ncismsiddhahindi">सिद्ध</a> <a
											class="dropdown-item" href="ncismsowahindi">सोवा-रिग्पा</a> <a
											class="dropdown-item" href="ncismhomoeopathyhindi">होम्योपैथी</a>
									</div></li>
								<li class="nav-item"><a class="nav-link"
								...
								<li class="nav-item"><a class="nav-link"
									href="https://apps.bisag.co.in/BERISM/landingpage">बीईआरआईएसएम</a></li>
								<li class="nav-item dropdown"><a
									class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
									role="button" data-bs-toggle="dropdown" aria-haspopup="true"
								...
								<li class="nav-item"><a class="nav-link"
									href="ncismcontacthindi">संपर्क करें</a></li>
							</ul>
						</div>
					</div>
					<!-- navigation end here -->
					...
					<div class="site-logo">
						<ul class="site-logo-inner d-flex">
							<li class="logo-s1"><a href="#"><img
									data-src="admin/assets/img/ncism_logo.png" class="lazy"></a></li>
						</ul>
					</div>
				</div>
			</div>
