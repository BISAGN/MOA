			...
			<div class="row">
				<div class="col-lg-5 col-md-6 col-sm-12">
					<div class="widget-a">
						...
						<div class="w-body-a">
							<p class="w-text-a">Jawahar Lal Nehru Bhartiya Chikitsa Avam
						...
						<div class="w-footer-a">
							<ul class="list-unstyled">
								<li class="color-a"><span class="color-text-a">Phone
										:</span><a href="tel:1800-11-0180,1964">+ 91-11-2852 5464,2519</a></li>
								<li class="color-a"><span class="color-text-a">Email
										:</span><a href="mailto:secretary@ncismindia.org">secretary@ncismindia.org</a>
								</li>
							</ul>
						</div>
					</div>
					...
					<div class="widget-a">
						...
						<ul class="list-unstyled">
								<!-- <li class="item-list-a"><i class="bi bi-chevron-right"></i>
									<a href="#">Website Policies</a></li>
								<li class="item-list-a"><i class="bi bi-chevron-right"></i>
									<a href="#">Help</a></li> -->
									<li class="item-list-a"><i class="bi bi-chevron-right"></i>
									<a href="ncismannualreport">Annual Report</a></li>
								<li class="item-list-a"><i class="bi bi-chevron-right"></i>
									<a href="ncismcontact">Contact Us</a></li>
								<!-- <li class="item-list-a"><i class="bi bi-chevron-right"></i>
									<a href="#">FAQ</a></li> -->
								<li class="item-list-a"><i class="bi bi-chevron-right"></i>
									<a href="ncismtermsandcondition">Terms and Conditions</a></li>
								<!-- <li class="item-list-a"><i class="bi bi-chevron-right"></i>
									<a href="#">Disclaimer</a></li>
								<li class="item-list-a"><i class="bi bi-chevron-right"></i>
									<a href="#">Sitemap</a></li> -->
									<li class="item-list-a"><i class="bi bi-chevron-right"></i>
									<a href="ncismfeedback">Feedback</a></li>
									<li class="item-list-a"><i class="bi bi-chevron-right"></i>
									<a href="ncismsitemap">Sitemap</a></li> 	
							</ul>							
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<div class="copyright-footer text-center">					
						<!-- <p class="copyright">
							This Website is designed, developed & maintained by <a
								href="https://main.ayush.gov.in/" class="f-link" target="_blank">Ministry of Ayush, Goverment of India</a>
						</p> -->
						<p class="copyright">
					...
					<div class="widget-a">
						...
						<div class="w-body-a">
							<ul class="list-unstyled">
								...
								<li class="item-list-a"><i class="bi bi-chevron-right"></i>
									<a href="ncismcontacthindi"> संपर्क करें</a></li>
							</ul>
						</div>
					</div>
				</div>
