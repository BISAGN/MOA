				...
				<div class="col-md-5 section-md-t3">
					<div class="icon-box section-b2">
						...
						<div class="icon-box-content table-cell">
							...
							<div class="icon-box-content">
								<p class="mb-1">
									Email: <a href="mailto:secy-nch@gov.in" class="color-a">secy-nch@gov.in,
									</a> <a href="mailto:nchindia21@gmail.com" class="color-a">nchindia21@gmail.com</a>
								</p>
								<p class="mb-1">
									Phone: <a href="tel:011-28522906" class="color-a">011-28522906</a>
								</p>
							</div>
						</div>
					</div>
					<div class="icon-box section-b2">
						...
						<div class="icon-box-content table-cell">
							...
							<div class="icon-box-content">
								<p class="mb-1">61-65, Institutional Area, Opp. 'D' Block,
									Janak Puri, New Delhi- 110058</p>
							</div>
						</div>
					</div>
					<div class="icon-box">
							...
							<div class="socials-a">
								<ul class="list-inline">
									<li class="list-inline-item"><a
										...
										class="fb-icon hvr-bounce-in" target="blank"> <i
											class="bi bi-facebook" aria-hidden="true"></i>
									</a></li>
									<li class="list-inline-item"><a
										href="https://twitter.com/moayush"
										class="tw-icon hvr-bounce-in" target="blank"> <i
									...
									<li class="list-inline-item"><a
										href="https://www.youtube.com/channel/UCqRR2gs-I3zrNcE4so4TpgQ"
										class="yt-icon hvr-bounce-in" target="blank"> <i
											class="bi bi-youtube" aria-hidden="true"></i>
									</a></li>
								</ul>
							</div>
						</div>
