        ...
        <div class="row">
          <div class="col-md-12 col-lg-8">
            <div class="title-single-box">
              <h1 class="title-single">Sowa-Rigpa</h1>
            </div>
          </div>
      ...
      <section class="section-about about-img-box-sm">
         <div class="row m-0">
            <div class="col-lg-12 col-md-12 col-sm-12 p-0">
               <div class="about-img-box portal-sowa-bgimg" title="Sowa-Rigpa">             
                  <div class="innerpage-imgbox">
	                  <div class="container">                  
		                  <div class="sinse-box">
		                     <h5 class="sinse-title">The term Sowa-Rigpa is derived from Bhoti language which means 'knowledge of healing'.</h5>		                   
		                  </div>
	                  </div>
                  </div>                  
               </div>
