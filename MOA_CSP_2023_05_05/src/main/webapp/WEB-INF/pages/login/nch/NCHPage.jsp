      ...
      <section class="section-about about-img-box-sm">
         <div class="row m-0">
            <div class="col-lg-12 col-md-12 col-sm-12 p-0">
               <div class="about-img-box portal-nch-bgimg" title="The National Commission for Homoeopathy">                
                  <div class="innerpage-imgbox">
	                  <div class="container">                  
		                  <div class="sinse-box">
		                     <h5 class="sinse-title">The National Commission for Homoeopathy- सर्वे सन्तु निरामयाः</h5>		                   
		                  </div>
	                  </div>
                  </div>                  
               </div>
