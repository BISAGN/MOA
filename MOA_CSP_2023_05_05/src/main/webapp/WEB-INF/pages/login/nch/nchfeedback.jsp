            ...
            <form name="user_mst" id="user_mst" action="Registration_Action" method='POST'>            
                ...
                <div class="form-group">
											<label class="form-control-label">Type of Issue <span class="mandatory">*</span>
												...
												<option value="15" id="server" name="Server">Server Issue</option>
												<option value="25" id="content" name="Content">Content Issue</option>
												<option value="35" id="design" name="Design">Design Issue</option>												
											</select>
										</div> 
										</div>                
