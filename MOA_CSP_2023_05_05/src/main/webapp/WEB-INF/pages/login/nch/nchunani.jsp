            ...
            <div class="col-lg-12 col-md-12 col-sm-12 p-0">
               <div class="about-img-box portal-unani-bgimg" title="Unani">                
                  <div class="innerpage-imgbox">
	                  <div class="container">                  
		                  <div class="sinse-box">
		                     <h5 class="sinse-title">Unani system of medicine is a great healing art as well as science</h5>		                   
		                  </div>
	                  </div>
                  </div>                  
               </div>
