		...
		<div class="col-lg-12 col-md-12 col-sm-12 p-0">
			<div class="about-img-box portal-sowa-bgimg" title="Sowa-Rigpa">		
				<div class="innerpage-imgbox">
					<div class="container">
						<div class="sinse-box">
							<h5 class="sinse-title">The term Sowa-Rigpa is derived from
								Bhoti language which means 'knowledge of healing'.</h5>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-md-12 pt-5">
				<div class="row">				
					<div class="col-md-12 col-lg-12 section-md-t3">
						...
						<p class="color-text-a">Sowa-Rigpa is a system of medicine
						...
						<p class="color-text-a">Sowa-Rigpa has been recognized and
							...
							in the Sowa-Rigpa system for treatment purposes.</p>

						<p class="color-text-a">India had been a learning hotspot for
							...
							are some factors that indicate its proximity within India.</p>
