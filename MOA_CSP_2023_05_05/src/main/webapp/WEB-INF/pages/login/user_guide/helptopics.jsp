			...
			<div class="row">
				...
				<div class="col-md-12 col-lg-4">
					<nav aria-label="breadcrumb"
						...
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="usermanual_main">User Guide</a></li>
								...
								<nav class="navi-tabs__nav">
									<ul class="verticalnav">
										<li class="dropdown open"><a
											class="verticalnav-title">Portal Topics</a>
											<ul>
									   ...
									   <li class="dropdown"><a
											class="verticalnav-title">NCH Topics</a>
											<ul>
												<li><a href="#nch1">NCH Guide</a></li>
														...
														<ul>
															...
															<li><a class="custom-link no-hover">Videos</a>
																<div class="uvp-list">
																 <ul class="video-list">
																	<li><a
																href="ayusheducationusermanual?filename=/ayush_edu/nch/nch_practitioner.mp4"
																class="custom-link" target="_blank">Hindi </a></li>
																	<li><a
																href="ayusheducationusermanual?filename=/ayush_edu/nch/nch_practitioner_eng.mp4"
																class="custom-link" target="_blank">English</a></li>
																</ul></div></li>
											...
											<div class="accordion-item accordion-itemstyle">
												<h2 class="accordion-header"
													...
													<button
														...
														Practitioner/Faculty Sign In</button>
												...
												<div id="panelsStayOpen-collapseseven"
													...
													<div class="accordion-body">
														...
														<ul>
															<li><a href="signin_diff_usermanual" class="custom-link">Sign In User Manual (With Aadhaar Verify)</a></li>
															<li><a class="custom-link no-hover">Videos</a>
																<div class="uvp-list">
																 <ul class="video-list">
																	<li><a
																href="ayusheducationusermanual?filename=/ayush_edu/nch/nch_pract_signin.mp4"
																class="custom-link" target="_blank">Hindi </a></li>
																	<li><a
																href="ayusheducationusermanual?filename=/ayush_edu/nch/nch_pract_signin_eng.mp4"
																class="custom-link" target="_blank">English</a></li>
																</ul></div></li>
														</ul>
													</div>
														...
														<ul>
															...
															<li><a class="custom-link no-hover">Videos</a>
																<div class="uvp-list">
																 <ul class="video-list">
																	<li><a
																href="ayusheducationusermanual?filename=/ayush_edu/nch/nch_pract_signup.mp4"
																class="custom-link" target="_blank">Hindi </a></li>
																	<li><a
																href="ayusheducationusermanual?filename=/ayush_edu/nch/nch_pract_signup_eng.mp4"
																class="custom-link" target="_blank">English</a></li>
																</ul></div></li>
														</ul>
													</div>
