							...
							<div class="tables-wrapper">
								<div class="row">
									<div class="col-lg-12">
                						...
                						<h3 class="b-top mt-3 pt-2">View Details Of Form-35B Within India (PG Courses):</h3>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type= "hidden"  id="h_id" name="h_id">
             <div class="col-12 col-sm-12 col-md-6 col-lg-4">
				<div class="input-style-2 data-view">
					<label for="">Name Of Affiliating University :</label> 
					<span class="value-bind" id="aff_university_name"></span>
				</div>
			</div>
			<div class="col-12 col-sm-12 col-md-6 col-lg-4">
				<div class="input-style-2 data-view">
					<label for="">Address Of University :</label> 
					<span class="value-bind" id="aff_university_address"></span>
				</div>
			</div>
			<div class="col-12 col-sm-12 col-md-6 col-lg-4">
				<div class="input-style-2 data-view">
					<label for="">Registered Email-ID :</label> 
					<span class="value-bind" id="reg_email"></span>
				</div>
			</div>
			<div class="col-12 col-sm-12 col-md-6 col-lg-4">
				<div class="input-style-2 data-view">
					<label for="">Contact Person Name :</label> 
					<span class="value-bind" id="cont_name"></span>
				</div>
			</div>
			<div class="col-12 col-sm-12 col-md-6 col-lg-4">
				<div class="input-style-2 data-view">
					<label for="">Contact Person Designation :</label> 
					<span class="value-bind" id="cont_designation"></span>
				</div>
			</div>
			<div class="col-12 col-sm-12 col-md-6 col-lg-4">
				<div class="input-style-2 data-view">
					<label for="">Contact Person Mob No :</label> 
					<span class="value-bind" id="cont_mobile_no"></span>
				</div>
			</div>
			<div class="col-12 col-sm-12 col-md-6 col-lg-4">
				<div class="input-style-2 data-view">
					<label for="">Contact Person Email-ID :</label> 
					<span class="value-bind" id="cont_email_id"></span>
				</div>
			</div>
			<div class="col-12 col-sm-12 col-md-6 col-lg-4">
				<div class="input-style-2 data-view">
					<label for="">Medical Stream :</label> 
					<span class="value-bind" id="medical_system"></span>
				</div>
			</div>
			<div class="col-12 col-sm-12 col-md-6 col-lg-4">
				<div class="input-style-2 data-view">
					<label for="">Name Of Institute :</label> 
					<span class="value-bind" id="insti_name"></span>
				</div>
			</div>
...
function data(tablename){
	 if(tablename=="search_system"){
		 jsondata = [];
			...
			var aff_university_name = $("#aff_university_name").val();
			var reg_email = $("#reg_email").val();
			var cont_name = $("#cont_name").val();
			var cont_mobile_no = $("#cont_mobile_no").val();
			var medical_system = $("#medical_system").val();
			
			$.post("getFilter_withinIndiaForm_B_PG_list?" + key + "=" + value, {
				      ...
				      function(j) {
				    	  console.log(j)
							for (var i = 0; i < j.length; i++) {
								jsondata.push([j[i].ser,j[i].aff_university_name,j[i].reg_email, j[i].cont_name, j[i].cont_mobile_no,j[i].system_name,j[i].action]);
							}
						});
			$.ajaxSetup({
				async : false
			...
			$.post("getFilter_withinIndiaForm_B_PGListCount?" + key + "=" + value, {
				id:0
			}, function(j) {
				FilteredRecords = j;
...
//-------------POPUP viewData2--------------
	...
	function viewData2(id) {
	 $.post('getviewdatapg?'+key+"="+value, {
		 id:id
		}).done(function(j) {
// 			alert(j);
// 			    var options = $("#headData").append(options);
			    $("#h_id").val(j[0].id);
				$("span#aff_university_name").text(j[0].aff_university_name);
				$("span#aff_university_address").text(j[0].aff_university_address);
				$("span#reg_email").text(j[0].reg_email);
				$("span#cont_name").text(j[0].cont_name);
				$("span#cont_designation").text(j[0].cont_designation);
				$("span#cont_mobile_no").text(j[0].cont_mobile_no);
				$("span#cont_email_id").text(j[0].cont_email_id);
				$("span#medical_system").text(j[0].medical_system);
				$("span#insti_name").text(j[0].insti_name);
