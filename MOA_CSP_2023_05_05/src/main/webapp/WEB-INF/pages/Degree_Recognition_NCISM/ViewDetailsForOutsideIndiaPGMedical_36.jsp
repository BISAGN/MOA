							...
							<div class="tables-wrapper">
								<div class="row">
									<div class="col-lg-12">
                						...
                						<h3 class="b-top mt-3 pt-2">View Details Of Form-36B Outside India (PG Medical Courses):</h3>
        ...
        <input type= "hidden"  id="h_id" name="h_id">
             <div class="col-12 col-sm-12 col-md-6 col-lg-4">
				<div class="input-style-2 data-view">
					...
					<span class="value-bind" id="pg_subject"></span>
				</div>
			</div>
			<div class="col-12 col-sm-12 col-md-6 col-lg-4">
				<div class="input-style-2 data-view">
					<label for="">Nomenclature Of Degree :</label> 
					<span class="value-bind" id="nom_degree"></span>
				</div>
			</div>
			<div class="col-12 col-sm-12 col-md-6 col-lg-4">
				<div class="input-style-2 data-view">
					<label for="">Abbreviation Of Degree :</label> 
					<span class="value-bind" id="abb_degree"></span>
				</div>
			</div>
			<div class="col-12 col-sm-12 col-md-6 col-lg-4">
				<div class="input-style-2 data-view">
					<label for="">Month & Year Of Admission Of First Batch :</label> 
					<span class="value-bind" id="m_y_add_fir_bat"></span>
				</div>
			</div>
			<div class="col-12 col-sm-12 col-md-6 col-lg-4">
				<div class="input-style-2 data-view">
					<label for="">Month & Year Of Passing Of First Batch :</label> 
					<span class="value-bind" id="m_y_exam_fir_bat"></span>
				</div>
			</div>
			<div class="col-12 col-sm-12 col-md-6 col-lg-4">
				<div class="input-style-2 data-view">
					<label for="">Month & Year Of Issue Of Provisional Certificate :</label> 
					<span class="value-bind" id="m_y_pro_cer"></span>
				</div>
			</div>
			<div class="col-12 col-sm-12 col-md-6 col-lg-4">
				<div class="input-style-2 data-view">
					<label for="">Date Of Letter Of Permission :</label> 
					<span class="value-bind" id="pg_diploma_date"></span>
				</div>
			</div>
	    </div>       
				<div class="modal-footer">
...
function data(tablename){
	 if(tablename=="search_system"){
		 jsondata = [];
			...
			var nom_degree = $("#nom_degree").val();
			var abb_degree = $("#abb_degree").val();
			
			$.post("getFilter_outsideIndiaForm_C_PG_list?" + key + "=" + value, {
				      ...
				      function(j) {
				    	  console.log(j)
							for (var i = 0; i < j.length; i++) {
								jsondata.push([j[i].ser,j[i].pg_subject,j[i].nom_degree, j[i].abb_degree,j[i].action]);
							}
						});
			$.ajaxSetup({
				async : false
			...
			$.post("getFilter_outsideIndiaForm_C_PGListCount?" + key + "=" + value, {
				id:0
			}, function(j) {
				FilteredRecords = j;
...
//-------------POPUP viewData2--------------
	...
	function viewData2(id) {
	 $.post('getviewdataoutsideindiapgmdeical?'+key+"="+value, {
		 id:id
		}).done(function(j) {
// 			alert(j);
// 			    var options = $("#headData").append(options);
			    $("#h_id").val(j[0].id);
				$("span#pg_subject").text(j[0].pg_subject);
				$("span#nom_degree").text(j[0].nom_degree);
				$("span#abb_degree").text(j[0].abb_degree);
				$("span#m_y_add_fir_bat").text(j[0].m_y_add_fir_bat);
				$("span#m_y_exam_fir_bat").text(j[0].m_y_exam_fir_bat);
				$("span#m_y_pro_cer").text(j[0].m_y_pro_cer);
				$("span#pg_diploma_date").text(j[0].pg_diploma_date);
