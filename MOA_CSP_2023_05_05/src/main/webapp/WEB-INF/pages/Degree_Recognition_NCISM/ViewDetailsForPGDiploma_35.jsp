							...
							<div class="tables-wrapper">
								<div class="row">
									<div class="col-lg-12">
                						...
                						<h3 class="b-top mt-3 pt-2">View Details Of Form-35B Within India (PG Diploma Courses):</h3>
...
function data(tablename){
	 if(tablename=="search_system"){
		 jsondata = [];
			...
			$.post("getFilter_withinIndiaForm_D_PG_list?" + key + "=" + value, {
			...
			$.post("getFilter_withinIndiaForm_D_PGListCount?" + key + "=" + value, {
				id:0
			}, function(j) {
				FilteredRecords = j;
...
//-------------POPUP viewData2--------------
	...
	function viewData2(id) {
	 $.post('getviewdatapgdiploma?'+key+"="+value, {
		 id:id
		}).done(function(j) {
// 			alert(j);
