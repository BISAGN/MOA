					...
					<form:form name="" id=""
						...
						<div class="card-style mb-30">
							<div class="custom-field-block">
								<h6 class="mb-25">View Faculty Details</h6>
								<div class="row">

									<div class="col-lg-4 col-md-6 col-sm-12">
										<div class="input-style-1">
											<label>Ayush Id <strong class="mandatory">*</strong></label>
											<input type="text" name="ayush_id" id="ayush_id"
								...
								<div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12">
										...
										<ul class="buttons-group mainbtn">
											...
											<li><a href="Search_teacher_detail_url"
												...
												<table id="getSearch_teacher_dtl" class="table">
													<thead>
														<tr>
															...
															<th><h6>Name of the state board</h6></th>
...
//		var currentPage = info.page;
	...
	$.post("getFilterTeacher_dtl_data?" + key + "=" + value, {
		startPage : startPage,
		...
		for (var i = 0; i < j.length; i++) {
			...
			var name_of_state_board=""
			
				if (j[i].state_board_name !="" && j[i].state_board_name !=null && j[i].state_board_name !="null") {
					name_of_state_board= j[i].state_board_name;
				}else {
					name_of_state_board="-";
				}
			...
			var state_reg_no=""
				...
				if (j[i].state_reg_no !="" && j[i].state_reg_no !=null && j[i].state_reg_no !="null") {
					state_reg_no= j[i].state_reg_no;
				}else {
					state_reg_no="-";
				}
			
			
			jsondata.push([ j[i].ser,j[i].ayush_id,j[i].first_name, j[i].gender,j[i].date_of_birth,j[i].state,j[i].district,j[i].per_village,
				state_reg_no,name_of_state_board,date_of_reg,central_reg,j[i].yr_of_exp,j[i].action]);
			
		}
	});
	$.post("getTotalTeacher_dtl_dataCount?" + key + "=" + value, {
		Search : Search,
		ayush_id : ayush_id,
		teacher_code : teacher_code,
		first_name : first_name,
