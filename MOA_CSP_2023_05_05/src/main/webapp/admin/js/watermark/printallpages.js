				...
				"<table style='width:100%;'>"+
					"<tr>"+
				   		"<td align='left' style='padding-right:50px;'>"+
				   			"<img src='js/images/indianarmy_smrm5aaa.jpg' style='height: 50px;'>"+
				   		"</td>"+
				   		"<td align='center'>"+
				   		...
				   		"</td>"+
				   		"<td align='right'>"+
				   			"<img src='js/images/dgis-logo.png' style='max-width: 155px; height: 50px;'>"+ 
				   		"</td>"+
				   	"</tr>";
 		row += "</table>";
...
function printDivOptimize(divName,header,allLbl,allVal,statusCol) {
	...
	popupWinindow.document.write('<html><head><link rel="stylesheet" href="layout_file/css/bootstrap.min.css"><link rel="stylesheet" href="layout_file/css/style.css"><link rel="stylesheet" href="js/watermark/printwatermark.css"></head><body onload="window.focus(); window.print(); window.close();" oncopy="return false" oncut="return false" onpaste="return false" oncontextmenu="return false">' +innerContents+  '</html>');
	popupWinindow.document.close();
	$("div#divShow").hide();
...
function printDivOptimize12(divName,header,allLbl,allVal,statusCol) {
    ...
    $("div#divShow1").show();
     ...
     var printVal = allVal; //[$('input:radio[name=we_pe]:checked').val(),document.getElementById('we_pe_no').value,document.getElementById('table_title1').value];
                     row += "<div style='background:#fff;'><h4 style='text-align:center;text-decoration: underline; font-size: 13px; '><b>RESTRICTED</b></h4></div>"+
                            "<table style='width:100%;'>"+
                                    "<tr>"+
                                               "<td align='left' style='padding-right:50px;'>"+
                                               "<img src='js/images/indianarmy_smrm5aaa.jpg'  class='img-fluid' alt='logo1' style='height:60px;width: 60px;'>"+
                                               "</td>"+
                                               "<td align='center'>"+
                                               ...
                                               "</td>"+
                                               "<td align='right'>"+
                                               "<img src='js/images/dgis-logo.png'  class='img-fluid' alt='logo' style='float: right; width: 95px;'>"+
                                               "</td>"+
                                       "</tr>";
                    row += "</table>";
     ...
     let innerContents = document.getElementById(divName).innerHTML;
       ...
       /*popupWinindow.document.write('<html><head><link rel="stylesheet" href="layout_file/css/bootstrap.min.css"><link rel="stylesheet" href="layout_file/css/style.css"><link rel="stylesheet" href="js/watermark/printwatermark.css"><style> table td{font-size:12px;} table th{font-size:13px !important;} </style></head><body onload="window.focus(); window.print(); window.close();" oncopy="return false" oncut="return false" onpaste="return false" oncontextmenu="return false">' +innerContents+  '</html>');*/
        popupWinindow.document.write('<html><head><link rel="stylesheet" href="js/watermark/printwatermark_old.css"><style> table td{font-size:12px;} table th{font-size:12px !important;} </style></head><body onload="window.focus(); window.print();  window.close();" oncopy="return false" oncut="return false" onpaste="return false" oncontextmenu="return false">' +innerContents+  '</html>');
