function Tour(steps, options) {
    ...
    var getPopoverSettings = function(arrows) {
        var template = '<div id="tour" class="popover popover-tour custom-tour" role="tooltip">' +
            '<div class="popover-arrow"></div>';
        if (!arrows) {
            template = '<div id="tour" class="popover popover-tour popover-tour-center custom-tour" role="tooltip">';
        }
...
//        template += '<div class="tour-exit"></div>' +
		  template += '<div class="d-none"></div>' +
            ...
            '   </a>' +
             '   <a class="btn tour-exit custom-tour-exit">' +
            translations.exit +
            '   </a>' +
            '   <a class="btn tour-next">' +
            translations.next +
            '   </a>' +           
            '   <a class="btn tour-finish hidden">' +
            translations.finish +
            '   </a>' +
            '</div>' +
            '</div>';
...
Tour.prototype.getCurrentStepUrl = function() {
	return this.steps[this.currentTab].url;
}
...
Tour.prototype.createContentUrl = function() {
    url = this.getCurrentStepUrl();
    if(url != ""){
