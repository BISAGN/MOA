...
//		document.getElementById('fees_sub_cat_1').onkeypress =
//		function() {
//			return OnlyAlphabetAndSpace(event);
//		};
...
//	var res1 = OnlyAlphabeAndSpaceRegExp('fees_sub_cat_' + x);
//	if (res1 !== "true") {
//
//		alert("Fees Sub-Category " + res1);
//		$('#fees_sub_cat_'+ x).focus();
//		return false;
//	}
...
//alert(hasMatch)
	if (hasMatch == false) {
		...
		$("table#co_feescategorytype").append('<tr  id="tr_img' + x + '"><td><p>' + x + '</p></td>'
			...
			+ '<input type="text" id="fees_sub_cat_' + x + '"  placeholder = "Enter Fees Sub Category" class="text-uppercase" name = "fees_sub_cat' + '" autocomplete = "off" tabindex = ' + ' class="feesvalue"> '
			+ '</div>'
			+ '</td>'
			+ '<td >'
			+ '<div class="input-style-1">'
			+ '<input type="text" id="feesvalue_' + x + '"  placeholder = "Enter Fees Value" name = "feesvalue' + '" autocomplete = "off" maxlength = "8" 	tabindex = ' + ' class="feesvalue"> '
			+ '</div>'
			+ '</td>'
...
//		document.getElementById('fees_sub_cat_' + x).onkeypress =
//			function() {
//				return OnlyAlphabetAndSpace(event);
//		};
	} else {
...
//	var res = OnlyLetterRegEx('insabb');
	var res =  OnlyAlphaNumericWithoutSpaceRegExp('insabb');
	if (res !== "true") {
...
//			var res1 = OnlyAlphabeAndSpaceRegExp('fees_sub_cat_' + counter);
//			if (res1 !== "true") {
//		
//				alert("Fees Sub-Category " + res1);
//				$('#fees_sub_cat_'+ counter).focus();
...
//			}
			...
			var hostelfacilitychk = $('#fees_'+counter).val();
			if(document.getElementById("hostelfacility").checked==false && hostelfacilitychk=="3") {
				alert("Hostel Fees Not Applicable");
				return false;
			}
			...
			for (var index = 0; index < jsonlist.length; ++index) {
				...
				if (jsondataval.categoryid == categoryvalue && jsondataval.feesid == $('#fees_' + counter).val()
				 && jsondataval.fees_sub_cat == $('#fees_sub_cat_' + counter).val()) {
					hasMatch = true;
					break;
				}
			}
