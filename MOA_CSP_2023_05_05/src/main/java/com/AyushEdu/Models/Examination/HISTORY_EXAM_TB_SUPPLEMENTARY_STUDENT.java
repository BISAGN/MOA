...
@Entity
@Table(name = "history_edu_exam_tb_supplementary_student", uniqueConstraints = { @UniqueConstraint(columnNames = "id") })

public class HISTORY_EXAM_TB_SUPPLEMENTARY_STUDENT {
