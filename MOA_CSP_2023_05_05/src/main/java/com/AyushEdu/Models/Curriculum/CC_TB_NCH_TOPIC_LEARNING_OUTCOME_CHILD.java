...
@Entity
@Table(name = "edu_cc_tb_nch_topic_learning_outcome_child", uniqueConstraints = { @UniqueConstraint(columnNames = "id") })

public class CC_TB_NCH_TOPIC_LEARNING_OUTCOME_CHILD {
