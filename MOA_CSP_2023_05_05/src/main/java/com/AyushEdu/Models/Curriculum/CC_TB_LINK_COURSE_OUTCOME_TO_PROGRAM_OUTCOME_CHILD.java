...
@Entity
@Table(name = "edu_cc_tb_link_course_outcome_and_program_outcome_child", uniqueConstraints = { @UniqueConstraint(columnNames = "id") })

public class CC_TB_LINK_COURSE_OUTCOME_TO_PROGRAM_OUTCOME_CHILD {
