...
@Entity
@Table(name = "edu_cc_summary_exam_pract_comp_child", uniqueConstraints = {
@UniqueConstraint(columnNames = "id") })
public class EDU_CC_SUMMARY_EXAMINATION_PRACT_COMP_CHILD {
	
	
	private int id;
	private int pract_cb; 
	private int practical_marks; 
	private int viva_cb; 
	private int viva_marks; 
	private int ele_cb; 
	private int elective_marks; 
	private int ia_cb; 
	private int ia_marks; 
	...
	public Integer getPa_cb() {
		return pa_cb;
	}
	public void setPa_cb(Integer pa_cb) {
		this.pa_cb = pa_cb;
	}
	public Integer getPa_marks() {
		return pa_marks;
	}
	public void setPa_marks(Integer pa_marks) {
