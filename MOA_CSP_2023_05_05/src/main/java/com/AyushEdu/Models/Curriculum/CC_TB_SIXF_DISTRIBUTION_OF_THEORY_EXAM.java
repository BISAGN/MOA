...
@Entity
@Table(name = "edu_cc_tb_sixf_distribution_of_theory_exam", uniqueConstraints = { @UniqueConstraint(columnNames = "id") })

public class CC_TB_SIXF_DISTRIBUTION_OF_THEORY_EXAM {
