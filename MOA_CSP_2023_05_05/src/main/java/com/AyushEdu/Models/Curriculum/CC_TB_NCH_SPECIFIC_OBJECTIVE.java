...
@Entity
@Table(name = "edu_cc_tb_nch_specific_objective", uniqueConstraints = { @UniqueConstraint(columnNames = "id") })

public class CC_TB_NCH_SPECIFIC_OBJECTIVE {
	...
	public String getSpecific_objective() {
		return specific_objective;
	}
	public void setSpecific_objective(String specific_objective) {
