...
@Entity
@Table(name = "edu_cc_tb_paper_layout", uniqueConstraints = {
@UniqueConstraint(columnNames = "id") })
public class EDU_CC_TB_PAPER_LAYOUT {
	...
	public int getMarks_questions() {
		return marks_questions;
	}
	public void setMarks_questions(int marks_questions) {
		this.marks_questions = marks_questions;
	}
