...
@Entity
@Table(name = "edu_cc_tb_nch_list_of_practical_parent", uniqueConstraints = { @UniqueConstraint(columnNames = "id") })

public class EDU_CC_TB_NCH_LIST_OF_PRACTICAL_PARENT {
	private int id;
