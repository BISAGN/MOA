...
@Entity
@Table(name = "edu_cc_tb_link_exam_and_course", uniqueConstraints = { @UniqueConstraint(columnNames = "id") })

public class CC_TB_LINK_EXAM_AND_COURSE {
	...
	public int getNo_of_exam() {
		return no_of_exam;
	}
	public void setNo_of_exam(int no_of_exam) {
