...
@Entity
@Table(name = "edu_cc_link_system_degree_professional_course", uniqueConstraints = { @UniqueConstraint(columnNames = "id") })

public class EDU_CC_LINK_SYSTEM_DEGREE_PROFESSIONAL_COURSE {
