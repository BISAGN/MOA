...
@Entity
@Table(name = "edu_cc_tb_nch_formative_and_summative_mstr", uniqueConstraints = { @UniqueConstraint(columnNames = "id") })
public class CC_TB_FORMATIVE_AND_SUMMATIVE_MSTR {
