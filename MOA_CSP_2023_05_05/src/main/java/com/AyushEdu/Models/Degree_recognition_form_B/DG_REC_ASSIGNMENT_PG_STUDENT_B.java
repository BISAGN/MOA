...
@Entity
@Table(name = "dg_rec_assignment_pg_student_child_b", uniqueConstraints = {
@UniqueConstraint(columnNames = "id") })

public class DG_REC_ASSIGNMENT_PG_STUDENT_B {
	
	private int id;
	private String student_name_formc;
	private String list_of_assignment_formc;
	...
	public String getStudent_name_formc() {
		return student_name_formc;
	}
	public void setStudent_name_formc(String student_name_formc) {
		this.student_name_formc = student_name_formc;
	}
	public String getList_of_assignment_formc() {
		return list_of_assignment_formc;
	}
	public void setList_of_assignment_formc(String list_of_assignment_formc) {
		this.list_of_assignment_formc = list_of_assignment_formc;
	}
