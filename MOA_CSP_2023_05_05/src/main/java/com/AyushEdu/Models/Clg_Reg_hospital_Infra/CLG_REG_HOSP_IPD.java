...
@Entity
@Table(name="clg_reg_hosp_ipd", uniqueConstraints={@UniqueConstraint(columnNames="id")})

public class CLG_REG_HOSP_IPD {
	
	private int id;
	private String ipd_department_name;
	...
	public String getIpd_department_name() {
		return ipd_department_name;
	}
	public void setIpd_department_name(String ipd_department_name) {
		this.ipd_department_name = ipd_department_name;
	}
