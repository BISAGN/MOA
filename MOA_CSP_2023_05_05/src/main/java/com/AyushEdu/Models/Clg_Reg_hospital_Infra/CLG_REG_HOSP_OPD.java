...
@Entity
@Table(name="clg_reg_hosp_opd", uniqueConstraints={@UniqueConstraint(columnNames="id")})

public class CLG_REG_HOSP_OPD {
	
	private int id;
	private String opd_department_name;
	...
	public String getOpd_department_name() {
		return opd_department_name;
	}
	public void setOpd_department_name(String opd_department_name) {
		this.opd_department_name = opd_department_name;
	}
