...
@Entity
@Table(name="clg_reg_dept_equipment_pathology_biochemeistry", uniqueConstraints={@UniqueConstraint(columnNames="id")})
public class CLG_REG_DEPT_EQUIPMENT_PATHOLOGY_BIOCHEMISTRY {
