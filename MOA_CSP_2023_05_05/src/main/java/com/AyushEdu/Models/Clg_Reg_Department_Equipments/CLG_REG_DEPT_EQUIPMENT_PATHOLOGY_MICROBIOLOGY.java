...
@Entity
@Table(name="clg_reg_dept_equipment_pathology_microbiology", uniqueConstraints={@UniqueConstraint(columnNames="id")})
public class CLG_REG_DEPT_EQUIPMENT_PATHOLOGY_MICROBIOLOGY {
