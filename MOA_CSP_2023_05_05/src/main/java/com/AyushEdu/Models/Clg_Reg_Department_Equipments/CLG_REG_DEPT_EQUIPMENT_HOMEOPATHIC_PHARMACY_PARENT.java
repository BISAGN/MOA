...
@Entity
@Table(name="clg_reg_dept_equipment_homeopathic_pharmacy_parent", uniqueConstraints={@UniqueConstraint(columnNames="id")})

public class CLG_REG_DEPT_EQUIPMENT_HOMEOPATHIC_PHARMACY_PARENT {
