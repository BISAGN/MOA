...
@Entity
@Table(name="clg_reg_dept_equipment_homeo_materia_medica", uniqueConstraints={@UniqueConstraint(columnNames="id")})
public class CLG_REG_DEPT_EQUIPMENT_HOMEO_MATERIA_MEDICA {
