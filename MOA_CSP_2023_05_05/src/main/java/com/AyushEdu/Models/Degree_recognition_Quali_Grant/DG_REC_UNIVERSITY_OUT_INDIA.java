package com.AyushEdu.Models.Degree_recognition_Quali_Grant;
...
@Entity
@Table(name = "dg_rec_university_out_india", uniqueConstraints = {
@UniqueConstraint(columnNames = "id") })
public class DG_REC_UNIVERSITY_OUT_INDIA {
