...
@Entity
@Table(name="clg_reg_inst_info_course_intake_capacity_pg", uniqueConstraints={@UniqueConstraint(columnNames="id")})
public class CLG_REG_INST_INFO_COURSE_INTAKE_CAPACITY_PG {
