...
//	private int country_id;
	...
	private int pract_type;
	
	private int Course_pub_userid;
	private String aadhar_no;
	private boolean aadhaar_is_verified;
...
//	}
	...
	public int getPract_type() {
		return pract_type;
	}
	public void setPract_type(int pract_type) {
		this.pract_type = pract_type;
	}
	public int getCourse_pub_userid() {
		return Course_pub_userid;
	}
	public void setCourse_pub_userid(int course_pub_userid) {
		Course_pub_userid = course_pub_userid;
	}
	...
	public boolean isAadhaar_is_verified() {
		return aadhaar_is_verified;
	}
	public void setAadhaar_is_verified(boolean aadhaar_is_verified) {
		this.aadhaar_is_verified = aadhaar_is_verified;
	}
