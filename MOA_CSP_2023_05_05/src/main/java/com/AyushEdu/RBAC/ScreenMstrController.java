...
public class ScreenMstrController {
	...
	//		 session.invalidate();
		...
		String roleid1 = session.getAttribute("roleid").toString();
		 Boolean val = roledao.ScreenRedirect("screen_mstUrl", roleid1);		
			if(val == false) {
...
//		}
	...
	public ModelAndView screen_mstAction(@ModelAttribute("screen_mstCMD") TB_LDAP_SCREEN_MASTER p,String id1,HttpServletRequest request, ModelMap model, HttpSession session) {
		String roleid1 = session.getAttribute("roleid").toString();
