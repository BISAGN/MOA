...
public class University_In_India {
	...
	@RequestMapping(value = "/UniversityIndiaUrl", method = RequestMethod.GET)

	public ModelAndView UniversityIndiaUrl(ModelMap Mmap, HttpSession session,
		...
		String roleid1 = session.getAttribute("roleid").toString();
		 Boolean val = roledao.ScreenRedirect("UniversityIndiaUrl", roleid1);		
			if(val == false) {
		...
		return new ModelAndView("University_In_India_Tiles", "University_CMD", new DG_REC_UNIVERSITY_IN_INDIA());

	}
	@RequestMapping(value = "/getInstituteUrlindia", method = RequestMethod.POST)
	public @ResponseBody List<EDU_LMS_INSTITUTE_REGISTRATION> getInstituteUrlindia(ModelMap Mmap, HttpSession session,
	...
	@PostMapping(value = "/University_Action")
	public ModelAndView University_Action(@Validated @ModelAttribute("University_CMD") DG_REC_UNIVERSITY_IN_INDIA td, BindingResult result,
...
//		}
		...
		try {
			...
			Long c = (Long) sessionHQL.createQuery(
					"select count(id) from  DG_REC_UNIVERSITY_IN_INDIA where country_name=:country_name and university_name=:university_name and "
			...
			if (id == 0) {
				...
				if (c == 0) {
					td.setId(id);
					String msg = Udao.updateuniversity(td);
	...
	@PostMapping("/getFilter_University")
	...
	public @ResponseBody List<Map<String, Object>> getFilterRegistration_data(int startPage, int pageLength,
		...
		return Udao.DataTableUniversityDataList(startPage, pageLength, Search, orderColunm, orderType, country_name, university_name, college_name, abbreviation, medical_course_name, validity_period, digital_code);

	}

	@PostMapping("/getTotal_University")
    ...
    {
		return Udao.DataTableUniversityDataTotalCount(Search, country_name, university_name, college_name, abbreviation, medical_course_name, validity_period, digital_code);
	...
	public List<TB_COUNTRY> getCountryName() {
		 ...
		 Query q0 = session.createQuery("from TB_COUNTRY  where id = '50'");
	...
	@RequestMapping(value = "/getAbbreviationList1", method = RequestMethod.POST)
	public @ResponseBody ArrayList<ArrayList<String>> getAbbreviationList1(ModelMap Mmap,
	...
	// -------------------------SEARCH Battalion  -------------------------------------//
			 ...
			 @RequestMapping(value = "/admin/getSearch_University", method = RequestMethod.POST)
				public ModelAndView getSearch_University(ModelMap Mmap,HttpSession session,HttpServletRequest request,
...
//				 Boolean val = roledao.ScreenRedirect("SystemUrl", roleid);	
			...
			//==========================================DELETE NAME========================================== 	
				...
				@RequestMapping(value = "/delete_Url33", method = RequestMethod.POST)
				public ModelAndView delete_Url33(@ModelAttribute("id33") int id, BindingResult result, RedirectAttributes ra,
					...
					try {
						...
						int app = session.createQuery(
								"delete from DG_REC_UNIVERSITY_IN_INDIA where id=:id")
