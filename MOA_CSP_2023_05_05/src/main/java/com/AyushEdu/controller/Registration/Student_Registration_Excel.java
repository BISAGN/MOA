...
public class Student_Registration_Excel extends AbstractXlsView {
	String Type = "";
	List<String> TH;
	String Heading = "";
	String username = "";
	...
	public Student_Registration_Excel(String Type, List<String> TH,  List<ArrayList<String>> non, String Heading, String username) {
		this.Type = Type;
		this.TH = TH;
		this.non = non;
