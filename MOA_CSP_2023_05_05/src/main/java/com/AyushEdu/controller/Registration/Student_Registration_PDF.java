...
public class Student_Registration_PDF extends AbstractPdfView  {
	
	String Type = "";
	List<String> TH;
//	List<ArrayList<String>> nonlecact1;
//	List<String> TH2;
	String Heading = "";
	String username = "";
	int total = 0;
	...
	public static final ArrayList aList = null;

	public Student_Registration_PDF(String Type, List<String> TH, String Heading, String username, int total) {
...
//		this.nonlecact1 = nonlecact1;
	...
	protected void buildPdfMetadata(Map<String, Object> model, Document document, HttpServletRequest request) {
		...
		Chunk underline2 = new Chunk("Student Registration Report");
...
//		ArrayList<ArrayList<String>> aList2 = new_list2;
		...
		PdfPTable table3 = new PdfPTable(1);
		 table3 = new PdfPTable(20);
		table3.setWidthPercentage(100);
		table3.setWidths(new int[] { 30,20, 30, 25, 20, 20, 20,20,20,20,20,20,20,20,24,25,20,20,20,60});
		table3.getDefaultCell().setHorizontalAlignment(Element.ALIGN_CENTER);
