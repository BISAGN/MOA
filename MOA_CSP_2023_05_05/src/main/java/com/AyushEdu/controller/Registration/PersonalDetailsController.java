...
public class PersonalDetailsController {
	...
	@RequestMapping(value = "/Personal_Details_Url", method = RequestMethod.GET)
	public ModelAndView Personal_Details_Url(ModelMap Mmap, HttpSession session,
...
//				session.invalidate();
			...
			if (check.equals(1)) {
				...
				Mmap.addAttribute("pddata", da.getAllPersdetails(Integer.parseInt(userId)));
				Mmap.addAttribute("userid", da.getUsername(username));
		...
		return new ModelAndView("Personal_Details_Tiles");
//		return new ModelAndView("Personal_Details_newTiles");
	}

	@PostMapping(value = "/personal_details_Action")
	public ModelAndView personal_details_Action(
			@Validated @ModelAttribute("personal_details_CMD") TB_PERSONAL_DETAILS td, BindingResult result,
...
//			session.invalidate();
		...
		try {
			...
			String chk_add_val = request.getParameter("chk_add_val");
			...
			System.err.println("corre_pincode------>>>" + corre_pincode);
...
//			if (validation.isOnlyAlphabetDASH(pers_middel_name) == false) {
...
//			}
			...
			if (validation.isOnlyDateFormat(pers_date_of_birth) == false) {
				ra.addAttribute("msg", "Date Of Birth "  + validation.isOnlyDateFormatMSG);
				return new ModelAndView("redirect:Personal_Details_Url");
			}
			...
			if (validation.maxlengthcheck50(pers_email) == false) {
				ra.addAttribute("msg", "Email Address " + validation.MaxlengthcheckMSG50);
				return new ModelAndView("redirect:Personal_Details_Url");
			}
			...
			if (validation.maxlengthcheck50(village) == false) {
				ra.addAttribute("msg", "village Name " + validation.MaxlengthcheckMSG50);
				return new ModelAndView("redirect:Personal_Details_Url");
			}
			if (validation.isOnlyAlphabet(village) == false) {
				ra.addAttribute("msg", "village Name " + validation.isOnlyAlphabetMSG);
				return new ModelAndView("redirect:Personal_Details_Url");
			}
			...
			if (validation.maxlengthcheck50(pers_permanent_village) == false) {
				ra.addAttribute("msg", "Permanent City/Village " + validation.MaxlengthcheckMSG50);
				return new ModelAndView("redirect:Personal_Details_Url");
			}
			...
			if (validation.maxlengthcheck50(pers_permanent_postoffice) == false) {
				ra.addAttribute("msg", "Permanent Post Office " + validation.MaxlengthcheckMSG50);
				return new ModelAndView("redirect:Personal_Details_Url");
			}
//			if (validation.isOnlyAlphabet(pers_permanent_postoffice) == false) {
//				ra.addAttribute("msg", "Permanent Post Office " + validation.isOnlyAlphabetMSG);
//				return new ModelAndView("redirect:Personal_Details_Url");
//			}
			...
			if (validation.maxlengthcheck50(pers_permanent_tehsil) == false) {
				ra.addAttribute("msg", "Permanent Tehsil " + validation.MaxlengthcheckMSG50);
				return new ModelAndView("redirect:Personal_Details_Url");
			}
			if (validation.isOnlyAlphabet(pers_permanent_tehsil) == false) {
				ra.addAttribute("msg", "Permanent tehsil " + validation.isOnlyAlphabetMSG);
				return new ModelAndView("redirect:Personal_Details_Url");
			}
			...
			if (validation.maxlengthcheck50(pers_permanent_policestation) == false) {
				ra.addAttribute("msg", "Permanent Police Station " + validation.MaxlengthcheckMSG50);
				return new ModelAndView("redirect:Personal_Details_Url");
			}
			
//			if (validation.isOnlyAlphabet(pers_permanent_policestation) == false) {
//				ra.addAttribute("msg", "Permanent Police Station " + validation.isOnlyAlphabetMSG);
//				return new ModelAndView("redirect:Personal_Details_Url");
//			}
			...
			if (pers_permanent_lendmark == null || pers_permanent_lendmark.trim().equals("")) {
				ra.addAttribute("msg", "Please Enter the Permanent Landmark");
				return new ModelAndView("redirect:Personal_Details_Url");
			}
			
			if (validation.maxlengthcheck50(pers_permanent_lendmark) == false) {
				ra.addAttribute("msg", "Permanent Lendmark " + validation.MaxlengthcheckMSG50);
				return new ModelAndView("redirect:Personal_Details_Url");
			}
			if (validation.isOnlyAlphabet(pers_permanent_lendmark) == false) {
			...
			if (request.getParameter("check_address") == null) {
				...
				if (validation.maxlengthcheck50(pers_present_village) == false) {
					ra.addAttribute("msg", "Present City/Village " + validation.MaxlengthcheckMSG50);
					return new ModelAndView("redirect:Personal_Details_Url");
				}
				...
				if (pers_present_postoffice == null || pers_present_postoffice.trim().equals("")) {
					ra.addAttribute("msg", "Please Enter the Present Post Office");
					return new ModelAndView("redirect:Personal_Details_Url");
				}
				if (pers_permanent_tehsil == null || pers_permanent_tehsil.trim().equals("")) {
				...
				if (validation.maxlengthcheck50(pers_present_policestation) == false) {
					ra.addAttribute("msg", "Present  Police Station " + validation.MaxlengthcheckMSG50);
					return new ModelAndView("redirect:Personal_Details_Url");
				}
//				if (validation.isOnlyAlphabet(pers_present_policestation) == false) {
//					ra.addAttribute("msg", "Present Police Station " + validation.isOnlyAlphabetMSG);
//					return new ModelAndView("redirect:Personal_Details_Url");
//				}
				...
				if (pers_present_lendmark == null || pers_present_lendmark.trim().equals("")) {
					ra.addAttribute("msg", "Please Enter the Present Landmark");
					return new ModelAndView("redirect:Personal_Details_Url");
				}
				
				if (validation.maxlengthcheck50(pers_present_lendmark) == false) {
					ra.addAttribute("msg", "Present Lendmark " + validation.MaxlengthcheckMSG50);
					return new ModelAndView("redirect:Personal_Details_Url");
				}
				if (validation.isOnlyAlphabet(pers_present_lendmark) == false) {
					ra.addAttribute("msg", "Present Lendmark " + validation.isOnlyAlphabetMSG);
					return new ModelAndView("redirect:Personal_Details_Url");
				}
...
//			if (chk_add_val == null || chk_add_val.trim().equals("")) {
//				ra.addAttribute("msg", "Please Select Radio Button ");
//				return new ModelAndView("redirect:Personal_Details_Url");
//			}
			
			if (request.getParameter("check_address1") == null) {
				...
				if (corre_postoffice == null || corre_postoffice.trim().equals("")) {
					ra.addAttribute("msg", "Please Enter the Corresponding Post Office");
					return new ModelAndView("redirect:Personal_Details_Url");
				}
				
				if (validation.maxlengthcheck50(corre_postoffice) == false) {
					ra.addAttribute("msg", "Corresponding Postoffice " + validation.MaxlengthcheckMSG50);
					return new ModelAndView("redirect:Personal_Details_Url");
				}
//				if (validation.isOnlyAlphabet(corre_postoffice) == false) {
//					ra.addAttribute("msg", "Corresponding Postoffice " + validation.isOnlyAlphabetMSG);
//					return new ModelAndView("redirect:Personal_Details_Url");
//				}

				
				if (corre_tehsil == null || corre_tehsil.trim().equals("")) {
					ra.addAttribute("msg", "Please Enter the Corresponding Tehsil");
					return new ModelAndView("redirect:Personal_Details_Url");
				}
				if (validation.maxlengthcheck50(corre_tehsil) == false) {
					ra.addAttribute("msg", "Corresponding Tehsil " + validation.MaxlengthcheckMSG50);
					return new ModelAndView("redirect:Personal_Details_Url");
				}
				if (validation.isOnlyAlphabet(corre_tehsil) == false) {
					ra.addAttribute("msg", "Corresponding Tehsil " + validation.isOnlyAlphabetMSG);
					return new ModelAndView("redirect:Personal_Details_Url");
				}
				
				if (corre_policestation == null || corre_policestation.trim().equals("")) {
					ra.addAttribute("msg", "Please Enter the Corresponding Police Station");
					return new ModelAndView("redirect:Personal_Details_Url");
				}
				
				if (validation.maxlengthcheck50(corre_policestation) == false) {
					ra.addAttribute("msg", "Corresponding Police Station " + validation.MaxlengthcheckMSG50);
					return new ModelAndView("redirect:Personal_Details_Url");
				}
//				if (validation.isOnlyAlphabet(corre_policestation) == false) {
//					ra.addAttribute("msg", "Corresponding Police Station " + validation.isOnlyAlphabetMSG);
//					return new ModelAndView("redirect:Personal_Details_Url");
//				}
				...
				if (corre_lendmark == null || corre_lendmark.trim().equals("")) {
					ra.addAttribute("msg", "Please Enter the Corresponding Landmark");
					return new ModelAndView("redirect:Personal_Details_Url");
				}
				
				if (validation.maxlengthcheck50(corre_lendmark) == false) {
					ra.addAttribute("msg", "Corresponding Lendmark " + validation.MaxlengthcheckMSG50);
					return new ModelAndView("redirect:Personal_Details_Url");
				}
				if (validation.isOnlyAlphabet(corre_lendmark) == false) {
					ra.addAttribute("msg", "Corresponding Lendmark " + validation.isOnlyAlphabetMSG);
					return new ModelAndView("redirect:Personal_Details_Url");
				}
				
				if (corre_pincode == null || corre_pincode.trim().equals("")) {
					ra.addAttribute("msg", "Please Enter Corresponding Pin Code");
					return new ModelAndView("redirect:Personal_Details_Url");
				}
			...
			if (request.getParameter("check_address2") == null) {
...
//				}
			...
			if (request.getParameter("check_address3") == null) {
...
//				    td.setPers_mother_title(Integer.parseInt(pers_mother_title));
			...
			// Query q2 = sessionHQL.createQuery("select userId from UserLogin Where
	...
	@RequestMapping(value = "/getPersonaldetails", method = RequestMethod.POST)
	public @ResponseBody ArrayList<ArrayList<String>> getPersonaldetails(int userid, HttpSession session) {
		ArrayList<ArrayList<String>> data = da.getPersonaldetails(userid, session);
		return data;
	}

	@RequestMapping(value = "/getBesicdetails_ctrl", method = RequestMethod.POST)
	public @ResponseBody ArrayList<ArrayList<String>> getBesicdetails_ctrl(int userid, HttpSession session) {
		ArrayList<ArrayList<String>> data = da.getBesicdetails(userid);
		return data;
	}

	@RequestMapping(value = "/get_p_id_pers_info_ctrl", method = RequestMethod.POST)
	public @ResponseBody ArrayList<ArrayList<String>> get_p_id_pers_info_ctrl(int userid) {
		ArrayList<ArrayList<String>> data = da.get_p_id_pers_info_data(userid);
		return data;
	}

	@RequestMapping(value = "/get_ayush_id_ctrl", method = RequestMethod.POST)
	public @ResponseBody ArrayList<ArrayList<String>> get_ayush_id_ctrl(String userid) {
		ArrayList<ArrayList<String>> data = da.get_ayush_id_data(userid);
		return data;
	}

	@RequestMapping(value = "/getUpdatePerDetails", method = RequestMethod.POST)
	public @ResponseBody String getUpdatePerDetails(String e_id, HttpServletRequest request, Principal principal)
			throws ParseException {
		String msg = "";
		String username = principal.getName();
		Date date = new Date();
...
//				}
		...
		if (pers_permanent_village == null || pers_permanent_village.trim().equals("")) {
			msg = "Please Enter Permanent City/Village,pers_permanent_village";
			return msg;
		}
		if (validation.maxlengthcheck50(pers_permanent_village) == false) {
...
//				}
		...
		if (request.getParameter("check_address") == null) {
			...
			if (corre_lendmark == null || corre_lendmark.trim().equals("")) {
				msg = "Please Enter the Corresponding Landmark,corre_lendmark";
				return msg;
			}
		...
		TB_PERSONAL_DETAILS pda = (TB_PERSONAL_DETAILS) sessionHQL.get(TB_PERSONAL_DETAILS.class,
...
//		add quota and councelling
		...
		msg = da.getUpdatePerDetails(pda);
		sessionHQL.close();
		return msg;
