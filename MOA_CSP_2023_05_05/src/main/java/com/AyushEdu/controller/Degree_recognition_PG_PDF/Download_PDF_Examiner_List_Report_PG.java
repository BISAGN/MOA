...
public class Download_PDF_Examiner_List_Report_PG extends AbstractPdfView  {
	...
	public Download_PDF_Examiner_List_Report_PG(String string, List<String> tH2, String heading2, String username2,
...
//		Font font = new Font(unicode,18,Font.NORMAL);
		...
		Chunk u1 = new Chunk("Examiner List For P.G. Students \n", myFont);
...
//		p.add(u2);
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter arg2,
		...
		pl = new Paragraph("Subject : " + l1.get(1) + "", font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Name of Examiner's : " + l1.get(2), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Date Of Examination : " + l1.get(2), font);
		tableleftFM.addCell(pl);
