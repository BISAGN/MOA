...
public class Download_PDF_Dissertation_Report_PG extends AbstractPdfView  {
	...
	public Download_PDF_Dissertation_Report_PG(String string, List<String> tH2, String heading2, String username2,
...
//		Font font = new Font(unicode,18,Font.NORMAL);
		...
		Chunk u1 = new Chunk("Dissertation Topics Of P.G. Student \n", myFont);
...
//		p.add(u2);
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter arg2,
		...
		pl = new Paragraph("Duration Of Job Dates From : " + l1.get(2), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Duration Of Job Dates To : " + l1.get(2), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Name Of Topic : " + l1.get(2), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Conclusion Obtained From Dissertation : " + l1.get(2), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Date Of Submission : " + l1.get(2), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Publication From Dissertation : " + l1.get(2), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Mention Article : " + l1.get(2), font);
		tableleftFM.addCell(pl);
