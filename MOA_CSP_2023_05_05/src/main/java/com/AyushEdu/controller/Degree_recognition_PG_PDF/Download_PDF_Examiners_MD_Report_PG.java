...
public class Download_PDF_Examiners_MD_Report_PG extends AbstractPdfView  {
	...
	public Download_PDF_Examiners_MD_Report_PG(String string, List<String> tH2, String heading2, String username2,
...
//		Font font = new Font(unicode,18,Font.NORMAL);
		...
		Chunk u1 = new Chunk("Examiners For M.D. Course\n", myFont);
...
//		p.add(u2);
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter arg2,
		...
		pl = new Paragraph("Name Of Guide : " + l1.get(2), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Name Student For Guide : " + l1.get(3), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Topic Of Dissertation : " + l1.get(4), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Whether Guide Participated in Examination : " + l1.get(5) + "", font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Date Of Submission : " + l1.get(6), font);
		tableleftFM.addCell(pl);
		
		
		pl = new Paragraph("Date Of Acceptance : " + l1.get(7) + "", font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Whether Student Published Article  : " + l1.get(8), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Mention Details  : " + l1.get(9) + "", font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Article Title : " + l1.get(10), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Name Of Journal year/month : " + l1.get(11), font);
		tableleftFM.addCell(pl);
