...
public class Download_PDF_Assignment_Report_PG extends AbstractPdfView  {
	...
	public Download_PDF_Assignment_Report_PG(String string, List<String> tH2, String heading2, String username2,
...
//		Font font = new Font(unicode,18,Font.NORMAL);
		...
		Chunk u1 = new Chunk("Assignment Of P.G. Students \n", myFont);
...
//		p.add(u2);
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter arg2,
		...
		pl = new Paragraph("List Of Assignments : " + l1.get(2), font);
		tableleftFM.addCell(pl);
