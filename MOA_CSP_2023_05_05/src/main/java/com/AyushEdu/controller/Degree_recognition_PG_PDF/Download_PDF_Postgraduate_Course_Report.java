...
public class Download_PDF_Postgraduate_Course_Report extends AbstractPdfView {
	...
	public Download_PDF_Postgraduate_Course_Report(String string, List<String> tH2, String heading2, String username2,
	...
	protected void buildPdfMetadata(Map<String, Object> model, Document document, HttpServletRequest request) {
		...
		Chunk u1 = new Chunk("Postgraduate Course Qualification In Homoeopathy In India \n", myFont);
...
//		tableleftFM.addCell("Postgraduate Course Qualification In Homoeopathy In India:");
//		tableleftFM.addCell("\n");
		
		pl = new Paragraph("Applicant University Granting Qualification : " + l1.get(1) + "", font);
		tableleftFM.addCell(pl);
		pl = new Paragraph("Full Name Of The Postgraduate Course : " + l1.get(2), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Abbreviation Of Postgraduate Course : " + l1.get(3) + "", font);
		tableleftFM.addCell(pl);
		...
		pl = new Paragraph("City  : " + l1.get(9) + "", font);
		tableleftFM.addCell(pl);
