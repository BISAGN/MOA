...
public class Download_PDF_lecture_Report_PG extends AbstractPdfView  {
	...
	public Download_PDF_lecture_Report_PG(String string, List<String> tH2, String heading2, String username2,
...
//		Font font = new Font(unicode,18,Font.NORMAL);
		...
		Chunk u1 = new Chunk("Lecture Taken by P.G. Students \n", myFont);
...
//		p.add(u2);
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter arg2,
		...
		pl = new Paragraph("Class : " + l1.get(2), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Date : " + l1.get(3), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Day : " + l1.get(4), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Time : " + l1.get(5) + "", font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Topic : " + l1.get(6), font);
		tableleftFM.addCell(pl);
