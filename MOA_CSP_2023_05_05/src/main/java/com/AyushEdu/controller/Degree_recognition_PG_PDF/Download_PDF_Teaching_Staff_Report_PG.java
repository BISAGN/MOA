...
public class Download_PDF_Teaching_Staff_Report_PG extends AbstractPdfView  {
	...
	public Download_PDF_Teaching_Staff_Report_PG(String string, List<String> tH2, String heading2, String username2,
...
//		Font font = new Font(unicode,18,Font.NORMAL);
		...
		Chunk u1 = new Chunk("Teaching Staff For Post Graduate Course \n", myFont);
...
//		p.add(u2);
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter arg2,
		...
		pl = new Paragraph("Name Of College : " + l1.get(1) + "", font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Name Of Teaching Staff : " + l1.get(2), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Phone : " + l1.get(3), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Email Id : " + l1.get(4), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Designation : " + l1.get(5) + "", font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Department : " + l1.get(6), font);
		tableleftFM.addCell(pl);
		
		
		pl = new Paragraph("Registration Number : " + l1.get(7) + "", font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Date Of Registration  : " + l1.get(8), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Date Of Birth  : " + l1.get(9) + "", font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Qualification Awarding Authority: " + l1.get(10), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Date Of Appointment : " + l1.get(11), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Full Time / Part Time  : " + l1.get(12) + "", font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Post : " + l1.get(13) + "", font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Experience Details From : " + l1.get(14) + "", font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Experience Details To  : " + l1.get(15) + "", font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Total Teaching Experience in Years : " + l1.get(16) + "", font);
		tableleftFM.addCell(pl);
