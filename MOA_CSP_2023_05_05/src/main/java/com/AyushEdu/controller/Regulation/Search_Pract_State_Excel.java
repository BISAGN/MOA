...
public class Search_Pract_State_Excel extends AbstractXlsView {
	String Type = "";
	List<String> TH;
	String Heading = "";
	String username = "";
	...
	public Search_Pract_State_Excel(String Type, List<String> TH,  List<ArrayList<String>> non, String Heading, String username) {
		this.Type = Type;
		this.TH = TH;
		this.non = non;
