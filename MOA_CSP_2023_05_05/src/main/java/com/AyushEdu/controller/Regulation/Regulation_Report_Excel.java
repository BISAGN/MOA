...
public class Regulation_Report_Excel extends AbstractXlsView {
	String Type = "";
	List<String> TH;
	String Heading = "";
	String username = "";
	...
	public Regulation_Report_Excel(String Type, List<String> TH,  List<ArrayList<String>> non, String Heading, String username) {
		this.Type = Type;
		this.TH = TH;
		this.non = non;
