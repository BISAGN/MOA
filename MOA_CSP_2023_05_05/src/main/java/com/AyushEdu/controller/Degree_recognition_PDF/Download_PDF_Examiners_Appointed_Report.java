...
public class Download_PDF_Examiners_Appointed_Report extends AbstractPdfView {
	...
	public Download_PDF_Examiners_Appointed_Report(String string, List<String> tH2, String heading2, String username2,
...
//		Font font = new Font(unicode,18,Font.NORMAL);
		...
		Chunk u1 = new Chunk("Examiners Appointed in For Examination \n", myFont);
//		Chunk u2 = new Chunk("Examiners Appointed in For Examination  \n", font007);
...
//		p.add(u2);
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter arg2,
		...
		pl = new Paragraph("Name Of Examiners External/Internal : " + l1.get(1) + "", font);
		tableleftFM.addCell(pl);
		pl = new Paragraph("Subjact : " + l1.get(2), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Year : " + l1.get(3) + "", font);
		tableleftFM.addCell(pl);
		pl = new Paragraph("Qualification : " + l1.get(4), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Teaching Experience : " + l1.get(5) + "", font);
		tableleftFM.addCell(pl);
		pl = new Paragraph("Teaching Code  : " + l1.get(6), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Registration Number   : " + l1.get(7) + "", font);
		tableleftFM.addCell(pl);
		pl = new Paragraph("Date of University Appointment Letter : " + l1.get(8), font);
		tableleftFM.addCell(pl);
