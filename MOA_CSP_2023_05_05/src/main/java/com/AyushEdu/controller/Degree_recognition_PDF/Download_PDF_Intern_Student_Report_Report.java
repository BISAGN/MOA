...
public class Download_PDF_Intern_Student_Report_Report extends AbstractPdfView {
	...
	public Download_PDF_Intern_Student_Report_Report(String string, List<String> tH2, String heading2, String username2,
...
//		Font font = new Font(unicode,18,Font.NORMAL);
		...
		Chunk u1 = new Chunk("Intern Student For Course \n", myFont);
//		Chunk u2 = new Chunk("Intern Student For Course  \n", font007);
...
//		p.add(u2);
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter arg2,
		...
		pl = new Paragraph("Name Of Students  : " + l1.get(1) + "", font);
		tableleftFM.addCell(pl);
		pl = new Paragraph("Year Of Admission : " + l1.get(2), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Date Of Result Of Final Year BHMS/Course Completed : " + l1.get(3) + "", font);
		tableleftFM.addCell(pl);
		pl = new Paragraph("Provisional Registration No : " + l1.get(4), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Year Of Provisional Registration : " + l1.get(5) + "", font);
		tableleftFM.addCell(pl);
		pl = new Paragraph("Date Of Starting Of Internship  : " + l1.get(6), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Date Of Completion Of Internship   : " + l1.get(7) + "", font);
		tableleftFM.addCell(pl);
		pl = new Paragraph("Remarks  : " + l1.get(8), font);
		tableleftFM.addCell(pl);
