...
public class Download_PDF_Migrated_To_Other_College_Report extends AbstractPdfView  {
	...
	public Download_PDF_Migrated_To_Other_College_Report(String string, List<String> tH2, String heading2, String username2,
...
//		Font font = new Font(unicode,18,Font.NORMAL);
		...
		Chunk u1 = new Chunk("For Those Who Migrated To Other College \n", myFont);
//		Chunk u2 = new Chunk("For Those Who Migrated To Other College  \n", font007);
