package com.AyushEdu.controller.Degree_recognition_PDF;
...
public class Download_PDF_Undergraduate_Course_Report extends AbstractPdfView {
	...
	public Download_PDF_Undergraduate_Course_Report(String string, List<String> tH2, String heading2, String username2,
			ArrayList<ArrayList<String>> list2){//,List<ArrayList<String>> listS
		this.Type = Type;
		this.TH = TH;
	...
	protected void buildPdfMetadata(Map<String, Object> model, Document document, HttpServletRequest request) {
		...
		Chunk u1 = new Chunk("Undergraduate Course In Homoeopathy In India \n", myFont);
//		Chunk u2 = new Chunk("Undergraduate Course In Homoeopathy In India  \n", font007); 
...
//		p.add(u2);
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter arg2,
		...
		pl = new Paragraph("Applicant University Granting Qualification : " + l1.get(1) + "", font);
		tableleftFM.addCell(pl);
		pl = new Paragraph("Full Name Of The Undergraduate Course : " + l1.get(2), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Abbreviation Of Undergraduate Course : " + l1.get(3) + "", font);
		tableleftFM.addCell(pl);
		pl = new Paragraph("Application For Admitted Academic Session : " + l1.get(4), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("College/Center/Medical Institute : " + l1.get(5) + "", font);
		tableleftFM.addCell(pl);
		pl = new Paragraph("Country  : " + l1.get(6), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("State  : " + l1.get(7) + "", font);
		tableleftFM.addCell(pl);
		pl = new Paragraph("District : " + l1.get(8), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("City  : " + l1.get(8) + "", font);
		tableleftFM.addCell(pl);
		pl = new Paragraph("Postal Address : " + l1.get(10), font);
		tableleftFM.addCell(pl);
//		
		pl = new Paragraph("Email  : " + l1.get(11) + "", font);
		tableleftFM.addCell(pl);
		pl = new Paragraph("Website  : " + l1.get(12), font);
		tableleftFM.addCell(pl);
		pl = new Paragraph("Academic Year Applied For : " + l1.get(13), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Permission From Central Government : " + l1.get(14) + "", font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Admission Intake Capacity Permitted  : " + l1.get(15), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Number Of Student Admitted : " + l1.get(16), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Remarks  : " + l1.get(17) + "", font);
		tableleftFM.addCell(pl);
