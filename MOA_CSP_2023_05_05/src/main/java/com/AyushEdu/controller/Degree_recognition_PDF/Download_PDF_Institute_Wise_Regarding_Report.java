...
public class Download_PDF_Institute_Wise_Regarding_Report extends AbstractPdfView {
	...
	public Download_PDF_Institute_Wise_Regarding_Report(String string, List<String> tH2, String heading2, String username2,
...
//		Font font = new Font(unicode,18,Font.NORMAL);
		...
		try {
			...
			String indian_Army = request.getRealPath("/") + "admin" + File.separator + "js" 
					+ File.separator + "images" + File.separator + "ncism_logo.png";
		...
		Chunk u1 = new Chunk("College Wise/Institute Wise Regarding The Hospital Attached \n", myFont);
//		Chunk u2 = new Chunk("College Wise/Institute Wise Regarding The Hospital Attached  \n", font007);
...
//		p.add(u2);
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter arg2,
		...
		pl = new Paragraph("Name Of Homoeopathic Medical College/Institute : " + l1.get(1) + "", font);
		tableleftFM.addCell(pl);
		pl = new Paragraph("Name Of Attached Homoeopathic Hospital/Institute : " + l1.get(2), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Name Of Attached Super Speciality Hospital : " + l1.get(3) + "", font);
		tableleftFM.addCell(pl);
		pl = new Paragraph("MOU Date : " + l1.get(4), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Copy Of MOU Date : " + l1.get(5) + "", font);
		tableleftFM.addCell(pl);
		pl = new Paragraph("Hospital Staff  : " + l1.get(6), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Designation   : " + l1.get(7) + "", font);
		tableleftFM.addCell(pl);
		pl = new Paragraph("Qualification : " + l1.get(8), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Full Time/Part Time  : " + l1.get(9) + "", font);
		tableleftFM.addCell(pl);
		pl = new Paragraph("Remarks   : " + l1.get(10), font);
		tableleftFM.addCell(pl);
