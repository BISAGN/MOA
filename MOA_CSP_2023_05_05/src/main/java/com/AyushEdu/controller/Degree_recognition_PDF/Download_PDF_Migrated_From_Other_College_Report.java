...
public class Download_PDF_Migrated_From_Other_College_Report extends AbstractPdfView  {
	...
	public Download_PDF_Migrated_From_Other_College_Report(String string, List<String> tH2, String heading2, String username2,
...
//		Font font = new Font(unicode,18,Font.NORMAL);
		...
		Chunk u1 = new Chunk("For Those Who Migrated From Other College \n", myFont);
//		Chunk u2 = new Chunk("For Those Who Migrated From Other College  \n", font007);
...
//		p.add(u2);
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter arg2,
		...
		pl = new Paragraph("Date Of Migration  : " + l1.get(2), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Professional Year Of Migration : " + l1.get(3) + "", font);
		tableleftFM.addCell(pl);
		pl = new Paragraph("University Enrollment Number : " + l1.get(4), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Remarks  : " + l1.get(5) + "", font);
		tableleftFM.addCell(pl);
