...
public class Download_PDF_Admitted_Students_Report extends AbstractPdfView  {
	...
	public Download_PDF_Admitted_Students_Report(String string, List<String> tH2, String heading2, String username2,
...
//		Font font = new Font(unicode,18,Font.NORMAL);
		...
		Chunk u1 = new Chunk("Admitted students For Each College/Institute As Per Performa \n", myFont);
//		Chunk u2 = new Chunk("Admitted students For Each College/Institute As Per Performa \n", font007);
...
//		p.add(u2);
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter arg2,
		...
		pl = new Paragraph("Rank : " + l1.get(3) + "", font);
		tableleftFM.addCell(pl);
		pl = new Paragraph("Marks : " + l1.get(4), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("All India : " + l1.get(5) + "", font);
		tableleftFM.addCell(pl);
		pl = new Paragraph("State  : " + l1.get(6), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Admission Authority  : " + l1.get(7) + "", font);
		tableleftFM.addCell(pl);
		pl = new Paragraph("Court Order & Others : " + l1.get(8), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Date Of Enrollment In University  : " + l1.get(8) + "", font);
		tableleftFM.addCell(pl);
		pl = new Paragraph("University Enrollment Number  : " + l1.get(10), font);
		tableleftFM.addCell(pl);
		
		pl = new Paragraph("Date Of Internship Completion  : " + l1.get(11) + "", font);
		tableleftFM.addCell(pl);
		pl = new Paragraph("Remarks   : " + l1.get(12), font);
		tableleftFM.addCell(pl);
