...
public class Admission_Student_Report_PDF extends AbstractPdfView{
...
//	List<String> TH2;
	...
	public Admission_Student_Report_PDF(String Type, List<String> TH1, String Heading, int total,String role) {
//		System.err.println("new_list2=============="+new_list2);
	...
	protected void buildPdfMetadata(Map<String, Object> model, Document document, HttpServletRequest request) {
		...
		Chunk underline3 = new Chunk(aList.get(0).get(1), fontTableHeadingBig);
...
//		p44.setAlignment(Element.ALIGN_CENTER);
		...
		table3.setWidths(new int[] { 35, 30, 25, 25, 25, 25,25,25,25,25,25,25,25,25,23,30,35,35 });
		table3.getDefaultCell().setHorizontalAlignment(Element.ALIGN_CENTER);
