...
public class Studentdetails_Report_Excell_Report  extends AbstractXlsView {
	String Type = "";
	List<String> TH;
	String Heading = "";
	String username = "";
	...
	public Studentdetails_Report_Excell_Report(String Type, List<String> TH, List<ArrayList<String>> listofdata, String Heading,
			String username) {
		this.Type = Type;
		this.TH = TH;
