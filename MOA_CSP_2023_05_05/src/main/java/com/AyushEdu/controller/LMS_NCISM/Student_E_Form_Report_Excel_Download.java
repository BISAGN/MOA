...
public class Student_E_Form_Report_Excel_Download  extends AbstractXlsView {
	String Type = "";
	List<String> TH;
	String Heading = "";
	String username = "";
	...
	public Student_E_Form_Report_Excel_Download(String Type, List<String> TH, List<ArrayList<String>> listofdata, String Heading,
			String username) {
		this.Type = Type;
		this.TH = TH;
