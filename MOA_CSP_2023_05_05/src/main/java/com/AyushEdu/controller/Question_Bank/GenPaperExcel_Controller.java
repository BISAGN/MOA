...
public class GenPaperExcel_Controller extends AbstractXlsView  {
	...
	public GenPaperExcel_Controller(String Type, List<String> TH, String Heading, String username) {
		this.Type = Type;
		this.TH = TH;
