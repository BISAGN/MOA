...
public class Exp_Excel_Report extends AbstractXlsView {
	...
	public Exp_Excel_Report(String Type, List<String> TH,List<ArrayList<String>> listofdata,String attendance_date, String Heading, String username) {
		this.Type = Type;
		this.TH = TH;
