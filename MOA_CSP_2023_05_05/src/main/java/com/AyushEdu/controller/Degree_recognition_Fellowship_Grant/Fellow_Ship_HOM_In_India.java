...
import com.AyushEdu.dao.Degree_recognition_Fellowship_Grant.Fellow_ship_HOM_in_IndiaDAO;
...
public class Fellow_Ship_HOM_In_India {

	@Autowired
	Fellow_ship_HOM_in_IndiaDAO pdao;
	...
	@RequestMapping(value = "/FellowShipHOMInIndiaUrl", method = RequestMethod.GET)

	public ModelAndView FellowShipHOMInIndiaUrl(ModelMap Mmap, HttpSession session,
...
//		SECURITY ABHISHEK
		...
		String roleid1 = session.getAttribute("roleid").toString();
		 Boolean val = roledao.ScreenRedirect("FellowShipHOMInIndiaUrl", roleid1);		
			if(val == false) {
		...
		return new ModelAndView("Fellow_Ship_HOM_In_India_Tiles", "Fellow_Ship_HOM_in_India_CMD", new DG_REC_FELLOW_SHIP_HOM_IN_INDIA());

	}
	@RequestMapping(value = "/getInstituteUrlfellowship", method = RequestMethod.POST)
	public @ResponseBody List<EDU_LMS_INSTITUTE_REGISTRATION> getInstituteUrlfellowship(ModelMap Mmap, HttpSession session,
	...
	@PostMapping(value = "/Fellow_Ship_HOM_in_India_Action")
	public ModelAndView Fellow_Ship_HOM_in_India_Action(
			@Validated @ModelAttribute("Fellow_Ship_HOM_in_India_CMD") DG_REC_FELLOW_SHIP_HOM_IN_INDIA td, BindingResult result,
...
//		SECURITY ABHISHEK
		...
		try {
			...
			Long c = (Long) sessionHQL.createQuery(
					"select count(id) from  DG_REC_FELLOW_SHIP_HOM_IN_INDIA where country_id=:country_id and university_name=:university_name and "
			...
			if (id == 0) {
				...
				if (c == 0) {
					td.setId(id);
					String msg = pdao.updateFellow_ship_hom_in_india(td);
	...
	@PostMapping("/getFilter_fellow_ship_hom_in_india_data")
	public @ResponseBody List<Map<String, Object>> getFilter_fellow_ship_hom_in_india_data(int startPage,
		...
		return pdao.DataTableFellow_ship_hom_in_india_Details_DataList(startPage, pageLength, Search, orderColunm,
				orderType, country_id, university_name, college_id,  abbreviation, medical_course_name,validity_period, digital_code);
	}

	@PostMapping("/getTotal_fellow_ship_hom_in_india_dataCount")
	public @ResponseBody long getTotal_fellow_ship_hom_in_india_dataCount(HttpSession sessionUserId, String Search,
		...
		return pdao.DataTableFellow_ship_hom_in_india_Details_DataTotalCount(Search, country_id, university_name, college_id,
	...
	@RequestMapping(value = "/getAbbreviationListfellow", method = RequestMethod.POST)
	public @ResponseBody ArrayList<ArrayList<String>> getAbbreviationListfellow(ModelMap Mmap,
...
@RequestMapping(value = "/deleteFellow_ship_Hom_in_india_Url", method = RequestMethod.POST)
public ModelAndView deleteFellow_ship_Hom_in_india_Url(@ModelAttribute("id2") int id, BindingResult result, RedirectAttributes ra,
	...
	try {
		...
		int app = session.createQuery(
				"delete from DG_REC_FELLOW_SHIP_HOM_IN_INDIA where id=:id")
