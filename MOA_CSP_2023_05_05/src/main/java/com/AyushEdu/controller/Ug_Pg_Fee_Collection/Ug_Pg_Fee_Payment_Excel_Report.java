...
public class Ug_Pg_Fee_Payment_Excel_Report extends AbstractXlsView  {
	String Type = "";
	List<String> TH;
	String Heading = "";
	String username = "";
	...
	public Ug_Pg_Fee_Payment_Excel_Report(String Type, List<String> TH, List<ArrayList<String>> listofdata, String Heading,
			String username) {
		this.Type = Type;
		this.TH = TH;
