...
public class Fees_Data_Excel_Report extends AbstractXlsView{
	String Type = "";
	List<String> TH;
	String Heading = "";
	String username = "";
	...
	public Fees_Data_Excel_Report(String Type, List<String> TH, List<ArrayList<String>> listofdata, String Heading,
			String username) {
		this.Type = Type;
		this.TH = TH;
